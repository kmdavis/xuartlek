...
health:
  - name: "HP"
    desc: "117; __Immunities__ disease, paralyzed, poison, precision; __Resistances__ all damage 7 (except force, _ghost touch_, spirit, or vitality; double resistance vs. non-magical)"
abilities_mid:
  - name: "Visage Strike"
    desc: "⬲"
  - name: "Trigger"
...
attacks:
  - name: "Melee"
    desc: "⬻ jaws +17 (Magical) __Damage__ 2d8+8 force plus Knockdown"
abilities_bot:
...
spellcasting:
  - name: "Primal Innate Spells"
    desc: "DC 22 - __3rd__ Revealing Light - __Constant (5th)__ Truespeech"
