...
armorclass:
  - name: "AC"
    desc: "24; __Fort__: +16; __Ref__: +14; __Will__: +11 (+2 status vs. mental)"
hp: 120
health:
  - name: "HP"
...
attacks:
  - name: "Melee"
    desc: "⬻ longspear +17 (reach 10 feet) __Damage__ 1d8+11 piercing"
  - name: "Melee"
...
abilities_bot:
  ...
  - name: "Effect"
    desc: "The granitescale rattles the base of their spear, attempting an Intimidation check to Demoralize all enemies within 30 feet (compare the check result to the targets' Will DCs individually)."
