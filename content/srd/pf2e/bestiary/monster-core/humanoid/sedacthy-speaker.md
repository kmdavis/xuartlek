...
abilities_mid:
  ...
  - name: "Requirements"
    desc: "The sedacthy speaker has cover from an animal ally"
  - name: "Effect"
    desc: "The animal takes the damage instead."
speed: "20 feet, swim 40 feet"
attacks:
  - name: "Melee"
    desc: "⬻ _trident_ +17 (Magical) __Damage__ 1d8+10 piercing"
  - name: "Melee"
    desc: "⬻ jaws +16 __Damage__ 1d6+8 piercing plus 1d4 persistent bleed"
  - name: "Melee"
    desc: "⬻ claw +16 (Agile) __Damage__ 1d6+8 slashing"
  - name: "Ranged"
    desc: "⬻ _trident_ +14 (Magical, thrown 20 feet) __Damage__ 1d8+8 piercing"
abilities_bot:
  - name: "Animal Shield"
    desc: "⬻"
  - name: "Requirements"
    desc: "The sedacthy speaker is adjacent to a Large or larger animal ally"
  - name: "Effect"
  ...
  - name: "Painful Cry"
    desc: "⬺ (Mental, Sonic) The sedacthy shrieks across a range of painfully high tones, dealing 3d6 sonic damage and 1d6 mental damage to all creatures in a 30-foot cone, with a DC 23 basic Fortitude save. A creature that fails its save is sickened 1."
  - name: "Shared Feast"
  ...
  - name: "Swim Together"
    desc: "⬺"
  - name: "Requirements"
    desc: "The speaker is adjacent to an animal ally"
  - name: "Effect"
    desc: "The speaker and the animal both Swim, ending their movement adjacent to one another."
