...
abilities_mid:
  ...
  - name: "Effect"
    desc: "The kuribu springs into action by making a shortbow Strike against the triggering creature. If the Strike hits, the creature is pinned by the arrow, as described in the [[srd/pf2e/compendium/rules-elements/Weapon Groups#Club|bow]] critical specialization."
