...
attacks:
  ...
  - name: "Melee"
    desc: "⬻ jaws +9 (Agile) __Damage__ 1d4+4 piercing"
  - name: "Ranged"
    desc: "⬻ club +8 (thrown 10 feet) __Damage__ 1d6+4 bludgeoning"
abilities_bot:
  ...
  - name: "Leap Attack"
    desc: "⬺ The morlock Strides up to twice their Speed, during which they attempt a High Jump or a Long Jump. At any point during their movement, the morlock can make a melee Strike against an enemy in their reach. The morlock then can't use Leap Attack until the end of their next turn."
  - name: "Sneak Attack"
