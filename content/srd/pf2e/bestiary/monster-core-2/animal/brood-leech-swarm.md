...
health:
  - name: "HP"
    desc: "50; __Immunities__ precision, swarm mind; __Resistances__ bludgeoning 2, piercing 5, slashing 5; __Weaknesses__ area damage 5, salt 5, splash damage 5"
speed: "5 feet, swim 20 feet"
abilities_bot:
  - name: "Blood-Draining Bites"
    desc: "⬻ Each enemy in the swarm's space takes 2d6 piercing damage (DC 21 basic Reflex save). A creature who fails the Reflex save also takes 1d6 persistent bleed damage and is exposed to brood leech swarm venom."
  ...
  - name: "Maximum Duration"
    desc: "6 rounds"
  - name: "Stage 1"
    desc: "clumsy 1, sickened 1, and –5-foot status penalty to Speed (1 round)"
  - name: "Stage 2"
