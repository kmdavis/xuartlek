...
health:
  - name: "HP"
    desc: "50; __Immunities__ precision, swarm mind; __Resistances__ bludgeoning 5, piercing 5, slashing 3; __Weaknesses__ area damage 5, [[srd/pf2e/compendium/rules-elements/traits/gm-core/splash|splash]] damage 5"
speed: "30 feet, climb 30 feet, swim 30 feet"
abilities_bot:
  - name: "Venom Spritz"
    desc: "⬺ The vipers spray venom from their fangs in a defensive display. Each creature in a 10-foot [[srd/pf2e/books/player-core/chapter-8-playing-the-game/area#Cone|cone]] is exposed to viper swarm venom but gains a +2 circumstance bonus to its initial saving throw against the poison."
  - name: "Venomous Fangs"
    desc: "⬻ Each enemy in the swarm's space takes 2d8 piercing damage (DC 21 [[srd/pf2e/books/player-core/chapter-8-playing-the-game/checks#Basic Saving Throws|basic]] Reflex save). A creature that fails their save is also exposed to viper swarm venom."
