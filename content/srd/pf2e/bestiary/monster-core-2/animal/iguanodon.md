...
attacks:
  - name: "Melee"
    desc: "⬻ thumb spike +17 (deadly d10, reach 10 feet) __Damage__ 2d8+9 piercing"
  - name: "Melee"
    desc: "⬻ tail +15 (reach 15 feet) __Damage__ 2d10+9 bludgeoning"
abilities_bot:
  - name: "Gouging Lunge"
    desc: "⬺ The iguanodon makes a thumb spike Strike at an adjacent foe and then Strides up to 15 feet, dragging its thumb spike across the foe to gouge out a brutal wound. If this Strike hits, it deals an extra 1d8 slashing damage, and the following Stride doesn’t trigger reactions from the creature struck. This thumb spike Strike counts as two attacks when calculating the iguanodon’s multiple attack penalty."
