...
health:
  - name: "HP"
    desc: "65 , regeneration 15 (deactivated by electricity or fire); __Weaknesses__ electricity 8, fire 8"
abilities_mid:
  - name: "Flailing Bite"
    desc: "⬲"
  - name: "Trigger"
    desc: "The trollhound takes electricity or fire damage; Effect The trollhound makes a jaws Strike against a random creature within reach. If the trollhound has persistent fire damage, they attempt a DC 15 flat check to remove it."
speed: "35 feet"
attacks:
  - name: "Melee"
...
abilities_bot:
  - name: "Bloodfire Fever"
    desc: "(, Disease) Trollhounds and trolls are immune to bloodfire fever"
  - name: "Saving Throw"
  ...
  - name: "Stage 3"
    desc: "enfeebled 1 and clumsy 1 (1 day)"
  - name: "Stage 4"
    desc: "enfeebled 2 and clumsy 2 (1 day)"
  - name: "Stage 5"
    desc: "enfeebled 2, clumsy 2, and fatigued (1 day)"
  - name: "Pack Attack"
