...
skills:
  - name: "Skills"
    desc: "Athletics +13, Crafting +12, Nature +11, Survival +15, Stealth +11"
...
attacks:
  - name: "Melee"
    desc: "⬻ hatchet +15 (Agile, Sweep) __Damage__ 1d6+7 slashing"
  - name: "Melee"
    desc: "⬻ fist +15 (Agile, Finesse, Nonlethal, Unarmed) __Damage__ 1d4+7 bludgeoning"
  - name: "Ranged"
    desc: "⬻ blowgun +15 (Agile, Nonlethal, reload 1) __Damage__ 1 piercing plus 2d6 poison and 1d6 persistent poison"
abilities_bot:
  ...
  - name: "Snare Master"
    desc: "⬽ (Manipulate, Trap)"
  - name: "Frequency"
    desc: "five times per day"
  - name: "Effect"
    desc: "By scrounging local materials, the castaway constructs a simple but effective deadfall without expending resources. Treat this as a snare with a DC 19 Perception check to spot, and a DC 23 Thievery check to disable. It occupies a single 5-foot square and lasts 24 hours before falling apart. The first creature that enters the space takes 6d6 bludgeoning damage"
  - name: "Sneak Attack"
    desc: "The castaway deals 1d6 extra precision damage to off-guard creatures."
