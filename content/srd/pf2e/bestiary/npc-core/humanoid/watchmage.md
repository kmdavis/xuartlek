...
skills:
  - name: "Skills"
    desc: "Arcana +13, Athletics +10, Intimidation +9, Legal Lore +13, Society +11"
...
abilities_top:
  ...
  - name: "Items"
    desc: "Leather Armor, Shortbow (20 arrows), spellbook (contains all prepared spells plus _earthbind_, _revealing light_, _sleep_, and _tailwind_)"
ac: 21
armorclass:
  - name: "AC"
...
abilities_mid:
  - name: "Counter Escape"
    desc: "⬲ (arcane)"
  - name: "Trigger"
    desc: "A creature Casts a Spell with the teleportation trait or as a reaction"
  - name: "Effect"
...
attacks:
  - name: "Melee"
    desc: "⬻ fist +15 (Agile, Finesse, Nonlethal, Unarmed) __Damage__ 1d6+5 bludgeoning"
  - name: "Ranged"
    desc: "⬻ shortbow +15 (deadly d10, Magical, range increment 60 feet) __Damage__ 1d6+4 piercing plus 1d6 force"
abilities_bot:
  - name: "Eldritch Arms"
...
spellcasting:
  - name: "Arcane Prepared Spells"
    desc: "DC 20, attack +12 - __Cantrips (3rd)__ Detect Magic, Frostbite, Ignition, Read Aura, Tangle Vine - __1st__ Command, Force Barrage, Sure Strike - __2nd__ Dispel Magic, See the Unseen - __3rd__ Haste, Slow"
