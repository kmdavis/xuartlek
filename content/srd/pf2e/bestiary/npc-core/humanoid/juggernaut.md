...
abilities_top:
  ...
  - name: "Items"
    desc: "Artisan's Toolkit (blacksmithing), juggernaut armor, Repair Toolkit"
ac: 33
armorclass:
  - name: "AC"
...
abilities_bot:
  ...
  - name: "Jump Jets"
    desc: "⬻ (Alchemical) The juggernaut gains a Fly speed of 15 feet until the end of their current turn. If the juggernaut isn't on solid ground when they lose their fly Speed, they fall. After the effect ends, the juggernaut can't use Jump Jets again for 1 round."
  - name: "Trample"
