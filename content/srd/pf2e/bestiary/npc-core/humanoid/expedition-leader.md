...
skills:
  - name: "Skills"
    desc: "Acrobatics +20, Athletics +20, Diplomacy +18, Nature +19, Scouting Lore +21, Survival +18"
...
abilities_top:
  ...
  - name: "Items"
    desc: "Compass, four-person tent, _+1 hide armor_, hooded lantern, _+1 striking machete_, Repair Toolkit, Shortbow (20 arrows), Spyglass, Sun Goggles, Survey Map"
ac: 27
armorclass:
  - name: "AC"
...
abilities_mid:
  ...
  - name: "Frequency"
    desc: "once per day"
  - name: "Trigger"
    desc: "The expedition leader fails a Survival check"
  - name: "Effect"
...
attacks:
  - name: "Melee"
    desc: "⬻ _machete_ +21 (deadly d8, Magical, Sweep) __Damage__ 2d6+10 slashing"
  - name: "Melee"
    desc: "⬻ fist +20 (Agile, Nonlethal, Unarmed) __Damage__ 1d4+10 bludgeoning"
  - name: "Ranged"
    desc: "⬻ shortbow +19 (deadly d10, range increment 60 feet) __Damage__ 1d6+6 piercing"
abilities_bot:
  - name: "Quick Draw"
  ...
  - name: "Effect"
    desc: "The expedition leader scoops up a handful of rubble and throws it. Each creature in a 15-foot cone must succeed at a DC 27 Reflex save or be dazzled and off-guard until the start of the expedition leader's next turn."
