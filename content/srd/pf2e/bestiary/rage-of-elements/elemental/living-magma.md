...
health:
  - name: "HP"
    desc: "250; __Immunities__ bleed, fire, paralyzed, poison, sleep; __Weaknesses__ cold 15"
abilities_mid:
  - name: "Molten Form"
  ...
  - name: "Volcanic Heat"
    desc: "(aura, fire) 40 feet. Any creature that enters or starts its turn in the aura takes 15 fire damage (DC 33 basic Fortitude save). A creature that fails its save is also enfeebled 1 until it's no longer in the aura."
  - name: "Trap Weapon"
    desc: "⬲ (fire)"
  - name: "Frequency"
    desc: "once per round"
