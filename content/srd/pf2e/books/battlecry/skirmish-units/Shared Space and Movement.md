---
title: "Shared Space and Movement"
aliases: ["Shared Space and Movement"]
...
tags:
  - srd/pf2e/battlecry
source: "Battlecry!"
aon_url: "https://2e.aonprd.com/Rules.aspx?ID=3440"
citation: "Battlecry! pg. 159"
---
...
**[[srd/pf2e/books/player-core/chapter-8-playing-the-game/Movement#Cover|Cover]]:** A leader and troop use their full space for determining cover. Therefore, they don’t grant each other cover, nor do they block each other’s attacks when determining an enemy’s cover.

[[srd/pf2e/books/player-core/chapter-8-playing-the-game/Movement#Flanking|Flanking]]: Regardless of their positioning, a leader and their troop can’t flank with each other. However, if two allied troops are flanking an enemy (or a segment of an enemy troop), their leaders can benefit from this flanking.

**[[srd/pf2e/compendium/rules-elements/traits/player-core/Minion|Minions]]:** If the leader has a minion, such as an animal companion or summoned creature, that minion typically occupies the troop’s space the same way the leader does. This can be dangerous for a weaker companion like a familiar, but the [Troop Mascot skirmish bond](https://2e.aonprd.com/SkirmishBonds.aspx?ID=12) can help.
