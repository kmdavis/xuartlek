---
title: "Troops in Skirmishes"
aliases: ["Troops in Skirmishes"]
...
tags:
  - srd/pf2e/battlecry
source: "Battlecry!"
aon_url: "https://2e.aonprd.com/Rules.aspx?ID=3445"
citation: "Battlecry! pg. 160"
---
...
If both happen at the same time, the troop rolls only one rout check. To attempt its rout check, the troop rolls a Will save against the standard DC for the level of the enemy that damaged it. This is an [[srd/pf2e/compendium/rules-elements/traits/player-core/Emotion|emotion]], [[srd/pf2e/compendium/rules-elements/traits/player-core/Fear|fear]], and [[srd/pf2e/compendium/rules-elements/traits/player-core/Mental|mental]] effect.
**Critical Success** The troop is unaffected.
**Success** The troop is [[srd/pf2e/compendium/rules-elements/Conditions#Frightened|frightened]] 1.
...
The result of a rout check applies only to the troop, not its leader. If the troop is led by a PC or NPC, the degree of success increases by one step, as noted in [[srd/pf2e/books/battlecry/skirmish-units/Boosted Morale|Boosted Morale]].

> [!pf2-sidebar] UNROUTABLE TROOPS
>
> Because of the traits on a rout check, some troops are entirely immune to them, in particular [[srd/pf2e/compendium/rules-elements/traits/player-core/Mindless|mindless]] hordes like [[srd/pf2e/compendium/gm/creature-families/Zombie|zombies]] or [[srd/pf2e/compendium/gm/creature-families/creature-families|clockwork constructs]]. NPCs often use these kinds of troops due to this advantage, but PCs might also be able to raise [skeleton infantry](https://2e.aonprd.com/Monsters.aspx?ID=1300) or build a similar fearless army.

## Loosing a Troop

When a leader’s troop is defeated, the leader remains on the battlefield and can place themself anywhere within the space their troop occupied. If the troop is forced to retreat in some way, such as after gaining the [[srd/pf2e/compendium/rules-elements/Conditions#Fleeing|fleeing]] condition, the leader can usually choose to stay behind, abandoning their troop. If they exercise this option, they can’t become the leader of that troop again in the same encounter.
...
**Take the Lead** [two-actions] ([[srd/pf2e/compendium/rules-elements/traits/player-core/Auditory|auditory]], [[srd/pf2e/compendium/rules-elements/traits/player-core/Concentrate|concentrate]], [[srd/pf2e/compendium/rules-elements/traits/player-core/Linguistic|linguistic]]) **Requirements** You aren’t leading a troop, and you’re adjacent to an allied troop that had a leader at the start of the encounter but has since lost its leader; **Effect** You try to become the leader of the troop. Attempt a [[srd/pf2e/compendium/rules-elements/skills/Diplomacy|Diplomacy]] check against the easy DC for the troop’s level.
**Success** You become the leader of the troop until the end of this combat and immediately [[srd/pf2e/compendium/rules-elements/actions/player-core#Step|Step]] into its space. The troop doesn’t gain any special skirmish actions or bonds, even if it had one with its former leader or if you had one for a troop you’ve since lost.
