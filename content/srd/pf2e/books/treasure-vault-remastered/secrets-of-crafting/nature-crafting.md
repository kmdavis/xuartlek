---
title: "Nature Crafting"
aliases: ["Nature Crafting"]
cssclasses:
  - pf2e
  - pf2e-book
tags:
...
aon_id: 1956
aon_url: "https://2e.aonprd.com/Rules.aspx?ID=1956"
citation: "Treasure Vault (Remastered) pg. 164"
---
...
Mechanically, the process of growing an item uses the same principles as Crafting it normally, though the details and the story differ. Use the [[srd/pf2e/compendium/rules-elements/actions/treasure-vault-remastered-co-the#Grow|Grow]] activity, a variant of the Craft activity. This activity has the rare trait; it's only available if you've decided to use this variant in your campaign.

### Grow

Rare Downtime Manipulate
**Source** Treasure Vault (Remastered) pg. 165
...
While many materials are covered by the Core Rulebook, some relatively mundane crafting materials not fully described there can be appropriate for use in weapons and armor produced from gardens or similar nature-oriented sources. Materials made from alchemically nurtured oozes (as described in [[#Ooze Farms|Ooze Farms]] on the previous page) can be as strong as iron or might emulate more fragile materials like [[srd/pf2e/compendium/equipment/materials/bone-object|bone]] and [[srd/pf2e/compendium/equipment/materials/stone-object-low-grade|stone]]. Bone and stone aren't precious materials, and as such don't impact the number or type of runes that can be placed on a weapon or suit of armor crafted from them.

> [!pf2-sidebar] VARIANT MATERIALS
>
