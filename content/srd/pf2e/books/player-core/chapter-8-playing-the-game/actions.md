...
> [!pf2-sidebar] IN-DEPTH ACTION RULES
>
...
You have to spend all the actions of an activity at once to gain its effects. In an encounter, this means you must complete it during your turn. If an activity gets [[#Disrupting Actions|interrupted or disrupted]] in an encounter, you lose all the actions you committed to it.
