...
**Magic**: The wheelchair is considered an extension of yourself. Spells or abilities that change your bodily form are also applied to the chair and it transforms with you so long as you're using it. You can choose what appearance this has. For example, when you transform with [wild shape](https://2e.aonprd.com/Feats.aspx?ID=316), you can choose to have full mobility of your limbs or have the chair transform to become a wheelchair appropriate for that shape, such as wheelchair harnesses for dogs.
...
**Quick-Righting**: If the chair is tipped or you are knocked [[srd/pf2e/compendium/rules-elements/Conditions|prone]] while in the chair, you can right yourself using the [Stand](https://2e.aonprd.com/Actions.aspx?ID=86) action, though in this case you are righting the wheelchair instead. An ally can use an Interact action to help right you, allowing you to Stand as a free action triggered by their Interact action.
