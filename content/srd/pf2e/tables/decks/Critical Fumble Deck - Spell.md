...
| `d54` | Effect |
|-------|--------|
| 1 | **How Did That Happen?** You call forth a mist with the effects of stinking cloud centered on a corner of your space (determined by the GM). |
| 2 | **Power Down** Until healed, you are stupefied. |
...
| 4 | **Mental Slip** You are controlled by the target until the end of your next turn. |
...
| 6 | **Strange Transference** Lost one prepared spell or spell slot, determined randomly by the GM. Your target can Cast this Spell on its next turn even if they can't cast spells, using your level, spell attack modifier, and spell DC. |
| 7 | **Mental Backlash** Until healed, you are stupefied. |
| 8 | **Fragmented Magic** Your target gains the effect of a mirror image spell. |
...
| 11 | **Nosebleed** You take 1 persistent bleed damage. |
...
| 15 | **Beastly Rift** Your spell becomes a summon animal spell of the same level. The animal attacks you. |
...
| 20 | **Bleeding Eyes** You take `1d6` persistent bleed damage. |
| 21 | **Tangled in Your Gear** You are encumbered until you spend 2 Interact actions to free your self. |
| 22 | **Distance Rift** You are teleported to the nearest space adjacent to your spell's target. |
| 23 | **Mind Drain** Until healed, you are stupefied. |
| 24 | **Vertigo** You are sickened. |
...
| 27 | **Tiring Spell** You are fatigued. |
...
| 44 | **You Made 'em Faster** The target is quickened for 2 rounds. |
| 45 | **Jumbled Components** You are slowed until the end of your next turn. |
| 46 | **Clatto Verata Necktie** You critically hit your nearest ally. |
| 47 | **Cursed** You are doomed. |
| 48 | **Magical Smackdown** You automatically fail (but do not critically fail) your next saving throw. |
| 49 | **Wild Magic** Roll twice on the rod of wonder table. You are the target of those effects. |
| 50 | **Draining Magic** You are drained. |
| 51 | **Everything to Fear** You are frightened. |
| 52 | **Now I See You...** Your target becomes invisible until the end of its next turn or uses a hostile action. |
| 53 | **It's So Sparkly!** You are blinded until the end of your next turn. |
| 54 | **Wild Magic** Roll twice on the rod of wonder table. You are the target of those effects. |
