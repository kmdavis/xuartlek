...
# Trick Shot  *Feat 10*  [>>](books/player-core/chapter-8-playing-the-game/actions#Actions "Two-Action")

`Gunslinger`

- **Archetypes**: Bullet Dancer (Level 12), Pistol Phenom (Level 12), Unexpected Sharpshooter (Level 10), Bullet Dancer (Level 12), Pistol Phenom (Level 12), Unexpected Sharpshooter (Level 10)
