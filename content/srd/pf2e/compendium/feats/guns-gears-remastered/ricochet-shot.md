...
# Ricochet Shot  *Feat 12*  [>](books/player-core/chapter-8-playing-the-game/actions#Actions "Single Action")

`Concentrate`  `Gunslinger`

- **Archetypes**: Bullet Dancer (Level 14), Bullet Dancer (Level 14)
