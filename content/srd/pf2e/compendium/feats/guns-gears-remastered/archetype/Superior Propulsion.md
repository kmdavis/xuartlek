...
aon_url: "https://2e.aonprd.com/Feats.aspx?ID=3150"
 ...
 **Clockwork** More resilient gears allow the vehicle to remain functional, even when damaged. If your signature vehicle is [[srd/pf2e/compendium/rules-elements/Conditions#Broken|broken]], it does not need to make the flat check to avoid losing operating time.
 ...
 **Steam** The outlet of steam forms a cloud around the vehicle as it moves. For the duration of its movement, your signature vehicle is [[srd/pf2e/compendium/rules-elements/Conditions#Concealed|concealed]].
