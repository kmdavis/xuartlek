...
aon_url: "https://2e.aonprd.com/Feats.aspx?ID=8311"
source: "Dark Archives (Remastered)"
socialImage: og-image.png
---

# Counter Thought  *Feat 1*  [<](books/player-core/chapter-8-playing-the-game/actions#Actions "Reaction")

`Occult`  `Psychic`

- **Trigger**: A creature Casts a Spell with the [[srd/pf2e/compendium/rules-elements/traits/player-core/mental|mental]] trait.
