...
- trait/oracle
- feat/level/10
aliases: ["On Borrowed Time"]
aon_url: "https://2e.aonprd.com/Feats.aspx?ID=8527"
source: "Dark Archives (Remastered)"
---

# On Borrowed Time  *Feat 10*  [>>](books/player-core/chapter-8-playing-the-game/actions#Actions "Two-Action")

`Cursebound`  `Divine`  `Oracle`

- **Prerequisites**: [[srd/pf2e/compendium/character/mysteries#Time|time mystery]]
