...
---
**Amp** Choose one creature hit by the spell (if the spell has a spell attack roll) or that fails its save against the spell (if the spell requires a save). A psychic beacon emits from the creature's location, making it easier to notice the creature as the mind and attention of onlookers is subtly drawn to it. For 1 minute, if the target would be [[srd/pf2e/compendium/rules-elements/conditions#Invisible|invisible]], it's instead merely [[srd/pf2e/compendium/rules-elements/conditions#Concealed|concealed]], and if it would be concealed, it's no longer concealed.
