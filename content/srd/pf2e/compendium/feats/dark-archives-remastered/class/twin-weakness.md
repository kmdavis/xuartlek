...
- **Requirements**: You're holding an implement and a weapon, you are using [[srd/pf2e/compendium/rules-elements/actions/dark-archives-remastered#Exploit Vulnerability|Exploit Vulnerability]] with mortal weakness or personal antithesis, and the target creature is within reach of both your implement and weapon.
