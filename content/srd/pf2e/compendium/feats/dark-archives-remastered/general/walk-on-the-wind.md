...
`Aftermath`  `Air`  `Magical`  `Rare`

- **Prerequisites**: You've been brought to 0 Hit Points by an enemy that has the [[srd/pf2e/compendium/rules-elements/traits/player-core/air|air]] trait or an enemy's ability that has the air trait.
