...
- trait/druid
- feat/level/12
aliases: ["Defensive Dismissal"]
aon_url: "https://2e.aonprd.com/Feats.aspx?ID=5404"
source: "Howl of the Wild"
---

# Defensive Dismissal  *Feat 12*  [<](books/player-core/chapter-8-playing-the-game/actions#Actions "Reaction")

`Druid`

- **Trigger**: A creature you’re aware of critically succeeds on a Strike against you.
- **Requirements**: You’re under a [[srd/pf2e/compendium/rules-elements/traits/player-core/polymorph|polymorph]] effect that you can [[srd/pf2e/compendium/rules-elements/actions/player-core#Dismiss|Dismiss]].
