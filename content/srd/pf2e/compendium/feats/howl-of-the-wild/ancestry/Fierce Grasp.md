...
- feat/level/5
aliases: ["Fierce Grasp"]
aon_url: "https://2e.aonprd.com/Feats.aspx?ID=5307"
source: "Howl of the Wild"
socialImage: og-image.png
---

# Fierce Grasp  *Feat 5*  [>](books/player-core/chapter-8-playing-the-game/actions#Actions "Single Action")

`Awakened Animal`

- **Prerequisites**: [[srd/pf2e/compendium/character/ancestries/Awakened Animal#Climbing Animal|Climbing Animal]] heritage
