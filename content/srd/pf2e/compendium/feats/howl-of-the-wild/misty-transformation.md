...
- trait/primal
- feat/level/6
aliases: ["Misty Transformation"]
aon_id: "feat-5402"
source: "Howl of the Wild"
---

# Misty Transformation  *Feat 6*  [<](books/player-core/chapter-8-playing-the-game/actions#Actions "Reaction")

`Druid`  `Primal`

- **Frequency**: once per minute
- **Trigger**: You transform due to a polymorph effect.
