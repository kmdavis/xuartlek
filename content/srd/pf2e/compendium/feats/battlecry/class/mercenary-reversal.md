...
**Success** The target is [[srd/pf2e/compendium/rules-elements/conditions#Stunned|stunned]] 1 as it is forced to consider the merits of your offer. 
**Failure** The target swaps sides and joins you for the duration of the battle. It gains the [[srd/pf2e/compendium/rules-elements/conditions#Controlled|controlled]] condition, but it can attempt a Will save whenever it takes damage or whenever you direct it to take an action that goes against its nature. On a success, the effect ends and it rejoins its former allies. 
