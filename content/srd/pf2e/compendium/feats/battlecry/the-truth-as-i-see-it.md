...
You don't take a penalty to Deception checks while subject to the _ring of truth_ spell or similar effects. Whenever you are subject to _ring of truth_ or a similar effect, you can attempt a Deception check when you first begin speaking to counteract the spell's effects, with a counteract rank equal to half your level (rounded up); succeeding at this check doesn't end the spell or effect, but it does cause it to indicate that you are speaking the truth, even when you are actually lying.
