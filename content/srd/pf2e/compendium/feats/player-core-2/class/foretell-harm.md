...
- **PFS Note**: The oracle's Foretell Harm feat can be used on all targets of an area-of-effect spell, not just a singular target.
- **Frequency**: once per round
- **Requirements**: Your previous action was to [[srd/pf2e/compendium/rules-elements/actions/player-core#Cast a Spell|Cast]] a non-cantrip Spell that dealt damage
