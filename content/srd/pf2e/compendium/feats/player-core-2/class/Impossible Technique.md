...
aon_url: "https://2e.aonprd.com/Feats.aspx?ID=6051"
source: "Player Core 2"
socialImage: og-image.png
---

# Impossible Technique  *Feat 20*  [<](books/player-core/chapter-8-playing-the-game/actions#Actions "Reaction")

`Fortune`  `Monk`

- **Trigger**: An enemy’s attack hits you or you fail a saving throw against an enemy’s ability.
- **Requirements**: You are not armored or [[srd/pf2e/compendium/rules-elements/conditions#Fatigued|fatigued]].
