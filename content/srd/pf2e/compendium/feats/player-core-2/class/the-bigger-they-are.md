...
With reckless speed, you dash, jump and swing around a creature to find a more vulnerable spot. Attempt to [[srd/pf2e/compendium/rules-elements/actions/player-core#Tumble Through|Tumble Through]] a creature at least one size category larger than you, using the following effects.
