...
aon_url: "https://2e.aonprd.com/Feats.aspx?ID=6303"
source: "Player Core 2"
---

# Distracting Flattery  *Feat 4*  [<](books/player-core/chapter-8-playing-the-game/actions#Actions "Reaction")

`Archetype`  `Skill`

- **Archetypes**: [[srd/pf2e/compendium/character/archetypes/dandy|Dandy]], Venture-Gossip (Level 4)
- **Prerequisites**: [[srd/pf2e/compendium/feats/player-core-2/archetype/dandy-dedication|Dandy Dedication]]; Expert in [[srd/pf2e/compendium/rules-elements/skills/deception|Deception]]
- **Trigger**: You observe a target’s attitude toward yourself or your allies decrease as a result of an ally’s behavior.

You know how to maintain a good impression and manage your image, even while keeping uncouth company. Make a [[srd/pf2e/compendium/rules-elements/skills/deception|Deception]] check against the target’s Will DC. Regardless of your result, the target is temporarily immune to your Distracting Flattery for 10 minutes.
