...
# Dread Marshal Stance  *Feat 4*  [>](books/player-core/chapter-8-playing-the-game/actions#Actions "Single Action")

`Archetype`  `Stance`

- **Archetype**: [[srd/pf2e/compendium/character/archetypes/marshal|Marshal]]
- **Prerequisites**: [[srd/pf2e/compendium/feats/player-core-2/archetype/marshal-dedication|Marshal Dedication]]; Trained in [[srd/pf2e/compendium/rules-elements/skills/intimidation|Intimidation]]
