...
- trait/tripkee
- feat/level/5
aliases: ["Tripkee Glide"]
aon_url: "https://2e.aonprd.com/Feats.aspx?ID=5704"
source: "Player Core 2"
socialImage: og-image.png
---

# Tripkee Glide  *Feat 5*  [>](books/player-core/chapter-8-playing-the-game/actions#Actions "Single Action")

`Tripkee`

- **Prerequisites**: [[srd/pf2e/compendium/character/ancestries/Tripkee#Windweb Tripkee|Windweb Tripkee]] heritage
