...
- **Archetype**: Cavalier
- **Prerequisites**: Trained in Nature or Trained in Society
...
Cavalier's Banner, Cavalier's Charge, Cushion Landing, Dashing Pickup, Defend Mount, Impressive Mount, Legendary Rider, Mounted Shield, Mounting Leap, Quick Mount, Rearing Display, Trampling Charge, Unseat, Vaulting Gallop
