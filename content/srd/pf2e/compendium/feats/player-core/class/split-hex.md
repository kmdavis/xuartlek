...
- feat/level/18
aliases: ["Split Hex"]
aon_url: "https://2e.aonprd.com/Feats.aspx?ID=5020"
source: "Player Core"
---

# Split Hex  *Feat 18*  [>](books/player-core/chapter-8-playing-the-game/actions#Actions "Single Action")

`Concentrate`  `Spellshape`  `Witch`  `Metamagic`
