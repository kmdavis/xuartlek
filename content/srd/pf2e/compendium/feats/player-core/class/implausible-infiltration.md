...
aon_url: "https://2e.aonprd.com/Feats.aspx?ID=4986"
source: "Player Core"
---

# Implausible Infiltration  *Feat 18*  [>>](books/player-core/chapter-8-playing-the-game/actions#Actions "Two-Action")

`Magical`  `Move`  `Rogue`

- **Prerequisites**: Legendary in [[srd/pf2e/compendium/rules-elements/skills/acrobatics|Acrobatics]]; [[srd/pf2e/compendium/feats/player-core/skill/quick-squeeze|Quick Squeeze]]
