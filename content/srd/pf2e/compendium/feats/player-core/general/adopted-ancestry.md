...
- **PFS Note**: The Adopted Ancestry feat can only be used to select common ancestries or ancestries which all Pathfinder agents have access to (such as kobolds).
