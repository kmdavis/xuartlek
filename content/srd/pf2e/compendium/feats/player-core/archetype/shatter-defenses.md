...
aon_url: "https://2e.aonprd.com/Feats.aspx?ID=4806"
source: "Player Core"
---

# Shatter Defenses  *Feat 6*  [>](books/player-core/chapter-8-playing-the-game/actions#Actions "Single Action")

`Fighter`  `Press`

- **Archetypes**: Blackjacket (Level 8), Hellknight (Level 8)
