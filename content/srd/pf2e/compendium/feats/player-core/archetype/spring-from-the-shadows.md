...
aon_url: "https://2e.aonprd.com/Feats.aspx?ID=4974"
source: "Player Core"
---

# Spring from the Shadows  *Feat 12*  [>](books/player-core/chapter-8-playing-the-game/actions#Actions "Single Action")

`Flourish`  `Rogue`

- **Archetypes**: Shadowdancer (Level 14), Rose Warden (Level 14), [[srd/pf2e/compendium/character/archetypes/veil-dancer|Veil Dancer]] (Level 14)
