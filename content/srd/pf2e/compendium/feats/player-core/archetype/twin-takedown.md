...
aon_url: "https://2e.aonprd.com/Feats.aspx?ID=4864"
source: "Player Core"
---

# Twin Takedown  *Feat 1*  [>](books/player-core/chapter-8-playing-the-game/actions#Actions "Single Action")

`Flourish`  `Ranger`

- **Archetype**: [[srd/pf2e/compendium/character/archetypes/avenger|Avenger]] (Level 4)
