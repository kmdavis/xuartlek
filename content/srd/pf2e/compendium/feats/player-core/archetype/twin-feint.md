...
- feat/level/1
aliases: ["Twin Feint"]
aon_url: "https://2e.aonprd.com/Feats.aspx?ID=4921"
source: "Player Core"
---

# Twin Feint  *Feat 1*  [>>](books/player-core/chapter-8-playing-the-game/actions#Actions "Two-Action")

`Rogue`

- **Archetype**: Red Mantis Assassin (Level 2)
