...
- feat/level/4
aliases: ["Sabotage"]
aon_url: "https://2e.aonprd.com/Feats.aspx?ID=4936"
source: "Player Core"
---

# Sabotage  *Feat 4*  [>](books/player-core/chapter-8-playing-the-game/actions#Actions "Single Action")

`Incapacitation`  `Rogue`

- **Archetype**: Twilight Talon (Level 6)
