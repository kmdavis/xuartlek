...
aon_url: "https://2e.aonprd.com/Feats.aspx?ID=4267"
source: "Rage of Elements"
---

# Ocean's Balm  *Feat 1*  [>](books/player-core/chapter-8-playing-the-game/actions#Actions "Single Action")

`Healing`  `Impulse`  `Kineticist`  `Manipulate`  `Primal`  `Vitality`  `Water`  `Positive`
