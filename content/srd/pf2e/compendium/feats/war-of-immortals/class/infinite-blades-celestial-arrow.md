...
**Transcendence—Heaven Rains an Ending** [>>>](books/player-core/chapter-8-playing-the-game/actions#Actions "Three-Action") (transcendence) You shoot an arrow that multiplies into a dense cloud of weapons. Make one ranged Strike with a –2 penalty against each enemy you are aware of within a [[srd/pf2e/books/player-core/chapter-8-playing-the-game/area#Cone|cone]] as long as your weapon’s first range increment. Roll the damage only once for all targets, and all the Strike’s damage is spirit damage instead of its normal type. Each attack counts toward your multiple attack penalty, the penalty doesn’t increase until you have made all your attacks.
