...
# Seven-Colored Cosmic Bridge  *Feat 18*
...
**Transcendence—Fleeting Arc through Heaven and Earth** (light, spirit, teleportation, transcendence) [>>>](books/player-core/chapter-8-playing-the-game/actions#Actions "Three-Action") You swing your weapon in a wide arc, releasing a blazing rainbow that deals 9d6 spirit damage and 9d6 damage of the same type as your weapon to all enemies in a 60-foot [[srd/pf2e/books/player-core/chapter-8-playing-the-game/area#Cone|cone]], with a basic Fortitude save against your class DC. As the rainbow ripples out, you use it as a bridge to teleport to any location within the effect’s area.
