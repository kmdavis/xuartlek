...
aon_url: "https://2e.aonprd.com/ConsciousMinds.aspx?ID=11"
...
Your minor illusions shift and dance in a way that draws the eye. The range of _figment_ increases to 60 feet. When you Sustain the spell, you can move the apparent sound or vision up to 15 feet. You can then attempt to [[srd/pf2e/compendium/rules-elements/actions/player-core#Create a Diversion|Create a Diversion]] as usual. Those creatures who disbelieved the illusion aren't affected by this diversion. Your _figment_ also gains the following amp.
