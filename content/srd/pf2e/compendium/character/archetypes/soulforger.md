...
- archetype/level/2
aliases: ["Soulforger"]
aon_url: "https://2e.aonprd.com/Archetypes.aspx?ID=393"
source: "Impossible Magic"
---

# Soulforger  *Archetype 2*
...
Melee weapon only. The weapon gains the thrown 30 feet trait and has the _returning_ rune (even if it already has its maximum number of property runes).
...
Your Strikes deal an additional 1d4 negative damage. Once while the armament is manifested, you can cast _harm_ as an innate spell, with a level equal to half your level rounded up.
...
You gain fast healing equal to half your level. You can cast _heal_ once as an innate spell with a level equal to half your level rounded up.

**Corruption Flaw** Reduce all healing you would receive or grant with a spell by half your level.

### Magical Resilience

Armor or shield only. You gain a +2 status bonus to saving throws and AC against spells. If you're 5th level or higher, you can cast _dispel magic_ once as an innate spell. The spell level is equal to 1 lower than half your level rounded up (2nd level if you're 5th or 6th level, and so on).
