...
Feats like [[srd/pf2e/compendium/feats/impossible-magic/class/Burning Cascade|Burning Cascade]], [[srd/pf2e/compendium/feats/impossible-magic/class/Devastating Spellstrike|Devastating Spellstrike]], and [[srd/pf2e/compendium/feats/impossible-magic/class/Distracting Spellstrike|Distracting Spellstrike]] have values dependent on your Arcane Cascade damage. Note that abilities that can increase the extra damage, such as the [[srd/pf2e/compendium/character/Hybrid Studies#Laughing Shadow|laughing shadow]] and [[srd/pf2e/compendium/character/Hybrid Studies#Twofold Tine|twofold tine]] hybrid studies, apply only to the Strikes that meet their criteria, not to other abilities. This means feats like the listed ones use the base damage value, not the boosted one!

### Combining your Abilities

As a magus, you have multiple special actions and abilities that can be used in combination with your spells.

 **Arcane Cascade:** Sometimes it's in your best interest to use Arcane Cascade before you Spellstrike at the start of combat, possibly casting a buff spell in the same round, rather than going for a Spellstrike right away. You can usually stay in Arcane Cascade for a long time, though if you find out an enemy has a weakness to a certain damage type, such as fire, you might want to refresh your stance after a fire spell to take advantage of the bonus damage.

 **Conflux Spells:** It's often worth it to cast a conflux spell and make a Strike either on a turn where you can't make a Spellstrike, or as the last action on your turn after a Spellstrike. Even if you think its Strike will miss, it might be worth it to cast a conflux spell if the spell does something else useful for you and recharges your Spellstrike for your next turn.

 **Spellstrike:** Since a lot can ride on your Spellstrike, which uses your multiple attack penalty, it's much better if used as the first attack of the turn! Because spells with DCs still require the target to save if Spellstrike misses, it can be better to use a spell with a DC against a more powerful enemy you're less likely to hit.

### Key Terms

You’ll see the following key term in many magus abilities.
...
Continually refine your spell and item selections to suit your personal style, or prepare battle plans and spell lists for a variety of situations.Socialize with scholars of magic and veteran combatants alike, seeking out masters to teach you new techniques.Overreach with ambitious plans that pull you in too many directions at once.

#### Others Probably...

Wonder how you can keep on top of two disparate disciplines at the same time.Believe you have a broad enough skill set to take care of yourself in most situations.
...
You study spells so you can combine them with your attacks or solve problems that strength of arms alone can't handle. You are a spellcaster, and you can cast spells of the arcane tradition using the Cast a Spell activity. As a magus, when you cast spells, you might draw sigils with your weapon or a free hand and shout magical words of power as battle cries.

 At 1st level, you can prepare one 1st-rank spell and five cantrips each morning from the spells in your spellbook (see below). Prepared spells remain available to you until you cast them or until you prepare your spells again. The number of spells you can prepare is called your spell slots.
...
#### Spellbook
 ...
 The spellbook contains your choice of eight arcane cantrips and five 1st-rank arcane spells. You choose these from the common spells on the [arcane spell list](https://2e.aonprd.com/SpellLists.aspx?Tradition=1) or from other arcane spells you gain access to.
 ...
 **Spellshape:** Even if you gain a spellshape action from outside the magus class, such as from a multiclass feat or an item, you typically can't use spellshape with Spellstrike. Spellshape actions require the next action you take to be Cast a Spell, and Spellstrike is a combined activity that doesn't qualify.

#### Arcane Cascade

You can enter a special stance to blend magic into your attacks and defend against spells. 

#### Hybrid Study

Your extensive physical training and carefully chosen magic combine to form a unique and dangerous fighting style that's more than the sum of its parts. You choose one field of hybrid study to represent your particular combination of skills. Your hybrid study gives you a special ability, usually tied to Spellstrike or Arcane Cascade, and it determines your initial conflux spell. Your hybrid study will also grant you the listed studious spells, starting when you gain that class feature at 7th level. The hybrid studies can be found [[srd/pf2e/compendium/character/Hybrid Studies|here]].
...
| | |
| --- | --- |
| **Magus Feats** | At 2nd level and every 2 levels thereafter, you gain a [magus class feat](https://2e.aonprd.com/Feats.aspx?Traits=953). |
...
Your fundamental understanding of magic improves, making your spells harder to resist. Your proficiency ranks for your spell attack modifier and spell DC increase to expert.
...
Mental diligence and combat resolve combine to fortify you against mental attacks. Your proficiency rank for Will saves increases to master. When you roll a success on a Will save, you get a critical success instead.

| | |
| --- | --- |
| **Medium Armor Expertise** | You’ve learned to defend yourself better against attacks. Your proficiency ranks for light armor, medium armor, and unarmored defense increase to expert. |
...
The mighty spells flowing through your body have bolstered you physically. Your proficiency rank for Fortitude saves increases to master. When you roll a success on a Fortitude save, you get a critical success instead.

| | |
| --- | --- |
| **Master Spellcaster** | You fortify your spells with masterful prowess. Your proficiency ranks for your spell attack modifier and spell DC increase to master. |
...
When adding a spell to an attack simply isn’t enough, you combine two spells with your attack instead. You gain the Double Spellstrike activity.
