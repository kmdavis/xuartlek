...
- trait/morph
aliases: ["Morph"]
aon_url: "https://2e.aonprd.com/Traits.aspx?ID=657"
source: "Player Core"
---
...
Effects that slightly alter a creature's form have the morph trait. Any Strikes specifically granted by a morph effect are magical. You can be affected by multiple morph spells at once, but if you morph the same body part more than once, the second morph effect attempts to counteract the first (in the same manner as two [[srd/pf2e/compendium/rules-elements/traits/player-core/polymorph|polymorph]] effects, described in that trait).
