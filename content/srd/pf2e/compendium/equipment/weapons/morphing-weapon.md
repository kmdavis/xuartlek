...
In its base form, this armament looks like a smooth bar of soft, gleaming metal shaped like a horseshoe. Its ability to adjust to any battle situation makes it a popular weapon for elite warriors of the [[srd/pf2e/compendium/rules-elements/traits/player-core/metal|Plane of Metal]]. It can be shaped into a melee weapon using its _shifting_ rune, but it can shift only into weapons primarily made of metal or back to its base shape. In weapon form, it's a +_1 striking shifting weapon_.
