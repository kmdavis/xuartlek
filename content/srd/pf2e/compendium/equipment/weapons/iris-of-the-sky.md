...
This _+1 striking [[srd/pf2e/compendium/equipment/weapons/firearm/jezail|jezail]]_ is built from white hot metal and has a ruby fused into the palm wood stock. When the _iris of the sky_ misfires, you take 5 persistent fire damage.
...
**Activate** [>](books/player-core/chapter-8-playing-the-game/actions#Actions "Single Action") [[srd/pf2e/compendium/rules-elements/traits/player-core/concentrate|concentrate]] **Frequency** once per minute; **Effect** You focus the solar energy housed in the ruby to release a gout of solar flame instead of a bullet. Make a Strike with the _iris of the sky_. All damage from this Strike is fire damage and the target takes an additional 1d6 fire damage and 1d6 persistent fire damage.

**Activate** [>>](books/player-core/chapter-8-playing-the-game/actions#Actions "Two-Action") command, envision ([[srd/pf2e/compendium/rules-elements/traits/player-core/fortune|fortune]]) **Frequency** once per minute; **Effect** You make a wish into the _iris of the sky_, yearning for it to strike true, and then fire. Strike against a foe with the iris, rolling the attack roll twice and taking the better result. If the attack is a failure, you take 5 persistent fire damage.
