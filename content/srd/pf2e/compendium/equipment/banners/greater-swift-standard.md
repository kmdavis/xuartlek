...
- trait/rare
- equipment/level/15
aliases: ["Greater Swift Standard"]
aon_id: "equipment-3917-3647"
source: "Battlecry!"
---

# Greater Swift Standard  *Item 12+*

`Air`  `Aura`  `Magical`  `Rare`
...
### Greater Swift Standard

**Price** 6,500 gp

---

The magical banner instead grants a +10-foot status bonus to land Speeds for 1 round. 

### Major Swift Standard

**Price** 24,000 gp

---

The magical banner instead grants a +15-foot status bonus to land Speeds for 1 round.
