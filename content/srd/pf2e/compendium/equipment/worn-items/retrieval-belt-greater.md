...
aon_id: "equipment-3102-3049"
source: "GM Core"
---

# Retrieval Belt (Greater)  *Item 7+*

`Extradimensional`  `Invested`  `Magical`  `Uncommon`
...
**Activate—Store Item** [>](books/player-core/chapter-8-playing-the-game/actions#Actions "Single Action") ([[srd/pf2e/compendium/rules-elements/traits/player-core/manipulate|manipulate]]) **Requirements** There is room for an item in the belt; **Effect** One item you're holding with a Bulk of 1 or less vanishes into the belt's extradimensional space. 

**Activate—Retrieve Item** [ ](books/player-core/chapter-8-playing-the-game/actions#Actions "Free Action") ([[srd/pf2e/compendium/rules-elements/traits/player-core/manipulate|manipulate]]) **Requirements** An item is stored in the belt and you have a free hand; **Effect** The item stored in the belt appears in your hand. Neither Store Item nor Retrieve Item can be activated again for 1 minute.
...
The belt can store up to three items at a time.
...
The belt can store up to 10 items at a time.
