...
**Activate—True Love’s Power** [<](books/player-core/chapter-8-playing-the-game/actions#Actions "Reaction") ; **Trigger** You would die due to a [[srd/pf2e/books/player-core/chapter-8-playing-the-game/hit-points-healing-and-dying#Death Effects|death effect]] rather than the [[srd/pf2e/compendium/rules-elements/conditions#Dying|dying]] condition; **Effect** Your love pulls you back from the brink of death and the locket cracks. You avoid dying and remain at 1 Hit Point. You cannot use the ability again until you replace the casing of the locket, which typically takes around 1 month and costs 600 gp.
