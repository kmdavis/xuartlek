...
When used as catalysts, _chaos falcon feathers_ lend flexibility to spells that deal with elemental energy. For the duration of a catalyzed [[srd/pf2e/compendium/spells/rank-2/resist-energy|_resist energy_]] spell, you can [[srd/pf2e/compendium/rules-elements/actions/player-core#Sustain|Sustain]] the Spell on an adjacent target, touching them and changing the type of energy to which they have resistance. This reduces the remaining duration of the spell by 1 minute; if the spell has less than a minute remaining, it reduces the duration to 1 round.
