...
aon_id: "equipment-544"
source: "Treasure Vault (Remastered)"
---

# Grinning Pugwampi  *Item 14*

`Consumable`  `Enchantment`  `Magical`  `Misfortune`  `Talisman`  `Uncommon`
...
**Activate** [ ](books/player-core/chapter-8-playing-the-game/actions#Actions "Free Action") envision; **Trigger** You damage a flat-footed creature with the affixed weapon; **Effect** The damaged creature must attempt a DC 33 Will save.
...
*Source: Treasure Vault (Remastered) p. 94*
