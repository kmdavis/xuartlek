...
aon_url: "https://2e.aonprd.com/Equipment.aspx?ID=951"
...
`Abjuration`  `Consumable`  `Fulu`  `Magical`  `Uncommon`

- **Price**: 1, 900 gp
- **Usage**: affixed to armor
- **Activate**: [ ](books/player-core/chapter-8-playing-the-game/actions#Actions "Free Action") command
