...
aon_id: "equipment-3402-3249"
source: "Player Core 2"
---

# Potion of Disguise (Moderate)  *Item 5+*

`Consumable`  `Magical`  `Polymorph`  `Potion`  `Uncommon`
...
The effects of this potion use the same rules as the [[srd/pf2e/compendium/rules-elements/actions/player-core#Impersonate|Impersonate]] activity of Deception. Onlookers always assume you're the chosen type of creature unless they're actively Seeking. You gain a +4 status bonus to your Deception DC against such Perception checks and add your level even if untrained.
...
The _moderate potion of disguise_ can increase your size if the creature is larger than you, to a maximum of Large, and it can shrink you to a creature of size Tiny. This doesn't change any of your statistics, with the exception of reducing your reach to 0 feet as a Tiny creature.
