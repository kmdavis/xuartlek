...
`Artifact`  `Divine`  `Intelligent`  `Unique`
...
**Skills** Iomedae Lore +29, [[srd/pf2e/compendium/rules-elements/skills/religion|Religion]] +26, Zon-Kuthon Lore +29
...
**Activate—Grace of the Inheritor** ([[srd/pf2e/compendium/rules-elements/traits/player-core/concentrate|concentrate]]) **Frequency** once per hour; **Effect** _Serithtial_ spends the appropriate number of actions and casts a 9th-rank _heal_ or [[srd/pf2e/compendium/spells/rank-3/ring-of-truth|_ring of truth_]] spell (DC 45 for either of the two spells).
