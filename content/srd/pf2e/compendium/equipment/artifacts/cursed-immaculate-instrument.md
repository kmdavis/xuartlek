...
aon_id: "equipment-3514-3393"
source: "War of Immortals"
---

# Cursed Immaculate Instrument  *Item 12+*

`Cursed`  `Artifact`  `Divine`  `Mythic`  `Rare`

- **Usage**: worn or held in 1 hand
- **Bulk**: L

This object, made of silver light, takes the form of a small musical instrument, prop, or other tool associated with a specific art form. The holder of the _immaculate instrument_ never suffers from creative blocks of any kind and their work is always insightful and skilled. A character who uses the _immaculate instrument_ to [[srd/pf2e/compendium/rules-elements/actions/player-core#Perform|Perform]] or [[srd/pf2e/compendium/rules-elements/actions/player-core#Craft|Craft]] can attempt the check at mythic proficiency once per month, and as long as they possess their _immaculate instrument_, they treat any critical failures with these skills as failures.
