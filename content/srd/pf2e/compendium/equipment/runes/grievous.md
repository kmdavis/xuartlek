 ...
 **Crossbow** If the target of the critical hit is adjacent to a surface, it gets stuck to that surface by the missile, as the [[srd/pf2e/compendium/rules-elements/Weapon Groups#Bow|bow]] critical specialization.
