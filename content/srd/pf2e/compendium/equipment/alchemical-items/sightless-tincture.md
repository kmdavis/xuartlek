...
- trait/uncommon
- equipment/level/9
aliases: ["Sightless Tincture"]
aon_url: "https://2e.aonprd.com/Equipment.aspx?ID=2013"
...
- **PFS Note**: The clause of sightless tincture which states that "the blinded condition from this poison lasts for an additional 24 hours once the poison has run its course" only applies if the victim reaches Stage 3 and is blinded.
- **Price**: 115 gp
