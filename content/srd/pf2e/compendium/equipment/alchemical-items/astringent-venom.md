 ...
 **Saving Throw** DC 32 Fortitude; **Onset** 1 round; **Maximum Duration** 6 rounds; **Stage 1** 6d6 poison damage (1 round); **Stage 2** 8d6 poison damage (1 round); **Stage 3** 10d6 poison damage and [[srd/pf2e/compendium/rules-elements/conditions#Confused|confused]] (1 round)
