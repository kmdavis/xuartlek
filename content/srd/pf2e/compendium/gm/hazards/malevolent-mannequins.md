...
`Clockwork`  `Complex`  `Haunt`  `Mechanical`  `Uncommon`

- **Complexity**: Complex A host of violent spirits possess three clockwork mannequins, and each lashes out at any creatures that dare walk near.
