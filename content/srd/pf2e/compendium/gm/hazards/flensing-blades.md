...
---
**Routine**
(3 actions) The tornado of blades uses 3 actions to move, traveling up to 30 feet with each action and dealing 2d10+10 slashing damage. Each creature in its path must attempt a DC 33 Reflex save. Each successful check to [[srd/pf2e/compendium/rules-elements/actions/player-core#Disable a Device|disable]] this hazard reduces the haunt’s movement by 30 feet, and the fourth success disables it completely. 
