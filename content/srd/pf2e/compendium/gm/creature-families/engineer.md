...
| 2 | **Backfire** The device violently explodes, disabling it and dealing 1d6 bludgeoning damage for every 2 levels the engineer has in a 5-foot burst centered on the device. The device is broken until the engineer [[srd/pf2e/compendium/rules-elements/actions/player-core#Repair\|Repairs]] it. |
...
Multiple engineers use firearms, technology that's present in relatively small numbers on Golarion. These are [[srd/pf2e/compendium/rules-elements/traits/player-core/Uncommon|uncommon]], simple, and martial weapons, so many player characters can use them. If you want to avoid putting the items in their hands, swap out the firearms with [[srd/pf2e/compendium/rules-elements/Weapon Groups#Crossbow|crossbow]] or similar weapons. [[srd/pf2e/compendium/rules-elements/Weapon Groups#Firearm|More firearms]] and the [[srd/pf2e/compendium/character/classes/Gunslinger|gunslinger]] class appear in _Pathfinder Guns & Gears_.

### Gadgets For PCs

Since engineers often carry unique gadgets, your player characters will likely want to salvage and reuse those items. If you want to do this in your games, you can either let them use the items primarily as written or convert them into consumable [gadgets](https://2e.aonprd.com/Equipment.aspx?Category=15&Subcategory=71). In any case, these items are typically unstable when salvaged, usable once to a few times or subject to misfires.
