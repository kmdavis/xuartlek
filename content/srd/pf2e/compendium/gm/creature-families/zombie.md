...
Plague Zombie (Creature 1), Shambler Troop (Creature 4), Sulfur Zombie (Creature 6), Zombie Bear (Creature 3), Zombie Brute (Creature 2), Zombie Desecrator (Creature 17), Zombie Dragon (Creature 9), Zombie Hulk (Creature 6), Zombie Shambler (Creature -1)
