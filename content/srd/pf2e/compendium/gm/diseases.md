...
_Nethys Note: No traits were printed with this version of the disease, so the traits are assumed to be the same as the legacy entry._
...
**Stage 3** 3** clumsy 2 and a –10-foot status penalty to Speed (1 day)
...
**Stage 3** sickened 3 and can’t speak (1 day)
...
**Stage 2** 2d6 bludgeoning damage, and whenever you gain the wounded condition, increase the condition value by 1 (1 day)
