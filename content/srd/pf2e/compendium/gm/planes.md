...
The River of Souls draws the attention of soul-hunting [[srd/pf2e/compendium/gm/creature-families/daemon|daemons]] and opportunistic night hags like sharks drawn to the scent of blood. Led by [[srd/pf2e/compendium/gm/creature-families/psychopomp|psychopomps]], a cross section of nearly every type of [[srd/pf2e/compendium/rules-elements/traits/player-core/celestial|celestial]] and [[srd/pf2e/compendium/rules-elements/traits/player-core/monitor|monitor]] in existence, along with some [[srd/pf2e/compendium/rules-elements/traits/player-core/fiend|fiends]], defends the proper flow of souls against such predators. Running opposite the River of Souls is the flow of raw quintessence spun off from the so-called Antipode, channeled by aeons back toward the [[srd/pf2e/compendium/gm/planes#Creation's Forge|Creation’s Forge]].
...
- **Category**: Transitive Planes
- **Divinities**: Alazhra
- **Native Inhabitants**: ether spiders, [[srd/pf2e/compendium/gm/creature-families/hag|hags]], shades (terrorized)

The Ethereal Plane is a vast, misty realm overlapping each of the [[srd/pf2e/books/gm-core/chapter-3-age-of-lost-omens/the-planes#Inner Sphere Planes|Inner Planes]]. Formed by the interacting tidal forces of creation and destruction from [[srd/pf2e/compendium/gm/planes#Creation's Forge|Creation’s Forge]] and [[srd/pf2e/compendium/gm/planes#The Void|the Void]], this plane swirls with currents and eddies of fog, lit only by erratic pulses of soft green luminescence and dim light of those planes it overlays, visible but ever intangible. While mortals most often use the Ethereal Plane as a means of transit, moving by force of will in the absence of gravity to bypass barriers on their own plane, the Ethereal hosts dangers and wonders, things lost or abandoned in the mists, and things spun from local eddies in the ethereal protomatter. Predatory monsters, ether spiders, [[srd/pf2e/compendium/gm/creature-families/hag|hags]] and their goddess Alazhra, and all manner of incorporeal [[srd/pf2e/compendium/rules-elements/traits/player-core/undead|undead]] roam the Space Between Spaces.
...
- **Native Inhabitants**: [[srd/pf2e/compendium/rules-elements/traits/player-core/fey|fey]], [[srd/pf2e/compendium/gm/creature-families/linnorm|linnorms]]

The First World was a first draft of [[srd/pf2e/compendium/gm/planes#The Universe|the Universe]], crafted by divinities to test their metaphorical materials and palettes of colors before setting it aside to create a second, final version of their work. A realm of extremes—bestial, primal, and beautiful— with colors and sensations brighter and more intense than the mundane world created after it, the First World is populated by [[srd/pf2e/compendium/rules-elements/traits/player-core/fey|fey]] and the divine entities known as the Eldest. Mirroring mercurial fey whimsy, the First World’s laws of nature constantly and unpredictably change. Distance and time are wildly inconsistent, such that mortal travelers might spend an hour or a day within the First World, only to find a century or only a few seconds passed once they return to their own plane.

The First World stands outside the cycle of souls, something the fey call the Great Abandonment, save for rare worshippers of the Eldest whose souls incarnate here as fey. However, the plane’s proximity to [[srd/pf2e/compendium/gm/planes#Creation's Forge|Creation’s Forge]] provides an environment bursting with all manner of strange life and a general absence of true death for its native fey unless they leave—as did [[srd/pf2e/compendium/character/ancestries/gnome|gnomes]]. Natural gates in wild places of the mortal realm connect to the First World, which fey often use to visit the Universe or ensnare mortals for their capricious desires.
...
Swirling with oddities and wild magic, bereft of laws and structure, the Maelstrom also serves as a conduit between the other Outer Planes utilized by armies of extraplanar beings, hordes of [[srd/pf2e/compendium/gm/creature-families/demon|demons]] spilling forth from the [[srd/pf2e/compendium/gm/planes#Outer Rifts|Outer Rifts]], and the innumerable protean choruses seeking to return the rest of the planes to the true freedom of the chaos from which they emerged. Sufficiently powerful magic can stabilize the chaos for a time, allowing for the creation of demiplanes and stable islands. The massive planar trade city of Galisemni is most prominent among them, drifting through the chaos.
...
- **Native Inhabitants**: [[srd/pf2e/compendium/gm/creature-families/elemental-air|air elementals]], cloud dragons, [[srd/pf2e/bestiary/monster-core/elemental/jaathoom|jaathooms]], shades (air pneuma)
...
- **Native Inhabitants**: [[srd/pf2e/compendium/gm/creature-families/elemental-fire|fire elementals]], [[srd/pf2e/bestiary/monster-core/elemental/ifrit|ifrits]], magma dragons, [[srd/pf2e/compendium/gm/creature-families/munsahir|munsahirs]], shades (fire pneuma)
...
- **Native Inhabitants**: brine dragons, [[srd/pf2e/bestiary/monster-core/elemental/faydhaan|faydhaans]], shades (water pneuma), [[srd/pf2e/compendium/gm/creature-families/elemental-water|water elementals]]

Beyond the skies of the [[srd/pf2e/compendium/gm/planes#Plane of Air|Plane of Air]], the roots of the newly regrown [[srd/pf2e/compendium/gm/planes#Plane of Wood|Plane of Wood]] are nurtured by the vast, spherical, liquid shell of the Plane of Water. Its nearly limitless stretches of saline, fresh, and brackish seas teem with all manner of oceanic life, lit by submerged suns and bioluminescence before descending into the black, benthic depths where the plane borders the [[srd/pf2e/compendium/gm/planes#Plane of Earth|Plane of Earth]]. While it’s perfectly amenable to water-breathing creatures, air-breathing travelers must provide their own supply of air or magical means to breathe while on the plane. Bubbles of breathable atmosphere are relatively rare and securely guarded, anchored over places of trade and commerce with outsiders, such as the great city of Vialesk, founded by immigrant undines. The plane’s oceans, dotted by vast forests of kelp, magical currents, and strange phenomena, play host to empires of [[srd/pf2e/compendium/gm/creature-families/merfolk|merfolk]], predatory and expansionist sea devils, and the holdings of the plane’s great brine dragons.

While [[srd/pf2e/bestiary/monster-core/elemental/faydhaan|faydhaans]] once claimed nearly absolute dominion over the plane of their origin, their empire long ago fell into deterioration and disunity. Their ravaged cities sank into the depths, and their present-day holdings remain a shadow of their former grandeur. Kelizandri the Brackish Emperor, the prideful elemental lord of water and cause of the genies’ ruin, rules the dark, saline depths, feasting on all rivals and hoarding the vast, stolen wealth of the fallen faydhaan cities—but the return of his counterpart Lysianassa, Empress of the Torrent, now threatens his hold on the plane. Unlike other subjective gravity planes, on the Plane of Water, a creature moves based on its [[srd/pf2e/books/player-core/chapter-8-playing-the-game/movement#Swim Speed|swim Speed]] and must use actions to [[srd/pf2e/compendium/rules-elements/actions/player-core#Swim|Swim]] if it doesn’t have one.
...
- **Native Inhabitants**: [[srd/pf2e/compendium/character/ancestries/dwarf|dwarves]], [[srd/pf2e/compendium/character/ancestries/elf|elves]], [[srd/pf2e/compendium/character/ancestries/halfling|halflings]], [[srd/pf2e/compendium/character/ancestries/human|humans]], [[srd/pf2e/compendium/character/ancestries/gnome|gnomes]], [[srd/pf2e/compendium/character/ancestries/goblin|goblins]], and countless other ancestries
...
Yet, for all the profound wonder and diversity of life that the Universe houses, strange alien gods and the sinister collective of malevolent beings known as the [[srd/pf2e/compendium/gm/creature-families/dominion-of-the-black|Dominion of the Black]] lurk in the dark places between the stars known as the Dark Tapestry.

The Universe serves as the destination for pre-incarnate souls, each mortal life born, living, and dying before sending its spirit toward the [[srd/pf2e/books/gm-core/chapter-3-age-of-lost-omens/the-planes#Outer Sphere Planes|planes of the Outer Sphere]] for judgment. The Universe is likewise the focus of the gods, each of whom is invested in fostering their own particular portfolio among mortal worshippers and the material world at large.
