 ...
 **Mythic Ferocity** [<](books/player-core/chapter-8-playing-the-game/actions#Actions "Reaction") **Cost** 1 Mythic Point; **Trigger** The monster is reduced to 0 HP; Effect The monster avoids being knocked out and remains at half its maximum HP, but its wounded value increases by 1. When it is wounded 3, it can no longer use this ability.
 ...
 **Titanic** Might A mythic brute ignores size limitations when performing actions like [[srd/pf2e/compendium/rules-elements/actions/player-core#Grapple|Grapple]] or [[srd/pf2e/compendium/rules-elements/actions/player-core#Trip|Trip]]. 
