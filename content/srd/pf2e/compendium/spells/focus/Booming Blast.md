...
- trait/uncommon
- spell/level/1
aliases: ["Booming Blast"]
aon_url: "https://2e.aonprd.com/Spells.aspx?ID=2875"
source: "Impossible Magic"
socialImage: og-image.png
---

# Booming Blast  *Focus 1*  [>](books/player-core/chapter-8-playing-the-game/actions#Actions "Single Action")

`Concentrate`  `Emotion`  `Fear`  `Focus`  `Magus`  `Mental`  `Uncommon`
