...
- spell/level/3
aliases: ["Combustion"]
aon_url: "https://2e.aonprd.com/Spells.aspx?ID=1309"
source: "Rage of Elements"
socialImage: og-image.png
---

# Combustion  *Focus 3*  [>>](books/player-core/chapter-8-playing-the-game/actions#Actions "Two-Action")

`Concentrate`  `Druid`  `Fire`  `Focus`  `Manipulate`  `Uncommon`
