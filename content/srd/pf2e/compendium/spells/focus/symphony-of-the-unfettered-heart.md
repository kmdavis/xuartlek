...
aon_url: "https://2e.aonprd.com/Spells.aspx?ID=1777"
source: "Player Core"
---

# Symphony of the Unfettered Heart  *Focus 5*  [>>](books/player-core/chapter-8-playing-the-game/actions#Actions "Two-Action")

`Bard`  `Composition`  `Concentrate`  `Focus`  `Uncommon`
