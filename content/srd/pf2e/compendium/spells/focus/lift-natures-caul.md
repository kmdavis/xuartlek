...
aon_url: "https://2e.aonprd.com/Spells.aspx?ID=2375"
source: "Divine Mysteries"
---

# Lift Nature's Caul  *Focus 1*  [>>](books/player-core/chapter-8-playing-the-game/actions#Actions "Two-Action")

`Cleric`  `Concentrate`  `Fear`  `Focus`  `Manipulate`  `Uncommon`  `Visual`
...
[[srd/pf2e/compendium/rules-elements/traits/player-core/aberration|Aberrations]] or worshippers of Outer Gods or Great Old Ones are bolstered by this vision of warped reality and gain a +1 status bonus to Will saving throws and attack rolls for 1 minute, while all other creatures must attempt a Will saving throw.
...
**Failure** The creature is [[srd/pf2e/compendium/rules-elements/conditions#Stupefied|stupefied]] 1 for 1 minute and [[srd/pf2e/compendium/rules-elements/conditions#Frightened|frightened]] 1.
