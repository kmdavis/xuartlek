...
- spell/level/1
aliases: ["Force Bolt"]
aon_url: "https://2e.aonprd.com/Spells.aspx?ID=1896"
source: "Player Core"
socialImage: og-image.png
---

# Force Bolt  *Focus 1*  [>](books/player-core/chapter-8-playing-the-game/actions#Actions "Single Action")

`Focus`  `Force`  `Manipulate`  `Uncommon`  `Wizard`
