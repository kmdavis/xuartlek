...
aon_url: "https://2e.aonprd.com/Spells.aspx?ID=1770"
source: "Player Core"
---

# Loremaster's Etude  *Focus 1*  [ ](books/player-core/chapter-8-playing-the-game/actions#Actions "Free Action")

`Bard`  `Composition`  `Focus`  `Fortune`  `Manipulate`  `Uncommon`
