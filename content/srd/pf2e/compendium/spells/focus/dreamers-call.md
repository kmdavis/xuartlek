...
`Cleric`  `Concentrate`  `Focus`  `Illusion`  `Incapacitation`  `Manipulate`  `Mental`  `Uncommon`
...
**Success** The target's attention wavers. It becomes [[srd/pf2e/compendium/rules-elements/conditions#Fascinated|fascinated]] by the daydream.
