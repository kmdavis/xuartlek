...
- trait/uncommon
- spell/level/5
aliases: ["Gluttonous Growth"]
aon_url: "https://2e.aonprd.com/Spells.aspx?ID=1935"
source: "Howl of the Wild"
---

# Gluttonous Growth  *Focus 5*  [>>](books/player-core/chapter-8-playing-the-game/actions#Actions "Two-Action")

`Concentrate`  `Focus`  `Manipulate`  `Plant`  `Ranger`  `Uncommon`
...
When you [[srd/pf2e/compendium/rules-elements/actions/player-core#Sustain|Sustain]] this spell, each creature grabbed or restrained by the plants takes 4d6 piercing damage
.

---
**Heightened (+1)** The damage dealt by the plants when you [[srd/pf2e/compendium/rules-elements/actions/player-core#Sustain|Sustain]] the spell increases by 2d6.

*Source: Howl of the Wild p. 60*
