...
- spell/level/1
aliases: ["Earthworks"]
aon_url: "https://2e.aonprd.com/Spells.aspx?ID=1900"
source: "Player Core"
socialImage: og-image.png
---

# Earthworks  *Focus 1*  [?](books/player-core/chapter-8-playing-the-game/actions#Actions "Varies")

`Concentrate`  `Earth`  `Focus`  `Manipulate`  `Uncommon`  `Wizard`
