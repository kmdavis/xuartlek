...
aon_url: "https://2e.aonprd.com/Spells.aspx?ID=1768"
source: "Player Core"
socialImage: og-image.png
---

# Hymn of Healing  *Focus 1*  [>>](books/player-core/chapter-8-playing-the-game/actions#Actions "Two-Action")

`Bard`  `Composition`  `Concentrate`  `Focus`  `Healing`  `Uncommon`  `Vitality`  `Positive`
