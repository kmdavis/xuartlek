...
aon_url: "https://2e.aonprd.com/Spells.aspx?ID=1882"
source: "Player Core"
---

# Patron's Puppet  *Focus 1*  [ ](books/player-core/chapter-8-playing-the-game/actions#Actions "Free Action")

`Focus`  `Hex`  `Uncommon`  `Witch`
