...
- trait/focus
- spell/level/2
aliases: ["Shining Starlight Attack"]
aon_url: "https://2e.aonprd.com/Spells.aspx?ID=2133"
source: "Tian Xia Character Guide"
socialImage: og-image.png
---

# Shining Starlight Attack  *Focus 2*  [>>](books/player-core/chapter-8-playing-the-game/actions#Actions "Two-Action")

`Concentrate`  `Manipulate`  `Rare`  `Focus`
...
*Source: Tian Xia Character Guide p. 95*
