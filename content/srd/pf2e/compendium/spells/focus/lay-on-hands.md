...
aon_url: "https://2e.aonprd.com/Spells.aspx?ID=2047"
source: "Player Core 2"
socialImage: og-image.png
---

# Lay on Hands  *Focus 1*  [>](books/player-core/chapter-8-playing-the-game/actions#Actions "Single Action")

`Champion`  `Focus`  `Healing`  `Manipulate`  `Uncommon`  `Vitality`  `Positive`
