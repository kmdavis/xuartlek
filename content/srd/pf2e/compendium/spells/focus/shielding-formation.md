...
aon_url: "https://2e.aonprd.com/Spells.aspx?ID=2489"
source: "Battlecry!"
socialImage: og-image.png
---

# Shielding Formation  *Focus 4*  [>>](books/player-core/chapter-8-playing-the-game/actions#Actions "Two-Action")

`Concentrate`  `Focus`  `Force`  `Manipulate`  `Uncommon`  `Wizard`

- **Range**: 30-foot [[srd/pf2e/books/player-core/chapter-8-playing-the-game/area#Emanation|emanation]]
