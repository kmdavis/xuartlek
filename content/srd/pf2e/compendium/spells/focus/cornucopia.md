...
- spell/level/1
aliases: ["Cornucopia"]
aon_url: "https://2e.aonprd.com/Spells.aspx?ID=1856"
source: "Player Core"
socialImage: og-image.png
---

# Cornucopia  *Focus 1*  [>>](books/player-core/chapter-8-playing-the-game/actions#Actions "Two-Action")

`Concentrate`  `Druid`  `Focus`  `Healing`  `Manipulate`  `Plant`  `Uncommon`  `Vitality`  `Positive`
