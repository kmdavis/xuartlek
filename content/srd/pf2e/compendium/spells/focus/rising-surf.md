...
- spell/level/1
aliases: ["Rising Surf"]
aon_url: "https://2e.aonprd.com/Spells.aspx?ID=1310"
source: "Rage of Elements"
socialImage: og-image.png
---

# Rising Surf  *Focus 1*  [>](books/player-core/chapter-8-playing-the-game/actions#Actions "Single Action")

`Druid`  `Focus`  `Manipulate`  `Move`  `Uncommon`  `Water`
