...
aon_url: "https://2e.aonprd.com/Spells.aspx?ID=1894"
source: "Player Core"
---

# Protective Wards  *Focus 1*  [>](books/player-core/chapter-8-playing-the-game/actions#Actions "Single Action")

`Aura`  `Focus`  `Manipulate`  `Uncommon`  `Wizard`
