...
aon_url: "https://2e.aonprd.com/Spells.aspx?ID=2679"
source: "Impossible Magic"
---

# Divine Armageddon  *Spell 8*  [>>](books/player-core/chapter-8-playing-the-game/actions#Actions "Two-Action")

`Concentrate`  `Manipulate`  `Sanctified`  `Spirit`  `Vitality`  `Void`  `Positive`  `Negative`
...
---
**Heightened (+1)** The damage increases by 1d6 void damage and 1d6 spirit damage.
