...
`Concentrate`  `Healing`  `Manipulate`  `Plant`  `Vitality`  `Void`  `Wood`  `Positive`  `Negative`
...
---
**Heightened (+1)** The void damage increases by 1d4, the healing increases by 1d4, and tree’s Hit Points increases by 10.
