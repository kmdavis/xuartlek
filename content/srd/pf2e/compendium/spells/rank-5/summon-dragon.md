...
aon_url: "https://2e.aonprd.com/Spells.aspx?ID=1697"
source: "Player Core"
---

# Summon Dragon  *Spell 5*  [>>>](books/player-core/chapter-8-playing-the-game/actions#Actions "Three-Action")

`Concentrate`  `Manipulate`  `Summon`

- **Traditions**: Arcane, Divine, Occult, Primal
- **Deities**: Apsu, Brixori, Dahak, Essence Dancers, Sarshallatu
- **Range**: 30 feet
