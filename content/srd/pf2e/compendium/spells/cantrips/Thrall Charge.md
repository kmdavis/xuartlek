...
- trait/uncommon
- spell/level/1
aliases: ["Thrall Charge"]
aon_url: "https://2e.aonprd.com/Spells.aspx?ID=2911"
source: "Impossible Magic"
socialImage: og-image.png
---

# Thrall Charge  *Cantrip 1*  [>>](books/player-core/chapter-8-playing-the-game/actions#Actions "Two-Action")

`Cantrip`  `Concentrate`  `Manipulate`  `Necromancer`  `Uncommon`
...
**Heightened (6th)** The additional damage increases to 3d6.

**Heightened (10th)** The additional damage increases to 4d6.
