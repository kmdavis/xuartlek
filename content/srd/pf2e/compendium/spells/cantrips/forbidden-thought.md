...
aon_url: "https://2e.aonprd.com/Spells.aspx?ID=2556"
source: "Dark Archives (Remastered)"
---

# Forbidden Thought  *Cantrip 1*  [>>](books/player-core/chapter-8-playing-the-game/actions#Actions "Two-Action")

`Cantrip`  `Concentrate`  `Manipulate`  `Mental`  `Psychic`  `Uncommon`
