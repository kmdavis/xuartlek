...
aon_url: "https://2e.aonprd.com/Spells.aspx?ID=1996"
source: "Player Core 2"
socialImage: og-image.png
---

# Ghoulish Cravings  *Spell 2*  [>>](books/player-core/chapter-8-playing-the-game/actions#Actions "Two-Action")

`Concentrate`  `Curse`  `Manipulate`  `Mental`
