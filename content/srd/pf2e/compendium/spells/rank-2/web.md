...
# Web  *Spell 2*  [>>>](books/player-core/chapter-8-playing-the-game/actions#Actions "Three-Action")
...
**Critical Failure** The creature is immobilized until the start of its next turn, after which it takes a –10-foot circumstance penalty to its Speeds for 1 round. It can attempt to [[srd/pf2e/compendium/rules-elements/actions/player-core#Escape|Escape]] to remove its immobilized condition.
