...
- spell/level/2
aliases: ["Gecko Grip"]
aon_url: "https://2e.aonprd.com/Spells.aspx?ID=1541"
source: "Player Core"
---

# Gecko Grip  *Spell 2*  [>>](books/player-core/chapter-8-playing-the-game/actions#Actions "Two-Action")

`Concentrate`  `Manipulate`

- **Traditions**: Arcane, Primal
- **Deities**: Chinostes (Nightwarden), Chinostes (Redeemer)
- **Range**: touch
- **Target**: 1 creature
- **Duration**: 10 minutes
