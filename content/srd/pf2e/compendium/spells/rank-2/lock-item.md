...
- spell/level/2
aliases: ["Lock Item"]
aon_url: "https://2e.aonprd.com/Spells.aspx?ID=2511"
source: "Battlecry!"
---

# Lock Item  *Spell 2*  [>>](books/player-core/chapter-8-playing-the-game/actions#Actions "Two-Action")

`Concentrate`  `Manipulate`

- **Traditions**: Arcane, Primal
- **Range**: 30 feet
- **Target**: one object held by one creature and the creature holding it
- **Defense**: Reflex
- **Duration**: varies
