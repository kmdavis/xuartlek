...
This new entity must be appeased by those who sail it. Appeasing the spirit requires a [[srd/pf2e/compendium/rules-elements/skills/diplomacy|Diplomacy]] or [[srd/pf2e/compendium/rules-elements/skills/nature|Nature]] check at the ritual's casting DC. Those negotiating with the spirit might make offerings to gain the spirit's favor, but such reprieve is short in duration and must be attempted each time a vessel passes near. The nature of these offerings is subject to the GM's discretion.

**Critical Success** As success, except the spirit looks kindly on the caster and those who travel with them. The spirit never takes [[srd/pf2e/books/player-core/chapter-7-spells/hostile-actions|hostile action]] against them or any vessel they travel on and increases their [[srd/pf2e/books/player-core/chapter-8-playing-the-game/movement#Swim Speed|swim Speed]] or their vessel’s Speed by 10 feet while within the affected area. Additionally, the spirit’s [[srd/pf2e/compendium/rules-elements/actions/player-core#Strike|Strike]] gains the Improved Grab ability with an [[srd/pf2e/compendium/rules-elements/skills/athletics|Athletics]] modifier of +38.

**Success** The spirit takes up residence in the body of water, defending it aggressively or attacking organized threats on adjacent shores. The spirit manifests as either a [[srd/pf2e/books/gm-core/chapter-2-building-games/environment#Tsunamis|massive tsunami]] that repeats every hour or a massive fist of water that can make a melee [[srd/pf2e/compendium/rules-elements/actions/player-core#Strike|Strike]] every round against any target within the affected area. This Strike has a +33 modifier and deals 3d8+19 bludgeoning damage. The spirit can make this Strike against two targets within 30 feet, rolling once to attack and comparing the result against the AC of both targets.

**Failure** The ritual has no effect, though tides and waves are more severe than normal for 24 hours.

**Critical Failure** The ritual backfires, causing four [[srd/pf2e/bestiary/monster-core/elemental/elemental-tsunami|elemental tsunamis]] to appear surrounding the casters and attack them for their insolence. If not defeated, the tsunamis remain for 1 week, attacking any waterborne vessels within the targeted area.

*Source: War of Immortals p. 162*
