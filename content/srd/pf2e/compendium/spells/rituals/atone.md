...
- **PFS Note**: All characters have access to atone
- **Cast**: 1 day
...
- **Range**: 10 feet
- **Target(s)**: another creature of up to 8th level who is a worshipper of the same deity or philosophy as you

You attempt to help a truly penitent creature atone for its misdeeds, typically actions that are anathema to your deity. If the creature isn't truly penitent, the outcome is always a critical failure. This ritual uses Nature if the target is a [[srd/pf2e/compendium/character/classes/druid|druid]], and Religion in all other cases.
