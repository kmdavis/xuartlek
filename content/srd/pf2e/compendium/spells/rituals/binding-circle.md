...
- **Secondary Casters**: 3
- **Primary Check**: [[srd/pf2e/compendium/rules-elements/skills/arcana|Arcana]] (master) or [[srd/pf2e/compendium/rules-elements/skills/occultism|Occultism]] (master)
- **Secondary Checks**: Diplomacy or Intimidation ; Arcana or Occultism (whichever isn’t used for the primary check)
- **Range**: interplanar
- **Target(s)**: 1 extraplanar creature
- **Duration**: varies
