...
You draw a ritual circle, and when the ritual is complete, you shift all creatures in the area to a different plane of existence. The skill you use for the primary check must be one that can be used to make a Recall Knowledge check about the intended destination, such as Arcana or Nature for the [[srd/pf2e/compendium/gm/planes#Plane of Fire|Plane of Fire]] or Occultism for the [[srd/pf2e/compendium/gm/planes#Astral Plane|Astral Plane]].
