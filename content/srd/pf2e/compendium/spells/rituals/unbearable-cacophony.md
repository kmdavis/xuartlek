...
You amplify the sound of every item and creature to impossible levels. [[srd/pf2e/compendium/rules-elements/conditions#Deafened|Deaf]] creatures and creatures [[srd/pf2e/books/player-core/chapter-8-playing-the-game/immunity-weakness-and-resistance|immune]] to [[srd/pf2e/compendium/rules-elements/traits/player-core/sonic|sonic]] damage remain unaffected in most cases.

**Critical Success** As success, and you and the secondary casters gain sonic resistance equal to your level for the duration.

**Success** Any sound produced by a creature or object (such as a cricket, a ringing anvil, or a lion’s roar) deals sonic damage equal to the level of the creature or item (minimum 1) to every creature within 15 feet (basic Fortitude save with a DC equal to the ritual’s casting DC). For every size category over Tiny of the item or creature making noise, this damage increases by 2. Organized groups of creatures, such as a singing quartet or a swarm of insects, count as the next size category larger for this effect. Effects that normally deal sonic damage to creatures and objects ignore half the creature or object’s sonic [[srd/pf2e/books/player-core/chapter-8-playing-the-game/immunity-weakness-and-resistance#Resistance|resistance]] or [[srd/pf2e/books/player-core/chapter-6-equipment/shields#Hardness|Hardness]].

**Failure** The ritual has no effect.

**Critical Failure** An intense sound of ringing echoes in each caster’s ears, imparting a [[srd/pf2e/books/player-core/chapter-8-playing-the-game/immunity-weakness-and-resistance#Weakness|weakness]] to sonic damage equal to their level for 1 day.
