...
# Command  *Spell 1*  [>>](books/player-core/chapter-8-playing-the-game/actions#Actions "Two-Action")

`Auditory`  `Concentrate`  `Linguistic`  `Manipulate`  `Mental`

- **Traditions**: Arcane, Divine, Occult
- **Patron Themes**: Faith's Flamekeeper, The Unseen Broker, The Unseen Broker
- **Range**: 30 feet
- **Target**: 1 creature
- **Defense**: Will
