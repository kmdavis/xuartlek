...
# Summon Lesser Servitor  *Spell 1*  [>>>](books/player-core/chapter-8-playing-the-game/actions#Actions "Three-Action")

`Concentrate`  `Manipulate`  `Summon`

- **PFS Note**: spell may be used, but imps may not be summoned
- **Tradition**: Divine
- **Range**: 30 feet
