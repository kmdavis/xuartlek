...
- trait/summon
- spell/level/1
aliases: ["Phantasmal Minion"]
aon_id: "spell-1631"
source: "Player Core"
---

# Phantasmal Minion  *Spell 1*  [>>>](books/player-core/chapter-8-playing-the-game/actions#Actions "Three-Action")

`Concentrate`  `Manipulate`  `Summon`

- **Traditions**: Arcane, Occult
- **Deities**: Anubis, Good Neighbors, Kols, Monad, Yelayne, Yluma
- **Range**: 60 feet
- **Duration**: sustained
