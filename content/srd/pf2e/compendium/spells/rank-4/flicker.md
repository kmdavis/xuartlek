...
# Flicker  *Spell 4*  [>>](books/player-core/chapter-8-playing-the-game/actions#Actions "Two-Action")

`Concentrate`  `Manipulate`  `Teleportation`

- **Traditions**: Arcane, Occult
- **Deities**: Black Butterfly, Guardians of the Sacred Self, Nethys, Ng, Phi Deva
- **Duration**: 1 minute
