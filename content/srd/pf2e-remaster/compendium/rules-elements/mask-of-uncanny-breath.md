...
aon_id: "equipment-2326-bonus-593"
...
**Activate** [ ](rules/player-core/chapter-8-playing-the-game/actions#Actions "Free Action") (concentrate) **Frequency** once per day; **Effect** You gain 1 Focus Point, which you can use only to cast an occult monk qi spell. If not used by the end of your turn, this Focus Point is lost.

**Activate** [<](rules/player-core/chapter-8-playing-the-game/actions#Actions "Reaction") (concentrate) **Frequency** once per day; **Trigger** Your unarmed Strike hits a creature that breathes; **Effect** The mask contorts and inhales, sucking breath from your target's lungs. The target falls unconscious but doesn't fall prone or drop what it's holding. It wakes up at the end of your turn if it hasn't been woken up already.
