...
aon_id: "equipment-2305-bonus-514"
...
**Activate** [>](rules/player-core/chapter-8-playing-the-game/actions#Actions "Single Action") (concentrate) **Frequency** once per day; **Requirements** You can create versatile vials; **Effect** You pull a versatile vial from the satchel’s secondary compartment. It’s as effective as the vials you create at the start of the day, not limited like ones created using Quick Alchemy.
