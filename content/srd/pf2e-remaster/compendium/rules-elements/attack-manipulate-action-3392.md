...
**Activate—Bragging Rights** [>](rules/player-core/chapter-8-playing-the-game/actions#Actions "Single Action") (attack, manipulate) **Frequency** once per day; **Effect** You attempt to Strike a significant enemy with the _doom switch_, marking them for defeat. The switch is treated as a simple melee weapon for the purpose of proficiency. This attack deals no damage.
