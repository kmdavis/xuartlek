...
# Banishing Touch  *Spell 2*  [?](rules/player-core/chapter-8-playing-the-game/actions#Actions "Varies")

`Attack`  `Concentrate`  `Manipulate`  `Mythic`  `Rare`
...
[>](rules/player-core/chapter-8-playing-the-game/actions#Actions "Single Action") The target is launched 10 feet into the air and knocked back 10 feet.

[>>](rules/player-core/chapter-8-playing-the-game/actions#Actions "Two-Action") Your touch deals 2d6 bludgeoning damage instead. The target is launched 20 feet into the air and pushed back 10 feet.

[>>>](rules/player-core/chapter-8-playing-the-game/actions#Actions "Three-Action") Your touch deals 2d6 bludgeoning damage instead. The target is launched 30 feet into the air and pushed back 20 feet.
