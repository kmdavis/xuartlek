...
# Hologram Cage  *Cantrip 5*  [>>>](rules/player-core/chapter-8-playing-the-game/actions#Actions "Three-Action")

`Cantrip`  `Concentrate`  `Illusion`  `Light`  `Manipulate`  `Psychic`  `Uncommon`
