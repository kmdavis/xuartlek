...
# Wall of Fire  *Spell 4*  [>>>](rules/player-core/chapter-8-playing-the-game/actions#Actions "Three-Action")

`Concentrate`  `Fire`  `Manipulate`

- **Traditions**: Arcane, Primal
- **Deities**: Chavazvug, Light of the Everlasting Flame, Sarenrae, Sekhmet, Uirch, Walkena, Ymeri
- **Range**: 120 feet
- **Duration**: 1 minute
