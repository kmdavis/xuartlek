...
- trait/manipulate
- spell/level/2
aliases: ["False Vitality"]
aon_id: "spell-1523"
source: "Player Core"
---

# False Vitality  *Spell 2*  [>>](rules/player-core/chapter-8-playing-the-game/actions#Actions "Two-Action")

`Concentrate`  `Manipulate`

- **Traditions**: Arcane, Occult
- **Deities**: Aesocar, Oathos, Osiris, Qi Zhong, Touch of the Sun, Urgathoa
- **Duration**: 8 hours
