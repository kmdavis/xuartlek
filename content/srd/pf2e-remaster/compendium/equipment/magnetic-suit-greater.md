...
aon_id: "equipment-1117-1091"
source: "Guns & Gears (Remastered)"
---

# Magnetic Suit (Greater)  *Item 4+*
...
- **Bulk**: 1
- **Activate**: [>>](rules/player-core/chapter-8-playing-the-game/actions#Actions "Two-Action") Interact
...
The area that gains an AC bonus when attracting is a 15-foot emanation, and the status bonuses and penalties increase from 1 to 2.
...
The area that gains an AC bonus when attracting is a 20-foot emanation, and the status bonuses and penalties increase from 1 to 3.

*Source: Guns & Gears (Remastered) p. 71*
