...
**Activate** [ ](rules/player-core/chapter-8-playing-the-game/actions#Actions "Free Action") (concentrate) **Trigger** You attempt a ranged Strike with _Ghosthand's Comet_; **Effect** For the triggering Strike, _Ghosthand's Comet_ changes its damage type to your choice of acid, cold, electricity, fire, or sonic.

**Activate** [>](rules/player-core/chapter-8-playing-the-game/actions#Actions "Single Action") (concentrate) **Effect** On your next attempt at a ranged Strike with _Ghosthand's Comet_, the shot phases through any material or magical obstacle, such as a _wall of force_, in its path, ignoring all cover. You must attempt the Strike by the end of your turn or this effect is lost.
