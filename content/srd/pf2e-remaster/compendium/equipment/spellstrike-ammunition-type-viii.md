...
aon_id: "equipment-2927-2795"
source: "GM Core"
---

# Spellstrike Ammunition (Type VIII)  *Item 3+*

`Consumable`  `Magical`

- **Ammunition**: any
- **Activate**: [>>](rules/player-core/chapter-8-playing-the-game/actions#Actions "Two-Action") Cast a Spell
