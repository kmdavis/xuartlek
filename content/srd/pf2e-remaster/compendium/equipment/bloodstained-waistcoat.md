...
- trait/magical
- equipment/level/4
aliases: ["Bloodstained Waistcoat"]
aon_id: "equipment-3957"
source: "Battlecry!"
---

# Bloodstained Waistcoat  *Item 4*

`Invested`  `Magical`

- **PFS Note**: A _bloodstained waistcoat’s_ change to DCs overwrites any other changes to flat checks, whether beneficial or harmful to the wearer.
- **Price**: 85 gp
- **Usage**: worn garment
- **Bulk**: L
