...
aon_id: "equipment-2111-1858"
source: "Treasure Vault (Remastered)"
---

# Reflecting Shard (Greater)  *Item 13+*

`Consumable`  `Magical`  `Talisman`  `Uncommon`

- **Usage**: affixed to a shield
- **Activate**: [<](rules/player-core/chapter-8-playing-the-game/actions#Actions "Reaction") (concentrate)
...
The talisman can reflect spells of any level, and its counteract rank is 9th.
