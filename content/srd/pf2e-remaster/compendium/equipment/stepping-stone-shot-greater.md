...
aon_id: "equipment-1198-1130"
source: "Guns & Gears (Remastered)"
---

# Stepping Stone Shot (Greater)  *Item 7+*

`Consumable`  `Magical`  `Uncommon`

- **Ammunition**: round
- **Activate**: [>](rules/player-core/chapter-8-playing-the-game/actions#Actions "Single Action") envision, Interact
