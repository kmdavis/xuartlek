...
A complex, collapsible mechanism forms the outer surface of a _planar tunnel_. It’s linked to a passageway that can be accessed if the tunnel is fully opened. The passage is extradimensional, but borders another plane of existence. Each planar tunnel is keyed to one specific plane.
...
**Special** A _planar tunnel_ can be used as a planar key for the _interplanar teleport_ spell, and has the same rarity as the key, as specified in the spell.
