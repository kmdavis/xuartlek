...
aon_id: "equipment-1194"
source: "Guns & Gears (Remastered)"
---

# Fairy Bullet  *Item 7*

`Consumable`  `Fey`  `Magical`  `Uncommon`

- **PFS Note**: The glitterdust spell cast by the fairy bullet has a DC of 23 (as is standard for a 7th-level item).
- **Price**: 65 gp
- **Ammunition**: round
- **Activate**: [>>](rules/player-core/chapter-8-playing-the-game/actions#Actions "Two-Action") command, envision
