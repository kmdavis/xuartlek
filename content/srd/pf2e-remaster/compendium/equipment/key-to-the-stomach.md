...
**Activate—Iron Gut** [>>](rules/player-core/chapter-8-playing-the-game/actions#Actions "Two-Action") (concentrate) **Frequency** once per day; **Effect** You absorb any poisons with the key sealing your _bargained contract_. You're affected by a 5th-rank _cleanse affliction_ spell to remove a poison (counteract modifier +15).
