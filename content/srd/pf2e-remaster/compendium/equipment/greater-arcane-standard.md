...
- trait/uncommon
- equipment/level/20
aliases: ["Greater Arcane Standard"]
aon_id: "equipment-3902-3620"
source: "Battlecry!"
---

# Greater Arcane Standard  *Item 10+*

`Aura`  `Magical`  `Uncommon`

- **PFS Note**: If a PC uses an arcane standard’s Magical Weakness ability against a creature which has taken more than one type of energy damage, the player chooses which energy type the creature gains weakness to.
