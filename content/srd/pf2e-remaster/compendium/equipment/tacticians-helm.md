...
**Activate** [>](rules/player-core/chapter-8-playing-the-game/actions#Actions "Single Action") (concentrate)**Cost** 1 charge from the helm; **Frequency** once per hour; **Effect** You choose one of the following effects. 
