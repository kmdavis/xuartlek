...
| **While Exploring...** | You keep an eye out for additional ingredients that you can turn into alchemical reagents, while giving advice on all things alchemical and mysterious. |
| **In Downtime...** | You experiment in an alchemical lab, brewing elixirs, making bombs, and furthering your alchemical knowledge. |

#### You Might...

Enjoy tinkering with strange formulas and alchemical reagents, often with a single-minded dedication and recklessness that gives others pause.Get a kick out of wreaking havoc with the alchemical concoctions you've made, and enjoy watching things burn, dissolve, freeze, and jolt.Endlessly experiment to discover new, more potent alchemical tools.
...
| **Attacks** | Trained in simple weapons Trained in alchemical bombs Trained in unarmed attacks |
...
| **Field Discovery** | You learn a discovery listed in your research field |
...
| **Advanced Vials** | Your experience helps you improve your field vials with a benefit particular to your research field. |
...
| | |
| --- | --- |
| **Greater Field Discovery** | You learn an incredible discovery that advances your understanding of your field, as described in your research field. |
...
| | |
| --- | --- |
| **Alchemical Weapon Mastery** | You’ve mastered full capability with your weapons. Your proficiency ranks for simple weapons, alchemical bombs, and unarmed attacks increase to master. |
...
| | |
| --- | --- |
| **Alchemical Mastery** | Your concoctions are incredibly effective. Your proficiency rank for your alchemist class DC increases to master. |
