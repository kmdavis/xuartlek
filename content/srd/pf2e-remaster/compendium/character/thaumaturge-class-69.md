...
tags:
- compendium/src/pf2e-remaster/dark-archives-remastered
aliases: ["Thaumaturge"]
aon_id: "class-69"
...
Prepare for the worst while improvising as necessary, impressing your allies when you're able to handle anything that fate throws at you.Assume everything is connected on a deeper level, rather than be content with what you find on the surface.Obsess over a certain supernatural phenomenon, attempting to tie everything back to it.

#### Others Probably...

Look to you to learn the weaknesses of a supernatural threat when one rears its head. Even when your explanations are invented on the fly, they just seem to work.Rely on you to come up with a solution when the situation seems hopeless.Mistake you for a common wizard or magician.
...
1Ancestry and background, attribute boosts, initial proficiencies, esoteric lore, first implement and esoterica, implement’s empowerment, thaumaturge feat
2Skill feat, thaumaturge feat
3General feat, reflex expertise, skill increase
4Skill feat, thaumaturge feat
5Ancestry feat, attribute boosts, second implement, skill increase, weapon expertise
6Skill feat, thaumaturge feat
7Disciplined mind, general feat, implement adept, skill increase, weapon specialization
8Skill feat, thaumaturge feat
9Ancestry feat, intensify vulnerability, perception expertise, skill increase, thaumaturgic expertise
...
13Ancestry feat, perfected mind, skill increase, weapon mastery
14Skill feat, thaumaturge feat
15Attribute boosts, earned resilience, general feat, greater weapon specialization, skill increase, third implement
...
| | |
| --- | --- |
| **Thaumaturge Feats** | At 1st level and every even-numbered level, you gain a thaumaturge class feat. |
...
You've learned to use your implement to further assault your quarry. You gain the intensify vulnerability benefit of all of your implements, as well as the following action. 

| | |
| --- | --- |
| **Perception Expertise** | You've developed keen awareness and attention to detail. Your proficiency rank for Perception increases to master. |
...
| **Second Adept** | You've improved your link to your second implement. You gain the adept benefit of your second implement. |
...
| | |
| --- | --- |
| **Weapon Mastery** | You fully understand your weapons. Your proficiency ranks for unarmed attacks, simple weapons, and martial weapons increase to master. |
