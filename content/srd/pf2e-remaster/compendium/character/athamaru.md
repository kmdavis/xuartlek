...
`Amphibious`  `Athamaru`  `Humanoid`  `Uncommon`  `Locathah`

### You Might...

Value your community above most everything else.Approach strangers with warm curiosity.

### Others Probably...

Assume you're well versed in underwater survival.Believe you're to blame for foul smells.
...
| | |
| --- | --- |
| **Sample Names** | Aussandor, Cayiel, Corlena, Mithae, Onteac, Paquotal |
