...
You'll see the following key terms in many necromancer abilities.
...
**Thrall**: The mindless undead you can create as a necromancer are called thralls. Spells or abilities that create thralls have the thrall trait. 

### Thralls

 A thrall is a level –1 creature with the mindless and undead traits. It's not a minion, nor does it have the summoned trait. It has 1 Hit Point and is immune to bleed, death effects, disease, mental, and poison. Thralls automatically fail all checks, and any check made against a thrall automatically succeeds. They can take actions only when commanded to by a grave spell or necromancer ability. A thrall is temporary and is destroyed after 1 minute if no other duration is listed.

 You choose whether a thrall is Small or Medium when you create it, and you must create it in an unoccupied space or the spell or ability that created the thrall fails. A thrall can contribute to flanking as though it were able to make melee unarmed Strikes. Thralls can't hold their ground—a creature can move into a thrall's space as though it were unoccupied. The thrall's space is difficult terrain, and the moving creature can automatically push the thrall into an adjacent space that's not in its path.
 ...
 **Command a Thrall** [>](rules/player-core/chapter-8-playing-the-game/actions#Actions "Single Action") (concentrate, necromancer, thrall) You make one of your thralls Crawl, Drop Prone, Escape, Interact , Stand, Stride, or Strike. A thrall can take only simple Interact actions, not ones that require skill checks or complicated movements. However, they can make checks to Escape using your spell attack modifier. Escaping this way uses and counts toward your multiple attack penalty.

### Roleplaying the Necromancer

#### During Combat Encounters...

You manipulate the flow of life and death on the battlefield. You both create and destroy your undead servants to amplify your occult powers and manipulate battle. You also tip the scales by draining the life of your foes to heal your allies.

#### During Social Encounters...

Your knowledge of the esoteric and macabre can be both insightful and frightening. Many find such knowledge to be gruesomely enchanting. When natural charm fails, your occult magic is a potent tool for manipulating the living and the dead.

#### While Exploring...

Since you understand them better than most, you excel at locating and handling haunts with your occult prowess. You might summon your undead thralls to trigger traps or to serve as a decoy when you think enemies are near.

#### In Downtime...

You can brew potions, craft magic items, or scribe scrolls for your party and seek out hidden or locked-away knowledge about your grim fascination. Perhaps you tend to the local graveyard to ensure the dead are properly put to rest.

#### You Might...

Have a feverish desire to study the anatomy of creatures you discover along your journey.Pay respects for the dead and the death you cause while understanding that it is the inevitable end of all living creatures.Seek ways to cheat the natural order of life and death, either to make yourself immortal or bring back a loved one.

#### Others Probably...

Assume you enjoy the cruelty of death and revel in decay.Seek you out, hoping you can send or receive a message from someone who has passed.Ignore you, as your existence is a reminder that they and everyone they know will someday die.
...
| **Skills** | Trained in Occultism Trained in a number of additional skills equal to 2 plus your Intelligence modifier |
...
| **Expert Necromancy** | You wield the necromantic arts with greater finesse. Your proficiency ranks for spell attack modifier and spell DC increase to expert. |
| **Perception Expertise** | You remain alert to threats around you. Your proficiency rank for Perception increases to expert. |

#### Unnatural Fortitude

Your body has been necromantically enhanced. Your proficiency rank for Fortitude saves increases to master. When you roll a success at a Fortitude save, you get a critical success instead.

| | |
| --- | --- |
| **Weapon Expertise** | You’ve dedicated yourself to learning the intricacies of your weapons. Your proficiency ranks for simple weapons and unarmed attacks increase to expert. |
...
You’ve learned how to inflict greater injuries with your
weapons. You deal 2 additional damage with weapons and unarmed attacks in which you are an expert. This damage increases to 3 if you’re a master, and to 4 if you’re legendary.

| | |
| --- | --- |
| **Master Necromancy** | The souls of the dead heed your beck and call. Your proficiency ranks for spell attack modifier and spell DC increase to master. |

#### Undying Resilience

Your body has been necromantically enhanced. Your proficiency rank for Fortitude saves increases to legendary. When you roll a critical failure on a Fortitude save, you get a failure instead. When you fail a Fortitude save against a damaging effect, you take half damage.

#### Epitaph

From the deepest crypts of magical knowledge, you summon forth a spell of immense occult power. You gain a single 10th-level spell slot and can prepare a spell in that slot using necromancer spellcasting. You don’t gain more 10th-level spells as you level up, unlike other spell slots, and you can’t use 10th-level slots with abilities that give you more spell slots or that let you cast spells without expending spell slots. You can take the Mortem Ultimatum necromancer feat to gain a second slot.

| | |
| --- | --- |
| **Legendary Necromancy** | Death in one hand, life in the other, you shape the cycles of necromancy. Your proficiency ranks for spell attack modifier and spell DC increase to legendary. |
