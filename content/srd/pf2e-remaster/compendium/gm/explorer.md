...
Chronicler (Creature 3), Expedition Leader (Creature 9), Forager (Creature 1), Gamekeeper (Creature 6), Guide (Creature 4), Hunter (Creature 7), Mountaineer (Creature 5), Natural Scientist (Creature 2), Poacher (Creature 2), Tomb Raider (Creature 5), Torchbearer (Creature 0), Tracker (Creature 3), Wooly Wrangler (Creature 8)
