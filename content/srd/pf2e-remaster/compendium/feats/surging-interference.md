...
# Surging Interference  *Feat 20*  [<](rules/player-core/chapter-8-playing-the-game/actions#Actions "Reaction")

`Mythic`

- **Archetype**: Wildspell
- **Prerequisites**: Wildspell Dedication
- **Trigger**: A creature Casts a Spell within your _spellsurge_ aura.
