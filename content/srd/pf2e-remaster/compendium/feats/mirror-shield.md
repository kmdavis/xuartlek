...
# Mirror Shield  *Feat 10*  [<](rules/player-core/chapter-8-playing-the-game/actions#Actions "Reaction")

`Fighter`

- **Archetypes**: Bastion (Level 12), Knight Vigilant (Level 12), Bastion (Level 12)
