...
# Impossible Volley  *Feat 18*  [>>>](rules/player-core/chapter-8-playing-the-game/actions#Actions "Three-Action")

`Fighter`  `Flourish`  `Ranger`

- **Archetypes**: Eldritch Archer (Level 20), Archer (Level 20), Eldritch Archer (Level 20)
