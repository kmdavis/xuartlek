...
- trait/minotaur
- feat/level/13
aliases: ["Threatening Pursuit"]
aon_id: "feat-5381"
source: "Howl of the Wild"
---

# Threatening Pursuit  *Feat 13*  [>](rules/player-core/chapter-8-playing-the-game/actions#Actions "Single Action")

`Auditory`  `Minotaur`

- **Prerequisites**: Expert in Intimidation; Expert in Stealth
