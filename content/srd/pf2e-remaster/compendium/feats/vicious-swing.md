...
# Vicious Swing  *Feat 1*  [>>](rules/player-core/chapter-8-playing-the-game/actions#Actions "Two-Action")

`Fighter`  `Flourish`

- **Archetypes**: Mauler (Level 4), Mauler (Level 4), Battle Harbinger (Level 2)
