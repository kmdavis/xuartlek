...
# The Bigger They Are  *Feat 12*  [>](rules/player-core/chapter-8-playing-the-game/actions#Actions "Single Action")

`Bravado`  `Swashbuckler`

With reckless speed, you dash, jump and swing around a creature to find a more vulnerable spot. Attempt to Tumble Through a creature at least one size category larger than you, using the following effects.
