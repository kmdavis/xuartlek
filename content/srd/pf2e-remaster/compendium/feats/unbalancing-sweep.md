...
# Unbalancing Sweep  *Feat 12*  [>>>](rules/player-core/chapter-8-playing-the-game/actions#Actions "Three-Action")

`Barbarian`  `Flourish`

- **Archetypes**: Mauler (Level 14), Mauler (Level 14), Warrior Of Legend (Level 14)
