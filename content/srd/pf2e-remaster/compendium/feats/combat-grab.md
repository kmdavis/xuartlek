...
# Combat Grab  *Feat 2*  [>](rules/player-core/chapter-8-playing-the-game/actions#Actions "Single Action")

`Fighter`  `Press`

- **Archetypes**: Wrestler (Level 4), Zombie (Level 4), Wrestler (Level 4)
