...
# Just One More Thing  *Feat 10*  [>](rules/player-core/chapter-8-playing-the-game/actions#Actions "Single Action")

`Fortune`  `Investigator`

- **Requirements**: Your most recent action was to Demoralize, Feint, or Request, and you failed but didn’t critically fail.
