...
# Two-Weapon Fusillade  *Feat 14*  [>](rules/player-core/chapter-8-playing-the-game/actions#Actions "Single Action")

`Flourish`  `Gunslinger`

- **Archetypes**: Bullet Dancer (Level 16), Bullet Dancer (Level 16)
