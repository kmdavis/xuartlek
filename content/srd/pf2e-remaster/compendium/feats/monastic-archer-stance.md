...
# Monastic Archer Stance  *Feat 1*  [>](rules/player-core/chapter-8-playing-the-game/actions#Actions "Single Action")

`Monk`  `Stance`

- **Requirements**: You are unarmored and wielding a longbow, a shortbow, or a bow with the Monk trait.
