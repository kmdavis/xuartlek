...
# Reach Spell  *Feat 1*  [>](rules/player-core/chapter-8-playing-the-game/actions#Actions "Single Action")

`Bard`  `Cleric`  `Concentrate`  `Druid`  `Oracle`  `Sorcerer`  `Spellshape`  `Witch`  `Wizard`  `Metamagic`
