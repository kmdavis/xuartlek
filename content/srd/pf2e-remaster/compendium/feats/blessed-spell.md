...
# Blessed Spell  *Feat 8*  [>](rules/player-core/chapter-8-playing-the-game/actions#Actions "Single Action")

`Archetype`  `Concentrate`  `Spellshape`  `Metamagic`

- **Archetype**: Blessed One
- **Frequency**: once per 10 minutes
- **Prerequisites**: Blessed One Dedication; Mercy; ability to cast spells from spell slots
