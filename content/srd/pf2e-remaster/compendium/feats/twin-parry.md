...
# Twin Parry  *Feat 4*  [>](rules/player-core/chapter-8-playing-the-game/actions#Actions "Single Action")

`Fighter`  `Ranger`

- **Archetypes**: Dual-Weapon Warrior (Level 6), Dual-Weapon Warrior (Level 6), Avenger (Level 6)
