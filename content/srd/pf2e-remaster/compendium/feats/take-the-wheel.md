...
# Take the Wheel  *Feat 4*  [>](rules/player-core/chapter-8-playing-the-game/actions#Actions "Single Action")

`Archetype`  `Flourish`

- **Archetype**: Trick Driver
- **Prerequisites**: Trick Driver Dedication; Expert in Driving Lore; Trained in Driving Lore
