...
**Intercession Spell** [<](rules/player-core/chapter-8-playing-the-game/actions#Actions "Reaction") (divine, concentrate, spellshape) **Frequency** once per day **Trigger** Your hierophant Casts a Spell; **Effect** Interceding directly in your hierophant's affairs, you grant them additional magic. They do not expend the spell slot, usage, or Focus Point.
