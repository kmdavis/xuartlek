...
# Share Burden  *Feat 6*  [<](rules/player-core/chapter-8-playing-the-game/actions#Actions "Reaction")

`Archetype`

- **Archetype**: Curse Maelstrom
- **Prerequisites**: Curse Maelstrom Dedication
- **Trigger**: An ally within 60 feet would be affected by a curse or misfortune effect, and you wouldn't be affected but are an eligible target for the effect.
