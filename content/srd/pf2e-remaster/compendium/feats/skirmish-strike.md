...
# Skirmish Strike  *Feat 6*  [>](rules/player-core/chapter-8-playing-the-game/actions#Actions "Single Action")

`Flourish`  `Ranger`  `Rogue`

- **Archetypes**: Drow Shootist (Level 10), Crossbow Infiltrator (Level 10)
