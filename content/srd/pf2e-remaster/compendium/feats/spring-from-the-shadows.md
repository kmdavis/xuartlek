...
# Spring from the Shadows  *Feat 12*  [>](rules/player-core/chapter-8-playing-the-game/actions#Actions "Single Action")

`Flourish`  `Rogue`

- **Archetypes**: Shadowdancer (Level 14), Rose Warden (Level 14), Veil Dancer (Level 14)
