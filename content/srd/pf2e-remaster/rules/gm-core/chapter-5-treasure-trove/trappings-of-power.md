...
You might want to acquire items that benefit a creature that assists you, such as an [[srd/pf2e-remaster/rules/player-core/chapter-3-classes/companions#Animal Companions|animal companion]], [[srd/pf2e-remaster/rules/player-core/chapter-3-classes/companions#Familiars|familiar]], or bonded animal. These items have the companion trait, meaning they function only for animal companions, familiars, and similar creatures. Normally, these are the only items a companion can use. Other items can qualify at the GM's discretion, but a companion can never [[srd/pf2e-remaster/rules/gm-core/chapter-5-treasure-trove/activating-items|Activate an Item]].
...
Use your spell attack modifier and spell DC when Casting a Spell from a staff. The spell gains the appropriate trait for your magical tradition and can be affected by any modifications you can normally make when casting spells, such as spellshape feats. You must provide any [[srd/pf2e-remaster/rules/player-core/chapter-7-spells/casting-spells#Costs and Loci|cost or locus]] required by the spell, or you fail to cast it.
...
Staves are also staff weapons. They can be etched with [[srd/pf2e-remaster/rules/gm-core/chapter-5-treasure-trove/armor-armaments#Fundamental Runes|fundamental runes]] but not [[srd/pf2e-remaster/rules/gm-core/chapter-5-treasure-trove/armor-armaments#Property Runes|property runes]].

## Wands

Short, slender items typically made of wood, wands let you cast a specific spell without expending a spell slot. They can be used once per day, but can be [[#Overcharging a Wand|overcharged]] to attempt to cast them again at great risk. Each wand holds a spell of a certain rank, determined when the wand is created. [[srd/pf2e-remaster/rules/player-core/chapter-7-spells/cantrips|Cantrips]], [[srd/pf2e-remaster/rules/player-core/chapter-7-spells/focus-spells|focus spells]], and [[srd/pf2e-remaster/rules/player-core/chapter-7-spells/rituals|rituals]] can't be placed in wands.
...
If a spell requires a [[srd/pf2e-remaster/rules/player-core/chapter-7-spells/casting-spells#Costs and Loci|locus]], you must still have that locus to cast the spell from a wand, and if the spell has a cost, you must still pay that cost to cast the spell from a wand.
...
Each type of wand has a level and Price determined by the spell's rank. The wand's rarity matches the spell's rarity, and it has its spell's traits. A wand has the normal Hardness, BT, and HP of a thin item of its material (see [[srd/pf2e-remaster/rules/gm-core/chapter-5-treasure-trove/materials|Materials]]).
...
This section includes magic items you wear. Most have the invested trait, which means you can wear no more than 10. Armor appears in its own section [[srd/pf2e-remaster/rules/gm-core/chapter-5-treasure-trove/armor-armaments#Armor|here]], high-level apex items that can increase ability modifiers are [[#Apex Items|here]], and worn items for pets appear [[#Companion Items|here]].
