...
Choose or design any special senses for your creature, such as low-light vision, darkvision, or scent. If you’re making a sense from scratch, simply decide what it senses, whether it has a range limit, and whether it’s [[srd/pf2e-remaster/rules/player-core/chapter-8-playing-the-game/perception-and-detection#Precise Senses|precise]] or [[srd/pf2e-remaster/rules/player-core/chapter-8-playing-the-game/perception-and-detection#Imprecise Senses|imprecise]]. For example, a sinspawn has “sin scent (imprecise) 30 feet.” This means it can smell creatures bearing its associated sin if they’re within 30 feet, and the sense is imprecise—about as acute as human hearing.

## Languages

Think about what languages the creature would need to communicate with other creatures in its home. For instance, many intelligent undead speak Necril, and many creatures from [[srd/pf2e-remaster/rules/gm-core/chapter-3-age-of-lost-omens/beyond-the-inner-sea#The Darklands|the Darklands]] speak Sakvroth. If you want your creature to be able to speak to the PCs, be sure it has Common; for a creature with no reason to speak the common tongue of your setting (such as most extraplanar creatures in a typical campaign), be sure it doesn’t. Some creatures can understand language but can’t vocalize; in this case, you can state that they can’t speak any language. For creatures that need to be able to infiltrate and communicate wherever they go, you might give them truespeech or a similar ability as a constant innate spell.
...
The effects of an ability should be appropriate to the creature’s level. For damaging abilities, that means they follow the [[#Damage-Dealing Abilities|damage guidelines]]. For others, take a look at spells and feats with a similar effect to see if they’re level appropriate. For instance, say you’re considering giving a 6th-level creature the ability to teleport a short distance. Translocate is comparable—that’s a 4th-rank spell, normally cast by a 7th-level or higher creature. That means 6th level probably isn’t too low, but the creature shouldn’t be able to use the ability more than once. You can also compare your creature to those in a Monster Core volume to see if the special abilities seem similar in power to those of other creatures of the same level.
...
An NPC's level should represent their combat prowess. A common person might not be a combat threat, even if they're important or highly skilled, and they consequently have a low level. However, that doesn't mean they can't present a challenge in other types of encounters. This is represented by a [[srd/pf2e-remaster/rules/gm-core/chapter-1-running-the-game/running-encounters#Non-Combat Level|non-combat level]] and tends to be specific to their area of expertise. For example, a barrister might be level –1 in combat but a 4th-level creature in an encounter related to legal matters.
