...
Their troop defenses protect them to some degree against effects that have individual targets, and instead of standard Strikes, the troop has special actions representing their coordinated attacks. This usually includes an ability that attacks in an [[srd/pf2e-remaster/rules/player-core/chapter-8-playing-the-game/area#Emanation|emanation]], acting as the troop's equivalent of a melee Strike.
