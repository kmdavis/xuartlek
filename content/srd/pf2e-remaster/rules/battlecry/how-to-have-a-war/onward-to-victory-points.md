...
The [[srd/pf2e-remaster/rules/gm-core/chapter-4-subsystems/victory-points|Victory Point]] subsystem is particularly well suited for war campaigns—it might not even need a change of name! Typically, you’ll want to use Victory Points when the characters have sufficient power or strategic pull to determine the outcome of the battle. Campaigns, especially about the futility or absurdity of war, should leave them out when the party can’t make the difference between victory and defeat.
