...
**[[srd/pf2e-remaster/rules/player-core/chapter-8-playing-the-game/movement#Cover|Cover]]:** A leader and troop use their full space for determining cover. Therefore, they don’t grant each other cover, nor do they block each other’s attacks when determining an enemy’s cover.

[[srd/pf2e-remaster/rules/player-core/chapter-8-playing-the-game/movement#Flanking|Flanking]]: Regardless of their positioning, a leader and their troop can’t flank with each other. However, if two allied troops are flanking an enemy (or a segment of an enemy troop), their leaders can benefit from this flanking.
