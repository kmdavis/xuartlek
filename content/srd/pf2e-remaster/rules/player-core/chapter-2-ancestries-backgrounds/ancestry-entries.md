...
This tells you the languages that members of the ancestry speak at 1st level. If your Intelligence modifier is +1 or higher, you can select more languages from a list given here. More about languages can be found [[srd/pf2e-remaster/rules/player-core/chapter-2-ancestries-backgrounds/languages|here]].
