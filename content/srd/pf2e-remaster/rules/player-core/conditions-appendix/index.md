...
>
> The doomed, dying, unconscious, and wounded conditions all relate to the process of coming closer to death. The full rules are [[srd/pf2e-remaster/rules/player-core/chapter-8-playing-the-game/hit-points-healing-and-dying|here]]. The most significant information not contained in the conditions themselves is this: When you're reduced to 0 Hit Points, you're knocked out with the following effects:
>
...
- [[srd/pf2e-remaster/rules/player-core/conditions-appendix/condition-values|Condition Values]]
- [[srd/pf2e-remaster/rules/player-core/conditions-appendix/overriding-conditions|Overriding Conditions]]
