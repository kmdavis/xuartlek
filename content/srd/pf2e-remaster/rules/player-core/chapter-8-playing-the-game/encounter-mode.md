...
Typically, you'll roll a [[srd/pf2e-remaster/rules/player-core/chapter-8-playing-the-game/checks#Perception|Perception]] check to determine your initiative—the more aware you are of your surroundings, the more quickly you can respond. Sometimes, though, the GM might call on you to roll some other type of check. For instance, if you were Avoiding Notice during [[srd/pf2e-remaster/rules/player-core/chapter-8-playing-the-game/exploration-mode|exploration]], you'd roll a Stealth check. A social encounter could call for a Deception or Diplomacy check. In most cases, you can still use Perception if you prefer.
...
When your foes are defeated, some sort of truce is reached, or some other event or circumstance ends the combat, the encounter is over. You and the other participants no longer follow the initiative order, and a more free-form style of play resumes, with the game typically moving into [[srd/pf2e-remaster/rules/player-core/chapter-8-playing-the-game/exploration-mode|exploration mode]]. Sometimes, at the end of an encounter, the GM will award [[srd/pf2e-remaster/rules/gm-core/chapter-1-running-the-game/rewards#Experience Points|Experience Points]] to the party or you’ll find [[srd/pf2e-remaster/rules/gm-core/chapter-1-running-the-game/rewards#Treasure|treasure]] to divvy up.
...
- If you're dying, roll a [[srd/pf2e-remaster/rules/player-core/chapter-8-playing-the-game/hit-points-healing-and-dying#Recovery Checks|recovery check]].
- Do anything else that is specified to happen at the start of your turn, such as regaining Hit Points from [[srd/pf2e-remaster/rules/player-core/chapter-8-playing-the-game/hit-points-healing-and-dying#Fast Healing and Regeneration|fast healing or regeneration]].

The last step of starting your turn is always the same.

- Regain your 3 actions and 1 reaction. If you haven't spent your reaction from your last turn, you lose it—you can't “save” actions or reactions from one turn to use during the next turn. Some abilities or conditions (such as quickened, slowed, and stunned) can change how many actions you regain and whether you regain your reaction. (Details on [[srd/pf2e-remaster/rules/player-core/conditions-appendix|gaining and losing actions]].)
...
>
> Any method used to track the initiative order needs to be flexible because the order can change. A creature can use the Delay basic action to change its place in the order, in which case you can erase it from the list or pull its marker aside until it reenters the initiative order. When a creature gets knocked out, its initiative order also changes (see [[srd/pf2e-remaster/rules/player-core/chapter-8-playing-the-game/hit-points-healing-and-dying#Getting Knocked Out|Getting Knocked Out]]). Using the Ready basic action doesn't change a creature's place in the initiative order, though, because the designated action becomes a reaction.

### Step 2: Act

You can use actions in any order you wish during your turn, but you have to complete one action or activity before beginning another; for example, you can't use a single action in the middle of performing a 2-action activity. What actions you can use often depend on your class features, skills, feats, and items, but there are default actions anyone can use, described in [[srd/pf2e-remaster/rules/player-core/chapter-8-playing-the-game/actions#Basic Actions|Basic Actions]]. Some effects might prevent you from acting. If you can't act, you can't use any actions, including reactions and free actions.
...
Once you have spent all 3 of your actions, your turn ends (as described in [[#Step 3: End Your Turn|Step 3]]) and the next creature's turn begins. You can choose to end your turn early, losing all remaining actions (but not your reaction).
...
- If you have a persistent damage condition, you take the damage at this point. After you take the damage, you can attempt the flat check to end the persistent damage. You then attempt any saving throws for ongoing [[srd/pf2e-remaster/rules/player-core/chapter-8-playing-the-game/afflictions|afflictions]]. Many other conditions change at the end of your turn, such as the frightened condition decreasing in severity. These take place after you've taken any persistent damage, attempted flat checks to end the persistent damage, and attempted saves against any afflictions.
...
- You're off-guard unless you have a [[srd/pf2e-remaster/rules/player-core/chapter-8-playing-the-game/movement#Swim Speed|swim Speed]].
- You gain [[srd/pf2e-remaster/rules/player-core/chapter-8-playing-the-game/immunity-weakness-and-resistance#Resistance|resistance]] 5 to acid and fire.
- You take a –2 circumstance penalty to your attack roll for bludgeoning or slashing attacks that pass through water.
- Ranged attacks made by an underwater creature or against an underwater target have their [[srd/pf2e-remaster/rules/player-core/chapter-8-playing-the-game/effects#Range and Reach|range increments]] halved.
