...
Perception is frequently used for rolling initiative in an encounter, and for the Seek action. See [[srd/pf2e-remaster/rules/player-core/chapter-8-playing-the-game/checks#Perception|here]] for the procedure for rolling a Perception check.
...
While a human might have a difficult time making creatures out in [[#Dim Light|dim light]], an elf can see those creatures just fine. And though elves have no problem seeing on a moonlit night, their vision can’t penetrate complete [[#Darkness|darkness]], whereas a dwarf’s can. Special senses allow a creature to ignore or reduce the effects of the [[#Undetected|undetected]], [[#Hidden|hidden]], or [[#Concealed|concealed]] conditions when it comes to situations that foil average vision.

### Darkvision and Greater Darkvision

A creature with darkvision or greater darkvision can see perfectly well in areas of [[#Darkness|darkness]] and [[#Dim Light|dim light]], though such vision is in black and white only. Some forms of magical darkness, such as a 4th-rank darkness spell, block normal darkvision. A creature with greater darkvision, however, can see through even these forms of magical darkness.

### Low-Light Vision

A creature with low-light vision can see in [[#Dim Light|dim light]] as though it were [[#Bright Light|bright light]], so it ignores the concealed condition due to dim light.
...
Typically, the GM tracks how well creatures detect each other, since neither party has perfect information. For example, you might think a creature is in the last place you sensed it, but it was able to Sneak away. Or you might think a creature can't see you in the dark, but it has [[#Darkvision and Greater Darkvision|darkvision]].
