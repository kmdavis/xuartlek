...
While encounters use rounds for combat, exploration is more free form. The GM determines the flow of time, as you could be traveling by horseback across craggy highlands, negotiating with merchants, or delving in a dungeon in search of danger and treasure. Exploration lacks the immediate danger of [[srd/pf2e-remaster/rules/player-core/chapter-8-playing-the-game/encounter-mode|encounter mode]], but it offers its own challenges.

Much of exploration mode involves movement and roleplaying. You might be traveling from one town to another, chatting with a couple of merchants in an outpost along the way, or maybe having a terse conversation with the watchful city guards at your destination. Instead of measuring your rate of movement in 5-foot squares every round, you measure it in feet or miles per minute, hour, or day, using your [[#Travel Speed|travel speed]]. Rather than deciding on each action every turn, you'll engage in an [[#Exploration Activities|exploration activity]], and you'll typically spend some time every day [[srd/pf2e-remaster/rules/gm-core/chapter-1-running-the-game/running-exploration#Resting|resting]] and making your [[srd/pf2e-remaster/rules/gm-core/chapter-1-running-the-game/running-exploration#Daily Preparations|daily preparations]].
...
>
> [[srd/pf2e-remaster/rules/player-core/chapter-4-skills|Chapter 4: Skills]] includes additional exploration activities.
>
...
After you rest, you make your [[srd/pf2e-remaster/rules/gm-core/chapter-1-running-the-game/running-exploration#Daily Preparations|daily preparations]], which takes around 1 hour. You can prepare only if you've rested, and only once per day. During preparations:
