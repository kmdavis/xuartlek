...
Some effects occupy an area of a specified shape and size. An area effect always has a point of origin and extends out from that point. There are four types of areas: emanations, bursts, cones, and lines. See [[srd/pf2e-remaster/rules/player-core/chapter-8-playing-the-game/area|Area]] for details.
...
Some effects require you to have line of sight to your target. As long as you can precisely sense the area (as described in [[srd/pf2e-remaster/rules/player-core/chapter-8-playing-the-game/perception-and-detection#Precise Senses|Precise Senses]]) and it is not blocked by a solid barrier (as described in [[srd/pf2e-remaster/rules/player-core/chapter-8-playing-the-game/movement#Cover|Cover]]), you have line of sight. An area of [[srd/pf2e-remaster/rules/player-core/chapter-8-playing-the-game/perception-and-detection#Darkness|darkness]] prevents line of sight if you don’t have [[srd/pf2e-remaster/rules/player-core/chapter-8-playing-the-game/perception-and-detection#Darkvision and Greater Darkvision|darkvision]], but portcullises and other obstacles that aren’t totally solid do not. Usually a 1-foot-square gap is enough to maintain line of sight, though the GM makes the final call.
