...
abilities_top:
  - name: "Stench of Decay"
    desc: "(aura, occult, olfactory) The necromancer emits a scent of putrid rot in a 5-foot emanation. A living creature that enters or begins its turn in the aura is sickened 1."
  - name: "Items"
...
attacks:
  - name: "Melee"
    desc: "⬻ light mace +14 (Agile, Finesse, Shove) __Damage__ 1d4+8 bludgeoning"
  - name: "Melee"
...
abilities_bot:
  ...
  - name: "Wave of Death"
    desc: "⬺ (Concentrate, Manipulate, Occult, Void)"
  - name: "Requirements"
    desc: "The necromancer isn't drained and has at least one undead entity active"
  - name: "Effect"
