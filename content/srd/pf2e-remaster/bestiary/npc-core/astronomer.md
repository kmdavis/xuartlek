...
abilities_mid:
  - name: "Reject Myth"
    desc: "⬲"
  - name: "Trigger"
    desc: "A creature within 30 feet Casts a Spell or uses an ability with the fortune or misfortune trait"
  - name: "Effect"
...
attacks:
  - name: "Melee"
    desc: "⬻ fist +8 (Agile, Finesse, Nonlethal, Unarmed) __Damage__ 1d4+4 bludgeoning"
  - name: "Melee"
    desc: "⬻ staff +7 (two-hand d8) __Damage__ 1d4+4 bludgeoning"
spellcasting:
  - name: "Arcane Prepared Spells"
    desc: "DC 17, attack +9 - __Cantrips (1st)__ Detect Magic, Read Aura, Sigil, Telekinetic Hand, Telekinetic Projectile - __1st__ Alarm, Gentle Landing, Phantasmal Minion, Sleep"
