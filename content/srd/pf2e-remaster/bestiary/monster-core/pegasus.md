...
attacks:
  ...
  - name: "Melee"
    desc: "⬻ wing +10 (Agile) __Damage__ 1d6+5 bludgeoning"
abilities_bot:
  - name: "Assisted Mount"
    desc: "⬻"
  - name: "Requirements"
    desc: "The pegasus is Flyingwithout a rider"
  - name: "Effect"
    desc: "The pegasus Flies. At any point during the movement, it can allow a willing adjacent creature to Mount it. That creature must use a reaction to do so."
  - name: "Gallop"
