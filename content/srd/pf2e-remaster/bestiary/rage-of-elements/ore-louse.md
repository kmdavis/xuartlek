...
attacks:
  - name: "Melee"
    desc: "⬻ mandibles +14 (Finesse) __Damage__ 2d8+4 piercing plus rust and metal snack"
  - name: "Melee"
    desc: "⬻ leg +14 (Finesse, 10 feet reach) __Damage__ 2d8+4 bludgeoning plus Knockdown"
  - name: "Melee"
...
abilities_bot:
  - name: "Consume Living Metal"
    desc: "⬻ (Manipulate)"
  - name: "Requirements"
    desc: "The ore louse is adjacent to a creature that died within the last hour and had the metal trait or was another ore louse"
  - name: "Effect"
