...
health:
  - name: "HP"
    desc: "215 (fast healing 15, void healing, plagued coffin restoration); __Immunities__ death effects, disease, paralyzed, poison, sleep; __Resistances__ physical 15 (except magical wood)"
abilities_mid:
  - name: "Air of Sickness"
    desc: "(aura) 30 feet. A creature entering or starting its turn in the aura must attempt a DC 33 Fortitude save. On a failure, the creature is sickened 1 and takes a –2 status penalty to saves to resist diseases and remove the sickened condition for 1 hour."
...
attacks:
  - name: "Melee"
    desc: "⬻ claw +30 (Agile, finesse) __Damage__ 3d10+12 piercing plus plague of ancients"
  - name: "Melee"
    desc: "⬻ fangs +30 (Finesse) __Damage__ 3d12+12 piercing plus Drink Blood"
abilities_bot:
  - name: "Change Shape"
  ...
  - name: "Paralytic Fear"
    desc: "⬻ (Divine, emotion, fear, incapacitation, mental)"
  - name: "Requirements"
  ...
  - name: "Success"
    desc: "The target is immobilized by fear until the end of the nosferatu's next turn."
  - name: "Failure"
    desc: "The target is restrained and takes a –2 circumstance penalty to its Fortitude DC against the nosferatu's Drink Blood ability until the end of the nosferatu's next turn."
  - name: "Critical Failure"
    desc: "As failure, and the target is frightened 2."
...
spellcasting:
  - name: "Divine Innate Spells"
    desc: "DC 36 - __8th__ Telekinetic Haul (×3), Vampiric Exsanguination (×2)"
