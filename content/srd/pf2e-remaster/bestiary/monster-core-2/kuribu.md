...
health:
  - name: "HP"
    desc: "45; __Weaknesses__ unholy 5"
abilities_mid:
  - name: "Sentinel's Aura"
    desc: "(aura, divine) 30 feet. The kuribu and any other creature in the aura defending the same holy site gain a +1 status bonus to AC. This aura is suppressed while Statue is in effect."
...
attacks:
  - name: "Melee"
    desc: "⬻ fist +11 (Agile, Finesse, Holy, Magical) __Damage__ 1d4+6 bludgeoning"
  - name: "Ranged"
    desc: "⬻ composite shortbow +11 (deadly d10, Holy, Magical, Propulsive, range increment 60 feet, reload 0) __Damage__ 1d6+5 piercing"
abilities_bot:
  - name: "Blessed Aspect"
    desc: "⬺ (Divine) The kuribu's face transforms and their holy countenance unleashes an attack based on the aspect the kuribu chooses. The kuribu can't use Blessed Aspect again for 1d4 rounds. They can revert back to their humanoid appearance at any time but they still have to wait before using Blessed Aspect again."
  - name: "Eagle"
    desc: "The kuribu unleashes a disorienting screech in a 15-foot cone that deals 2d10 sonic damage with a DC 19 basic Will save. A creature that critically fails is also stunned 1."
  - name: "Lion"
  ...
  - name: "Ox"
    desc: "The kuribu charges into a creature. The kuribu Flies or Strides. At the end of their movement dealing 4d6 bludgeoning damage to it with a DC 17 basic Fortitude save. If the target critically fails, it is also knocked prone."
  - name: "Statue"
