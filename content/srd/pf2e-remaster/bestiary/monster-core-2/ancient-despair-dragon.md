...
languages: "Common, Draconic; telepathy 90 feet, _truespeech_"
skills:
  - name: "Skills"
...
armorclass:
  - name: "AC"
    desc: "41; __Fort__: +28; __Ref__: +30; __Will__: +32 +2 status to all saves vs. occult"
hp: 325
health:
  - name: "HP"
    desc: "325; __Immunities__ fear, paralyzed, sleep"
abilities_mid:
  - name: "Frightful Presence"
    desc: "(aura, emotion, fear, mental) 60 feet, DC 40"
  - name: "Consume Fear"
    desc: "⬲ (occult)"
  - name: "Trigger"
    desc: "A creature within 60 feet loses the frightened condition"
  - name: "Effect"
    desc: "The dragon feasts upon the fear that leaves the triggering creature's body, gaining 7d8 temporary Hit Points that last for 1 minute."
...
attacks:
  - name: "Melee"
    desc: "⬻ jaws +33 (Magical, reach 20 feet) __Damage__ 3d12+20 piercing"
  - name: "Melee"
    desc: "⬻ claws +33 (Agile, magical, reach 15 feet) __Damage__ 3d10+20 slashing"
  - name: "Melee"
    desc: "⬻ tail +31 (Magical, reach 25 feet) __Damage__ 3d8+18 bludgeoning"
abilities_bot:
  ...
  - name: "Trigger"
    desc: "The dragon successfully Hides from a creature within 90 feet"
  - name: "Effect"
    desc: "The dragon teleports to a space directly behind the target creature. The dragon immediately becomes detected unless their chosen position has cover or another means to remain hidden."
...
spellcasting:
  - name: "Occult Innate Spells"
    desc: "DC 40 - __7th__ Fear (at will), Wave of Despair - __Constant (5th)__ Truespeech"
