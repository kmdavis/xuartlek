...
class: Swashbuckler
ancestry: Goblin
source: Foundry export fvtt-Actor-flick-(wes)-0RU6JYuFZDhsl3JI.json
publish: true
visibility: players
type: pc
---
...
name: Flick
level: 2
ancestry: Goblin # unrendered
heritage: Unbreakable Goblin # unrendered
background: Deckhand # unrendered
class: Swashbuckler # unrendered

rare_03: Swashbuckler # class
rare_04: Deckhand # background
size: Small
trait_01: Goblin
trait_02: Humanoid
...
| Item | Qty | Bulk | Price |
|---|---|---|---|
| Flick's Explosive Dogslicer |  | 2 | 10 gp |
