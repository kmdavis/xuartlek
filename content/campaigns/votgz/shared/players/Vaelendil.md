...
class: Wizard
ancestry: Elf
source: Foundry export fvtt-Actor-vaelendil-(tanusri)-XVxJ9TJfEldjSuah.json
publish: true
visibility: players
type: pc
---
...
name: Vaelendil
level: 2
ancestry: Elf # unrendered
heritage: Seer Elf # unrendered
background: Criminal # unrendered
class: Wizard # unrendered

rare_03: Wizard # class
rare_04: Criminal # background
size: Medium
trait_01: Elf
trait_02: Humanoid
...
skills:
  ...
  stealth: +5
  underworld_lore: +7
abilityMods: [1,1,1,3,2,1]

ac: 12 # unrendered
armorclass:
  - name: "AC"
    desc: "12; __Fort__: +5; __Ref__: +5; __Will__: +8"
hp: 20 # unrendered
health:
  - name: "HP"
    desc: 20
