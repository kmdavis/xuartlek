...
class: Gunslinger
ancestry: Dwarf
source: Foundry export fvtt-Actor-john-jacob-jingleheimer-schmidt-(kevan)-eppEppyerNvsb2mr.json
publish: true
visibility: players
type: pc
---

![[John Jacob Jingleheimer Schmidt Portrait.webp|portrait]]
![[John Jacob Jingleheimer Schmidt Token.webp|token]]

```statblock
layout: Basic Pathfinder 2e Layout
name: John Jacob Jingleheimer Schmidt
level: 2
ancestry: Dwarf # unrendered
heritage: Rock Dwarf # unrendered
background: Detective # unrendered
class: Gunslinger # unrendered

rare_03: Gunslinger # class
rare_04: Detective # background
size: Medium
trait_01: Dwarf
trait_02: Humanoid
...
skills:
  ...
  stealth: +8
  thievery: +8
  underworld_lore_lore: +6
abilityMods: [0,4,2,2,2,-1]
