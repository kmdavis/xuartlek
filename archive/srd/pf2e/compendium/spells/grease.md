...
- **Area** All solid ground in the area is covered with grease. Each creature standing on the greasy surface must succeed at a Reflex save or an [Acrobatics](skills.md#Acrobatics) check against your spell DC or fall [prone](archive/srd/pf2e/rules/conditions.md#Prone). Creatures using an action to move onto the greasy surface during the spell's duration must attempt either a Reflex save or an [Acrobatics](skills.md#Acrobatics) check to [Balance](archive/srd/pf2e/rules/actions/balance.md). A creature that [Steps](archive/srd/pf2e/rules/actions/step.md) or Crawls doesn't have to attempt a check or save.
