...
> [!success-degree] 
> - **Critical Success** The target ally gains a reaction that lets it make a melee [Strike](archive/srd/pf2e/rules/actions/strike.md) against the target enemy, triggered if the enemy leaves a square within the ally's reach. If the ally already has an ability that lets it make melee [Strikes](archive/srd/pf2e/rules/actions/strike.md) as a reaction, such as [Attack of Opportunity](archive/srd/pf2e/rules/actions/attack-of-opportunity.md), the ally can forgo gaining the temporary reaction to instead gain a +2 status bonus to melee [Strikes](archive/srd/pf2e/rules/actions/strike.md) it makes as reactions.
