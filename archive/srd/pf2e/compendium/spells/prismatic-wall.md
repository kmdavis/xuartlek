...
The wall sheds bright light out to 20 feet on each side (and dim light to the next 20 feet). Creatures other than you that come into the wall's light must attempt a Will save; they're [dazzled](archive/srd/pf2e/rules/conditions.md#Dazzled) for 1 round on a success, [blinded](archive/srd/pf2e/rules/conditions.md#Blinded) for 1 round on a failure, and [blinded](archive/srd/pf2e/rules/conditions.md#Blinded) for 1 minute on a critical failure. They are then temporarily immune to the blinding effect for 1 hour.
