...
- **Range**: 30 foot
- **Targets**: 1 willing creature with an unarmed claw [Strike](archive/srd/pf2e/rules/actions/strike.md)
...
**Heightened (4th)** The spell can affect up to 6 willing creatures with unarmed claw [Strikes](archive/srd/pf2e/rules/actions/strike.md).
