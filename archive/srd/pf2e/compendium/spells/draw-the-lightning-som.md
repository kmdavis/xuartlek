...
**Heightened (8th)** The damage dealt to the initial target increases by `4d12`, and the additional damage dealt on the first [Strike](archive/srd/pf2e/rules/actions/strike.md) each turn increases by `1d12`.
