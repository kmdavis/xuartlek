...
---
# Storm Lord *Focus 9*   
[air](archive/srd/pf2e/rules/traits/air.md "Air Energy & Element Trait")  [druid](archive/srd/pf2e/rules/traits/druid.md "Druid Class Trait")  [electricity](archive/srd/pf2e/rules/traits/electricity.md "Electricity Energy & Element Trait")  [evocation](evocation.md "Evocation School Trait")  [uncommon](archive/srd/pf2e/rules/traits/uncommon.md "Uncommon Rarity Trait")  
...
In addition, once per round you can use a single action, which has the [concentrate](archive/srd/pf2e/rules/traits/concentrate.md "Concentrate Action & Ability Trait") and [manipulate](archive/srd/pf2e/rules/traits/manipulate.md "Manipulate General Trait") traits, to call down a bolt of lightning, striking any target in range that you can see. You deal `10d6` electricity damage to the target; it must attempt a basic Reflex save. On a failure, it is also [deafened](archive/srd/pf2e/rules/conditions.md#Deafened) for 1 round.
