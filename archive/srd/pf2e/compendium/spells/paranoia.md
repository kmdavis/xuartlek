...
> - **Success** The target believes everyone it sees is a potential threat. It becomes [unfriendly](archive/srd/pf2e/rules/conditions.md#Unfriendly) to all creatures to which it wasn't already [hostile](archive/srd/pf2e/rules/conditions.md#Hostile), even those that were previously allies. It treats no one as an ally. The spell ends after 1 round.
