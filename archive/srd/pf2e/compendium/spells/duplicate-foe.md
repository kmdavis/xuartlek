...
The duplicate gains the minion trait, and it can only [Stride](archive/srd/pf2e/rules/actions/stride.md) and [Strike](archive/srd/pf2e/rules/actions/strike.md). Its [Strikes](archive/srd/pf2e/rules/actions/strike.md) deal the target's normal damage but don't apply added effects, since it doesn't have special abilities. The spell automatically ends if the duplicate's Hit Points drop to 0.
...
> - **Success** The duplicate deals half damage with its [Strikes](archive/srd/pf2e/rules/actions/strike.md) and the duration is reduced to a maximum of 2 rounds.
