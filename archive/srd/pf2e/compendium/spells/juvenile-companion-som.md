...
If your companion uses a [hostile](archive/srd/pf2e/rules/conditions.md#Hostile) action, juvenile companion ends. This spell has no effect on a companion that doesn't have a juvenile form.
