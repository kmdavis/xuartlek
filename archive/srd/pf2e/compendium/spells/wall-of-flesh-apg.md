...
When you [Cast the Spell](archive/srd/pf2e/rules/actions/cast-a-spell.md), choose one of the following features for your wall.

- **Mouths** The wall has countless toothy mouths along its surface. The mouths [Strike](archive/srd/pf2e/rules/actions/strike.md) any creature that ends its turn within 5 feet of the wall, using your spell attack roll for these [Strikes](archive/srd/pf2e/rules/actions/strike.md) and dealing piercing damage equal to `1d6` + your spellcasting ability modifier. The mouths are capable of consuming potions; since the wall is alive, it can recover Hit Points from a potion of healing, but it can't benefit from any effect that would give it the ability to move. Otherwise, the GM determines which potions can affect the wall.
...
> - **Failure** The creature is [grabbed](archive/srd/pf2e/rules/conditions.md#Grabbed) by the wall for 1 round or until it [Escapes](archive/srd/pf2e/rules/actions/escape.md) against your spell DC, whichever comes first.
> - **Critical Failure** The creature is [restrained](archive/srd/pf2e/rules/conditions.md#Restrained) by the wall for 1 round or until it [Escapes](archive/srd/pf2e/rules/actions/escape.md) against your spell DC, whichever comes first.
