...
---
# Demon Form *Spell 6*   
[chaotic](chaotic.md "Chaotic Alignment Trait")  [evil](evil.md "Evil Alignment Trait")  [polymorph](archive/srd/pf2e/rules/traits/polymorph.md "Polymorph Effect Trait")  [transmutation](transmutation.md "Transmutation School Trait")  
...
- One or more attacks specific to the battle form you use. You're trained with them. Your attack modifier is +22, and you use the listed damage. These attacks are Strength based (for the purpose of the [enfeebled](archive/srd/pf2e/rules/conditions.md#Enfeebled) condition, for example). If your attack modifier is higher for the given unarmed attack or weapon, you can use it instead.
...
- **Babau** Speed 25 feet; **Melee** [>](chapter-9-playing-the-game.md#Actions "Single Action") longspear (reach <10 feet>), **Damage** `2d8+10` piercing plus `1d6` evil; **Melee** [>](chapter-9-playing-the-game.md#Actions "Single Action") jaws, **Damage** `2d10` piercing plus `1d6` evil; **Melee** [>](chapter-9-playing-the-game.md#Actions "Single Action") claw ([agile](archive/srd/pf2e/rules/traits/agile.md "Agile Weapon Trait")), **Damage** `2d4` slashing plus `1d6` evil; all [Strikes](archive/srd/pf2e/rules/actions/strike.md) deal `2d6` additional precision damage to flatfooted creatures.
...
- **Nabasu** Speed 25 feet, fly 40 feet; **Melee** [>](chapter-9-playing-the-game.md#Actions "Single Action") jaws, **Damage** `2d10+10` piercing plus `1d6` evil; **Melee** [>](chapter-9-playing-the-game.md#Actions "Single Action") claw ([agile](archive/srd/pf2e/rules/traits/agile.md "Agile Weapon Trait")), **Damage** `2d6` slashing plus `1d6` evil.
- **Vrock** Speed 25 feet, fly 35 feet; resistance 10 to electricity; **Melee** [>](chapter-9-playing-the-game.md#Actions "Single Action") beak, **Damage** `2d8+10` piercing plus `1d6` evil; **Melee** [>](chapter-9-playing-the-game.md#Actions "Single Action") claw ([agile](archive/srd/pf2e/rules/traits/agile.md "Agile Weapon Trait")), **Damage** `2d6` slashing plus `1d6` evil; **Melee** [>](chapter-9-playing-the-game.md#Actions "Single Action") talon ([agile](archive/srd/pf2e/rules/traits/agile.md "Agile Weapon Trait")), **Damage** `2d6` slashing plus `1d6` evil.
