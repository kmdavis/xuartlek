...
An elemental force fills your target, granting the target the swiftness of air, the ruggedness of earth, the sting of fire, or the flexibility of water, depending on which element you choose. Choose an element when you [Cast the Spell](archive/srd/pf2e/rules/actions/cast-a-spell.md).
...
- **Earth** While on the ground, the target gets a +2 status bonus to Fortitude and Reflex saves against effects that would [Shove](archive/srd/pf2e/rules/actions/shove.md) or [Trip](archive/srd/pf2e/rules/actions/trip.md) it, and to saves against effects that would attempt to knock it [prone](archive/srd/pf2e/rules/conditions.md#Prone). In addition, the ground adjacent to the target is difficult terrain, and the difficult terrain moves with the target, though the target ignores this difficult terrain with its own movement.
- **Fire** The target's melee unarmed [Strikes](archive/srd/pf2e/rules/actions/strike.md) and melee weapon [Strikes](archive/srd/pf2e/rules/actions/strike.md) deal `1d6` [persistent fire damage](archive/srd/pf2e/rules/conditions.md#Persistent%20Damage) on a hit.
