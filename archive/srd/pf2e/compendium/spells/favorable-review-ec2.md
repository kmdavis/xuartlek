...
> - **Critical Failure** As failure, except the duration is permanent and the target genuinely holds a favorable opinion about the subject, with their attitude toward the creature (or creatures associated with the subject, such as the owner of a location or artists in a performance) becoming two degrees better (for example, [helpful](archive/srd/pf2e/rules/conditions.md#Helpful) instead of [indifferent](archive/srd/pf2e/rules/conditions.md#Indifferent)).
