...
You weave light into a cube of vivid and fantastic patterns. The walls shed bright light for 10 feet (and dim light for the next 20 feet) and completely block line of sight; creatures within the cage can't be seen by creatures outside of it, though they can see each other, and creatures outside of it can't see into it. You can [Dismiss](archive/srd/pf2e/rules/actions/dismiss.md) the spell, and if you [Cast the Spell](archive/srd/pf2e/rules/actions/cast-a-spell.md) again, your previous hologram cage ends.
