...
> - **Critical Failure** You don't conjure any daemons, and the self-sacrifice required to perform the ritual leaves you [drained](archive/srd/pf2e/rules/conditions.md#Drained) (or [drained](archive/srd/pf2e/rules/conditions.md#Drained) if the spell level is 5 or higher).
