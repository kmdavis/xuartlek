...
---
# Statuette *Ritual 6*  
[polymorph](archive/srd/pf2e/rules/traits/polymorph.md "Polymorph Effect Trait")  [rare](archive/srd/pf2e/rules/traits/rare.md "Rare Rarity Trait")  
...
This ritual is a variant of the [shrink item](archive/srd/pf2e/compendium/spells/shrink-item.md) spell that allows for the transformation of significantly larger items. You transform the object into a tiny statuette of itself that is Light Bulk. The ritual does not shrink any creatures inside or on top of the item when it is transformed. The item remains in statuette form until the ritual's duration expires or until a creature places it on a stable surface and uses a 10-minute activity to [Interact](archive/srd/pf2e/rules/actions/interact.md) with the item to enlarge it. When restored to its normal size, the object simply pushes other creatures and objects aside or harmlessly contains them, as a magic item with the [structure](archive/srd/pf2e/rules/traits/structure.md "Structure General Trait") trait.
