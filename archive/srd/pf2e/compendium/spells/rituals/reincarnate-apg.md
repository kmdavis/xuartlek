...
> - **Success** As critical success, except the new body has 1 HP and no spells prepared or points in any pools. The soul takes some time to adjust to their new body, leaving them [clumsy](archive/srd/pf2e/rules/conditions.md#Clumsy), [drained](archive/srd/pf2e/rules/conditions.md#Drained), and [enfeebled](archive/srd/pf2e/rules/conditions.md#Enfeebled) for 1 week; these conditions can't be removed or reduced by any means until the week has passed.
