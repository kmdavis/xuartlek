...
A successful [dispel magic](archive/srd/pf2e/compendium/spells/dispel-magic.md) used on a specific effect removes only that effect (such as the [lock](archive/srd/pf2e/compendium/spells/lock.md) effect on one window). A successful [disjunction](disjunction.md) ends the entire ritual.
...
> - **Critical Failure** The area becomes trapped and [hostile](archive/srd/pf2e/rules/conditions.md#Hostile) to you and your allies in a way you didn't anticipate.
