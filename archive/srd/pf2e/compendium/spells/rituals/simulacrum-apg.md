...
- **Secondary Casters** 3
- **Primary Checks** [Arcana](skills.md#Arcana) or [Occultism](skills.md#Occultism) (master, the check has the [secret](archive/srd/pf2e/rules/traits/secret.md "Secret General Trait") trait)
- **Secondary Checks** [Arcana](skills.md#Arcana), [Nature](skills.md#Nature), [Occultism](skills.md#Occultism), [Religion](skills.md#Religion), or [Society](skills.md#Society) (whichever is required to [Recall Knowledge](archive/srd/pf2e/rules/actions/recall-knowledge.md) about the creature being duplicated); [Crafting](skills.md#Crafting), [Deception](skills.md#Deception)
- **Range**: 20 feet
- **Targets**: 1 living creature

You create an illusory duplicate of the target creature by animating ice or snow sculpted in its shape. The simulacrum is a 4th-level creature with no special abilities. If it needs to attempt a roll or use a DC, use the moderate number for a monster, except as noted below. It doesn't have any specific memories from the target, but it can use information about the creature gained from any of the casters to [Impersonate](archive/srd/pf2e/rules/actions/impersonate.md) the target. It looks exactly like the target and has a [Deception](skills.md#Deception) modifier to [Impersonate](archive/srd/pf2e/rules/actions/impersonate.md) that creature equal to the modifier of the secondary spellcaster who rolled the [Deception](skills.md#Deception) check, with a +4 status bonus.
...
> - **Critical Failure** The simulacrum awakens, but it isn't your [minion](archive/srd/pf2e/rules/traits/minion.md "Minion Creature Trait") and is [hostile](archive/srd/pf2e/rules/conditions.md#Hostile) to all the casters. It does everything it can to destroy them, but if it can't immediately slay them, the simulacrum tries to escape and plots their demise.
