...
Casting veil counts as setting up a disguise for the purpose of the [Impersonate](archive/srd/pf2e/rules/actions/impersonate.md) action. It allows the target to ignore any circumstance penalties they might take for being disguised as dissimilar creatures, and it gives the targets a +4 status bonus to [Deception](skills.md#Deception) checks to prevent others from seeing through their disguises, and add their level even if untrained. You can [Dismiss](archive/srd/pf2e/rules/actions/dismiss.md) any or all of these disguises.

**Heightened (5th)** The spell also disguises the targets' voices and scents; it gains the [auditory](archive/srd/pf2e/rules/traits/auditory.md "Auditory Effect Trait") trait.

**Heightened (7th)** The targets can appear as any creature of the same size, even specific individuals. You must have seen an individual to reproduce their appearance. The spell also disguises the targets' voices and scents; it gains the [auditory](archive/srd/pf2e/rules/traits/auditory.md "Auditory Effect Trait") trait.
