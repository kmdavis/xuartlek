...
If the target is opened, the spell ends. Assuming the target is not barred or locked in some additional way, you can unlock and open it with an [Interact](archive/srd/pf2e/rules/actions/interact.md) action during which you touch the target. This does not end the spell. You can [Dismiss](archive/srd/pf2e/rules/actions/dismiss.md) this spell at any time and from any distance.
