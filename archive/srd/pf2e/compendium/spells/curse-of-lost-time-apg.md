...
[curse](archive/srd/pf2e/rules/traits/curse.md "Curse Effect Trait")  [negative](negative.md "Negative Energy & Element Trait")  [transmutation](transmutation.md "Transmutation School Trait")  
...
- **Construct** The construct takes `4d6` damage (basic Fortitude save). On a failure, for 1 hour the construct is [clumsy](archive/srd/pf2e/rules/conditions.md#Clumsy), is [enfeebled](archive/srd/pf2e/rules/conditions.md#Enfeebled), and can't be Repaired, and the curse attempts to counteract any spell that would restore the construct's Hit Points. On a critical failure, these effects have an unlimited duration.
...
> - **Success** The living creature briefly ages, becoming [clumsy](archive/srd/pf2e/rules/conditions.md#Clumsy) and [enfeebled](archive/srd/pf2e/rules/conditions.md#Enfeebled) for 1 round.
