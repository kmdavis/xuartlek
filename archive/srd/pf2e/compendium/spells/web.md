...
> - **Critical Failure** The creature is [immobilized](archive/srd/pf2e/rules/conditions.md#Immobilized) until the start of its next turn, after which it takes a –10-foot circumstance penalty to its Speeds for 1 round. It can attempt to [Escape](archive/srd/pf2e/rules/actions/escape.md) to remove its [immobilized](archive/srd/pf2e/rules/conditions.md#Immobilized) condition.
