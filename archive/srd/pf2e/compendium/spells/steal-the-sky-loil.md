...
- **Trigger**: You make a successful unarmed [Strike](archive/srd/pf2e/rules/actions/strike.md) against a flying creature.
...
> - **Failure** As success; if the target hits a surface, it falls [prone](archive/srd/pf2e/rules/conditions.md#Prone) and can't [Fly](archive/srd/pf2e/rules/actions/fly.md), levitate, or otherwise leave the ground for 1 minute.
