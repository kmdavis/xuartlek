...
Each time you hit a creature with a [Strike](archive/srd/pf2e/rules/actions/strike.md), one of the wisps goes hurtling towards that creature, dealing `1d4` fire damage. If you [Cast a Spell](archive/srd/pf2e/rules/actions/cast-a-spell.md) with the [fire](archive/srd/pf2e/rules/traits/fire.md "Fire Energy & Element Trait") trait while you have fewer than three wisps, a new wisp appears.
