...
---
# Upheaval *Spell 9*   
[conjuration](conjuration.md "Conjuration School Trait")  [earth](archive/srd/pf2e/rules/traits/earth.md "Earth Energy & Element Trait")  [uncommon](archive/srd/pf2e/rules/traits/uncommon.md "Uncommon Rarity Trait")  
...
> - **Success** The creature takes half the collapse damage and falls [prone](archive/srd/pf2e/rules/conditions.md#Prone).
> - **Failure** The creature takes the full collapse damage and falls [prone](archive/srd/pf2e/rules/conditions.md#Prone).
> - **Critical Failure** The creature takes the full collapse damage and is [restrained](archive/srd/pf2e/rules/conditions.md#Restrained) by debris until it successfully Escapes (DC equal to the spell's save DC).
