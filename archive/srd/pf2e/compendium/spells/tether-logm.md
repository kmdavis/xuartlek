...
You use magical chains, vines, or other tethers to bind your target to you. The creature can still try to [Escape](archive/srd/pf2e/rules/actions/escape.md), and it or others can break the tethers by attacking them (the tethers have AC 15 and 10 Hit Points). You must stay within 30 feet of the target while it is tethered; moving more than 30 feet away from your target ends the spell. The target must attempt a Reflex save.

> [!success-degree] 
> - **Critical Success** The target is unaffected.
> - **Success** The target takes a –5-foot circumstance penalty to its Speed as long as it is within 30 feet of you.
> - **Failure** The target takes a –10-foot circumstance penalty to its Speed and cannot move more than 30 feet away from you until it [Escapes](archive/srd/pf2e/rules/actions/escape.md) or the spell ends.
> - **Critical Failure** The target is [immobilized](archive/srd/pf2e/rules/conditions.md#Immobilized) until it [Escapes](archive/srd/pf2e/rules/actions/escape.md) or the spell ends.
