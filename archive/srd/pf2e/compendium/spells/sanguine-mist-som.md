...
[death](archive/srd/pf2e/rules/traits/death.md "Death Effect Trait")  [necromancy](necromancy.md "Necromancy School Trait")  [negative](negative.md "Negative Energy & Element Trait")  
...
You unleash a cloud of foul, blood-sucking fog that drains the vitality from the living to bolster your own. Each living creature in the area when you [Cast the Spell](archive/srd/pf2e/rules/actions/cast-a-spell.md), aside from you, takes `6d6` negative damage with a basic Fortitude save. Creatures in the area are [concealed](archive/srd/pf2e/rules/conditions.md#Concealed), and all creatures outside the cloud become [concealed](archive/srd/pf2e/rules/conditions.md#Concealed) to creatures within it.
