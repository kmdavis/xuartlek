...
It's immune to critical hits and precision damage. [Disintegrate](archive/srd/pf2e/compendium/spells/disintegrate.md) destroys the sphere instantly. If the target is unwilling, the effects of the sphere depend on the target's Reflex save.
