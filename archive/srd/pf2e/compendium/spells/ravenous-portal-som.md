...
When that happens, the door transforms into a mimic that can't move and is [hostile](archive/srd/pf2e/rules/conditions.md#Hostile) to all creatures. When [Casting the Spell](archive/srd/pf2e/rules/actions/cast-a-spell.md), you designate yourself and up to 10 other creatures of your choice; these creatures don't trigger the ward, and the mimic is [helpful](archive/srd/pf2e/rules/conditions.md#Helpful) to them instead of [hostile](archive/srd/pf2e/rules/conditions.md#Hostile). No effect can move the mimic unless it's also capable of moving the entire door. Once the door transforms into a mimic, it attacks creatures in its reach for up to 1 minute, and then the spell ends. If the mimic is killed before that time, the spell ends and the door returns to its normal form.
