...
- **Domains** [ambition](archive/srd/pf2e/compendium/setting/domains.md#Ambition)
...
> - **Success** The target takes a –1 status penalty to its saving throws and other defenses against attempts to [Coerce](archive/srd/pf2e/rules/actions/coerce.md) it, [Request](archive/srd/pf2e/rules/actions/request.md) something of it, or use [mental](archive/srd/pf2e/rules/traits/mental.md "Mental Effect Trait") effects to convince it to do something (such as a [suggestion](archive/srd/pf2e/compendium/spells/suggestion.md) spell). This penalty applies only if the target is being encouraged to advance its own ambitions.
