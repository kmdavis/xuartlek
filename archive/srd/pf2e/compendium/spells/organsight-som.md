...
When you [Cast the Spell](archive/srd/pf2e/rules/actions/cast-a-spell.md), attempt a special [Recall Knowledge](archive/srd/pf2e/rules/actions/recall-knowledge.md) check using [Medicine](skills.md#Medicine) to spot and discern a vital organ. If you have a [Lore](skills.md#Lore) skill appropriate to the creature, you can use that skill instead of [Medicine](skills.md#Medicine). If you succeed, the next time you deal piercing or slashing damage to the target with a [Strike](archive/srd/pf2e/rules/actions/strike.md) or spell, you deal `4d6` additional precision damage. Once on each of your subsequent turns, you can use a single action to attempt the special [Recall Knowledge](archive/srd/pf2e/rules/actions/recall-knowledge.md) check again. The extra damage isn't cumulative, so making the check more than once before a [Strike](archive/srd/pf2e/rules/actions/strike.md) or spell has no extra benefit.
