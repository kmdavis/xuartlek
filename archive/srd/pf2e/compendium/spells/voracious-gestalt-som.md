...
[aura](archive/srd/pf2e/rules/traits/aura.md "Aura Combat Trait")  [death](archive/srd/pf2e/rules/traits/death.md "Death Effect Trait")  [evil](evil.md "Evil Alignment Trait")  [necromancy](necromancy.md "Necromancy School Trait")  
...
When you [Cast the Spell](archive/srd/pf2e/rules/actions/cast-a-spell.md), the gestalt deals `14d6` negative damage to all living creatures of your choice in the area, with a basic Fortitude save. Creatures you choose that end their turns in the area take `6d6` damage, with a basic Fortitude save.
