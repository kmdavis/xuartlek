...
---
# Falling Sky *Spell 8*   
[evocation](evocation.md "Evocation School Trait")  [incapacitation](archive/srd/pf2e/rules/traits/incapacitation.md "Incapacitation Effect Trait")  
...
> [!success-degree] 
> - **Critical Success** The creature is unaffected, and if it was flying, it isn't knocked [prone](archive/srd/pf2e/rules/conditions.md#Prone) even though it took falling damage.
> - **Success** The creature is knocked [prone](archive/srd/pf2e/rules/conditions.md#Prone).
> - **Failure** The creature is knocked [prone](archive/srd/pf2e/rules/conditions.md#Prone) and [stunned](archive/srd/pf2e/rules/conditions.md#Stunned).
> - **Critical Failure** The creature is knocked [prone](archive/srd/pf2e/rules/conditions.md#Prone) and [stunned](archive/srd/pf2e/rules/conditions.md#Stunned) for 1 round.
