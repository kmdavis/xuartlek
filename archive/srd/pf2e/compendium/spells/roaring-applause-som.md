...
> - **Failure** The target applauds you so vigorously that it can't use reactions and is [slowed](archive/srd/pf2e/rules/conditions.md#Slowed). The applause is so involved that it has the [manipulate](archive/srd/pf2e/rules/traits/manipulate.md "Manipulate General Trait") trait. This triggers reactions based on the [manipulate](archive/srd/pf2e/rules/traits/manipulate.md "Manipulate General Trait") trait at the start of the target's turn.
> - **Critical Failure** As failure, plus the target is so distracted by its vigorous applauding of you that it's [fascinated](archive/srd/pf2e/rules/conditions.md#Fascinated) with you.
