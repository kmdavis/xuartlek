...
When you use Nimble Dodge and the triggering attack fails or critically fails, or when you succeed or critically succeed at the saving throw, you can also [Stride](archive/srd/pf2e/rules/actions/stride.md) up to 10 feet as part of the reaction. If you do, the reaction gains the [move](archive/srd/pf2e/rules/traits/move.md "Move Combat Trait") trait. You can use Nimble Roll while Flying or Swimming instead of [Striding](archive/srd/pf2e/rules/actions/stride.md) if you have the corresponding movement type.
