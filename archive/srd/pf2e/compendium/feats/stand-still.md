...
You strike out when your foe tries to flee. Make a melee [Strike](archive/srd/pf2e/rules/actions/strike.md) against the triggering creature. If the attack is a critical hit and the trigger was a move action, you disrupt that action.
