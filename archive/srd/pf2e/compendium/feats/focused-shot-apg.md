...
[concentrate](archive/srd/pf2e/rules/traits/concentrate.md "Concentrate Action & Ability Trait")  [monk](archive/srd/pf2e/rules/traits/monk.md "Monk Class Trait")  
...
You achieve a state of perfect calm before unleashing your attack, opening your mind to the minute movements of the world around you to increase your accuracy. Make a ranged weapon [Strike](archive/srd/pf2e/rules/actions/strike.md) against a target within your weapon's first range increment. This [Strike](archive/srd/pf2e/rules/actions/strike.md) ignores the target's [concealed](archive/srd/pf2e/rules/conditions.md#Concealed) condition and all cover.
