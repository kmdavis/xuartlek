...
[plant](archive/srd/pf2e/rules/traits/plant.md "Plant Creature Type Trait")  [primal](archive/srd/pf2e/rules/traits/primal.md "Primal Tradition Trait")  ardande  

- **Frequency**: once per day
- **Activity** Two-Action

Vitality and elemental wood flows out from your body and into the earth, infusing it with a stream of new life. When you walk, you leave blooming flowers and sprouting vines in your wake. For the next minute, each time you [Step](archive/srd/pf2e/rules/actions/step.md) or [Stride](archive/srd/pf2e/rules/actions/stride.md), you create difficult terrain in each square you leave during your movement.
