...
[druid](archive/srd/pf2e/rules/traits/druid.md "Druid Class Trait")  [exploration](archive/srd/pf2e/rules/traits/exploration.md "Exploration Action & Ability Trait")  


You cultivate a seed that can sprout into a wooden staff, vine whip, or another weapon. You spend 10 minutes focusing primal energy into a seed, imprinting it with the potential of a single level 0 weapon you are trained with and that has no mechanical parts or metal components. When holding the imprinted seed, you can spend a single [Interact](archive/srd/pf2e/rules/actions/interact.md) action to cause it to immediately grow into that weapon; a second [Interact](archive/srd/pf2e/rules/actions/interact.md) action returns it to seed form. Your verdant weapon functions as the imprinted weapon and can be etched with runes or affixed with talismans as normal, which are suppressed when the weapon is in seed form. It also becomes a primal focus.
