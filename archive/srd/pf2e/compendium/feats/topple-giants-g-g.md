...
When an ally within your overwatch field attempts to [Disarm](archive/srd/pf2e/rules/actions/disarm.md), [Shove](archive/srd/pf2e/rules/actions/shove.md), or [Trip](archive/srd/pf2e/rules/actions/trip.md) an opponent within your overwatch field and fails, you coordinate efforts to provide a +2 circumstance bonus to the next [Athletics](skills.md#Athletics) check rolled by a different ally to attempt the same action on the same target before that target's next turn.
