...
Your final blow can make an impact even if it rebounds off a foe's defenses. Make a [Strike](archive/srd/pf2e/rules/actions/strike.md) with the required weapon. After the [Strike](archive/srd/pf2e/rules/actions/strike.md), your turn ends. The [Strike](archive/srd/pf2e/rules/actions/strike.md) deals one extra weapon damage die, or two extra weapon damage dice if you're at least 18th level. The [Strike](archive/srd/pf2e/rules/actions/strike.md) also gains the following failure effect.
