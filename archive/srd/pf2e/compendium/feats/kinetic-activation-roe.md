...
Rather than incantations and gestures, you can use your kinetic gate to directly unlock the potential of elementally empowered magic items. You can Activate magic items that require you to be able to [Cast a Spell](archive/srd/pf2e/rules/actions/cast-a-spell.md), provided you activate them to [Cast a Spell](archive/srd/pf2e/rules/actions/cast-a-spell.md) with the same trait as one of your kinetic elements; for example, if you can channel fire, you could Activate a scroll of fireball.
