...
> [!success-degree] 
> - **Critical Success** You slam the foe down and the magical energy overwhelms it. The creature is knocked [prone](archive/srd/pf2e/rules/conditions.md#Prone), becomes [dazzled](archive/srd/pf2e/rules/conditions.md#Dazzled) for 1 round, and takes damage equal to `2d6` plus your Strength modifier. The foe is no longer [grabbed](archive/srd/pf2e/rules/conditions.md#Grabbed) or [restrained](archive/srd/pf2e/rules/conditions.md#Restrained) by you.
> - **Success** You slam the foe down. The creature is knocked [prone](archive/srd/pf2e/rules/conditions.md#Prone) and takes damage equal to your Strength modifier. The foe is no longer [grabbed](archive/srd/pf2e/rules/conditions.md#Grabbed) or [restrained](archive/srd/pf2e/rules/conditions.md#Restrained) by you.
> - **Failure** You are unable to slam the creature, but your hold on the creature remains.
> - **Critical Failure** The creature breaks free and is no longer [grabbed](archive/srd/pf2e/rules/conditions.md#Grabbed) or [restrained](archive/srd/pf2e/rules/conditions.md#Restrained) by you.
