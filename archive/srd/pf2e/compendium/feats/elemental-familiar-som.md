...
Your familiar gains one additional familiar ability each day, which must be one of the following elemental familiar abilities. While your familiar has an elemental familiar ability, your familiar is composed of the associated elemental matter and gains the matching [elemental](archive/srd/pf2e/rules/traits/elemental.md "Elemental Creature Type Trait") trait. You can't select more than one elemental familiar ability at a time.

- **Air** If your familiar stays completely still for 1 round, it becomes [invisible](archive/srd/pf2e/rules/conditions.md#Invisible) until it next takes an action. Any motion, even being moved or carried by another creature, ends this effect.
...
- **Water** Your familiar can move through a gap at least 2 inches wide without [Squeezing](archive/srd/pf2e/rules/actions/squeeze.md) and can [Squeeze](archive/srd/pf2e/rules/actions/squeeze.md) through a gap at least 1 inch wide.
