...
- **Prerequisites**: [Arcane Evolution](archive/srd/pf2e/compendium/feats/arcane-evolution.md) or [Primal Evolution](archive/srd/pf2e/compendium/feats/primal-evolution.md)
...
If you have Arcane Evolution, you can also choose from any battle form spell in your spellbook. If you have Primal Evolution, you can [Cast a Spell](archive/srd/pf2e/rules/actions/cast-a-spell.md) listed in that feat using the extra spell slot the feat grants (instead of a sorcerer spell slot).
