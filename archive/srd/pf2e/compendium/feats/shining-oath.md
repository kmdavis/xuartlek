...
Your [Retributive Strike](archive/srd/pf2e/rules/actions/retributive-strike.md) gains a +4 circumstance bonus to damage against an undead, or +6 if you have master proficiency with the weapon you used. Your [Glimpse of Redemption](archive/srd/pf2e/rules/actions/glimpse-of-redemption.md)'s resistance against damage from an undead is 7 + your level. If you use [Liberating Step](archive/srd/pf2e/rules/actions/liberating-step.md) triggered by an undead, your ally gains a +4 circumstance bonus to checks granted by your [Liberating Step](archive/srd/pf2e/rules/actions/liberating-step.md), and the ally can [Step](archive/srd/pf2e/rules/actions/step.md) twice afterward.

You don't consider undead to be legitimate authorities, even in nations ruled by undead.

## Shining Oath leads to...

[Aura Of Life](archive/srd/pf2e/compendium/feats/aura-of-life.md)
