...
- **Arctic** For 1 hour, treat environmental [cold](archive/srd/pf2e/rules/traits/cold.md "Cold Energy & Element Trait") effects as if they were one step less severe.
- **Desert** For 1 hour, treat environmental heat effects as if they were one step less severe.
- **Forest** Gain a +2 circumstance bonus to saves against [disease](archive/srd/pf2e/rules/traits/disease.md "Disease Effect Trait") and [poison](archive/srd/pf2e/rules/traits/poison.md "Poison Effect Trait") effects.
- **Mountain** Gain a +1 circumstance bonus to Reflex saves.
- **Plains** Gain a +1 circumstance bonus to Will saves.
- **Swamp** Remove one source of [persistent bleed damage](archive/srd/pf2e/rules/conditions.md#Persistent%20Damage).
