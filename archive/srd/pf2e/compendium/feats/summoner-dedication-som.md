...
Due to your tenuous link, you can't gain or use [tandem](tandem-som.md "Tandem Action & Ability Trait") actions. Because you don't have [Act Together](act-together-som.md), only you or your eidolon can perform an [exploration](archive/srd/pf2e/rules/traits/exploration.md "Exploration Action & Ability Trait") activity at one time, so for instance you couldn't both be [Searching](archive/srd/pf2e/rules/actions/search.md) or [Investigating](archive/srd/pf2e/rules/actions/investigate.md).
