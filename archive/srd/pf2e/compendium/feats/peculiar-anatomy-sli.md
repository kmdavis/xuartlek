...
In addition, your resistance to precision damage from [Disturbing Defense](disturbing-defense-sli.md) increases to an amount equal to 7 + your number of class feats from the oozemorph archetype, and the DC of your flat checks to recover from [persistent bleed damage](archive/srd/pf2e/rules/conditions.md#Persistent%20Damage) is 8 rather than 13.
