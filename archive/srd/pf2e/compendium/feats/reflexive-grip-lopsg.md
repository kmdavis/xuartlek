...
You gain a +2 circumstance bonus to your Reflex DC when defending against checks to [Disarm](archive/srd/pf2e/rules/actions/disarm.md) you. In addition, when you fall [unconscious](archive/srd/pf2e/rules/conditions.md#Unconscious), you don't drop any weapons that you're currently wielding, though somebody else can remove them from you.
