...
- Cleansing Pollen ([healing](archive/srd/pf2e/rules/traits/healing.md "Healing Effect Trait"), vitality) Each living ally that's in the area or enters it regains `3d4` HP and is then temporarily immune to regaining HP from Tree of Duality for 10 minutes.
- Hallucinogenic Spores ([mental](archive/srd/pf2e/rules/traits/mental.md "Mental Effect Trait")) Enemies in the area are [dazzled](archive/srd/pf2e/rules/conditions.md#Dazzled). An enemy that leaves the area remains [dazzled](archive/srd/pf2e/rules/conditions.md#Dazzled) until the start of its next turn.
