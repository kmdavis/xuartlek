...
You retain not only your vampiric parent's taste for blood but their ability to gain vitality from it. You drink fresh blood from a living humanoid creature, gaining temporary Hit Points equal to the target's level that last for 10 minutes. The target must succeed at a Fortitude save against the higher of your class DC or spell DC or become [drained](archive/srd/pf2e/rules/conditions.md#Drained). Regardless of the outcome of this save, the target is temporarily immune to your Taste Blood for 1 day; further uses of this ability against the target don't increase the [drained](archive/srd/pf2e/rules/conditions.md#Drained) condition or grant you more temporary Hit Points.

To drink a creature's blood, either your last action must have been a fangs [Strike](archive/srd/pf2e/rules/actions/strike.md) that damaged the target, or the target must be [restrained](archive/srd/pf2e/rules/conditions.md#Restrained) or [unconscious](archive/srd/pf2e/rules/conditions.md#Unconscious) and your last action must have been a [Strike](archive/srd/pf2e/rules/actions/strike.md) that dealt piercing or slashing damage to them.

If the target is willing, they don't need to be [restrained](archive/srd/pf2e/rules/conditions.md#Restrained) or [unconscious](archive/srd/pf2e/rules/conditions.md#Unconscious) for the latter.
