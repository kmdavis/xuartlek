...
If you have the [Thorough Reports](thorough-reports-lowg.md) feat and have expert proficiency in the skill you're using to [Recall Knowledge](archive/srd/pf2e/rules/actions/recall-knowledge.md), your circumstance bonus to [Recall Knowledge](archive/srd/pf2e/rules/actions/recall-knowledge.md) about creatures from that feat increases to +4.
