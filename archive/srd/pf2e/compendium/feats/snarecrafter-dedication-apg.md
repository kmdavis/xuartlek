...
- **Prerequisites**: trained in [Crafting](skills.md#Crafting), [Snare Crafting](archive/srd/pf2e/compendium/feats/snare-crafting.md)

You've learned to create a limited number of snares at no cost. Each day during your daily preparations, you can prepare four snares from your formula book for quick deployment; if they normally take 1 minute to [Craft](archive/srd/pf2e/rules/actions/craft.md), you can [Craft](archive/srd/pf2e/rules/actions/craft.md) them with 3 [Interact](archive/srd/pf2e/rules/actions/interact.md) actions. The number of snares increases to six if you're a master in [Crafting](skills.md#Crafting) and eight if you're legendary. Snares prepared in this way don't cost you any resources to [Craft](archive/srd/pf2e/rules/actions/craft.md).
