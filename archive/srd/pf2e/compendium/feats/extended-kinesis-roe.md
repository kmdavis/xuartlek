...
- **Prerequisites**: [Base Kinesis](archive/srd/pf2e/rules/actions/base-kinesis-roe.md)

You've refined the control you can exert over your elements. Add the following options to [Base Kinesis](archive/srd/pf2e/rules/actions/base-kinesis-roe.md).
...
- **Sculpt.** (earth, metal, or wood only) Reshape an existing element into a small object of a design you choose. It looks crude and artificial on close examination. The sculpted element can be shaped into a functional short tool (or a long tool if your [Base Kinesis](archive/srd/pf2e/rules/actions/base-kinesis-roe.md) can affect 1 Bulk or greater). It's too fragile and artificial to be used as a weapon or have any monetary value.
