...
- You can communicate with mindless elementals on a basic level if they have a trait that matches one of your kinetic elements or are made of one of those elements. This allows you to use [Diplomacy](skills.md#Diplomacy) to [Make an Impression](archive/srd/pf2e/rules/actions/make-an-impression.md) on them and to make very simple Requests.
