...
[champion](archive/srd/pf2e/rules/traits/champion.md "Champion Class Trait")  [divine](archive/srd/pf2e/rules/traits/divine.md "Divine Tradition Trait")  [necromancy](necromancy.md "Necromancy School Trait")  [negative](negative.md "Negative Energy & Element Trait")  [uncommon](archive/srd/pf2e/rules/traits/uncommon.md "Uncommon Rarity Trait")  

- **Prerequisites**: divine ally (shield), tenets of evil

Your shield ally is more than just a spirit of protection—it's a conduit for deadly divine magic. When you use your shield ally to [Shield Block](archive/srd/pf2e/compendium/feats/shield-block.md) a melee unarmed attack or a melee weapon [Strike](archive/srd/pf2e/rules/actions/strike.md) from an adjacent creature, the attacker takes `1d6` evil or negative damage (your choice). If the attack or [Strike](archive/srd/pf2e/rules/actions/strike.md) breaks or destroys your shield, double this additional damage.
