...
[cleric](archive/srd/pf2e/rules/traits/cleric.md "Cleric Class Trait")  [exploration](archive/srd/pf2e/rules/traits/exploration.md "Exploration Action & Ability Trait")  
...
- **Shield** The shield gains a +1 status bonus to its Hardness. (This causes it to reduce more damage with the [Shield Block](archive/srd/pf2e/compendium/feats/shield-block.md) reaction.)
- **Weapon** The wielder gains a +1 status bonus to damage rolls.

## Emblazon Armament leads to...

[Emblazon Antimagic](archive/srd/pf2e/compendium/feats/emblazon-antimagic.md), [Emblazon Energy](archive/srd/pf2e/compendium/feats/emblazon-energy.md), [Emblazon Divinity](emblazon-divinity-aoa6.md)
