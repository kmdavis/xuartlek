...
---
# Posse  *Feat 4*  
[archetype](archive/srd/pf2e/rules/traits/archetype.md "Archetype Feat Trait")  [exploration](archive/srd/pf2e/rules/traits/exploration.md "Exploration Action & Ability Trait")  

- **Prerequisites**: [Bounty Hunter Dedication](bounty-hunter-dedication-apg.md)
- **Requirements**: You have designated prey with [Hunt Prey](archive/srd/pf2e/rules/actions/hunt-prey.md).

By spending 1 minute giving guidance to help hunt down your prey, you instruct up to five willing creatures to assist you. They gain a +1 circumstance bonus to [Seek](archive/srd/pf2e/rules/actions/seek.md) your prey, to [Track](archive/srd/pf2e/rules/actions/track.md) your prey, and to [Gather Information](archive/srd/pf2e/rules/actions/gather-information.md) about your prey. You and the creatures assisting you gain a +1 circumstance bonus to initiative rolls when entering combat with your prey.
