...
In addition, a creature must attempt a Will save against your class DC the first time in an encounter you attack it with a Ricochet Shot. If it fails, it's [stunned](archive/srd/pf2e/rules/conditions.md#Stunned) and is unable to determine where your shot originated.
