...
- **Arctic** You need to eat and drink only one-tenth as much as usual, you aren't affected by severe or extreme cold, and you can walk across ice and snow at full Speed without needing to [Balance](archive/srd/pf2e/rules/actions/balance.md).
- **Desert** You need to eat and drink only one-tenth as much as usual, you aren't affected by severe or extreme heat, and you can walk along sand at full Speed without needing to [Balance](archive/srd/pf2e/rules/actions/balance.md).
...
- **Swamp** You can move across bogs at full Speed, even if they are deep enough to be greater difficult terrain or to normally require you to [Swim](archive/srd/pf2e/rules/actions/swim.md).

## Favored Terrain leads to...

[Terrain Master](archive/srd/pf2e/compendium/feats/terrain-master.md)
