...
Your [Retributive Strike](archive/srd/pf2e/rules/actions/retributive-strike.md) gains a +4 circumstance bonus to damage against a fiend, or a +6 circumstance bonus if you have master proficiency with the weapon you used. Your [Glimpse of Redemption](archive/srd/pf2e/rules/actions/glimpse-of-redemption.md)'s resistance against damage from a fiend is 7 + your level. If you use [Liberating Step](archive/srd/pf2e/rules/actions/liberating-step.md) triggered by a fiend, your ally gains a +4 circumstance bonus to checks granted by your [Liberating Step](archive/srd/pf2e/rules/actions/liberating-step.md), and the ally can [Step](archive/srd/pf2e/rules/actions/step.md) twice afterward.
