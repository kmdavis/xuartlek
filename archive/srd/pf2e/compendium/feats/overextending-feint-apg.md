...
When you trick a foe, instead of catching them off guard, you goad them into overextending their next attack. On a successful [Feint](archive/srd/pf2e/rules/actions/feint.md), you can use the following success and critical success effects instead of any other effects that would occur when you [Feint](archive/srd/pf2e/rules/actions/feint.md). You can choose a different effect each time you [Feint](archive/srd/pf2e/rules/actions/feint.md) against a given foe.
