...
- **Prerequisites**: [Mountain Stronghold](archive/srd/pf2e/compendium/feats/mountain-stronghold.md)
- **Requirements**: You are in [Mountain Stance](archive/srd/pf2e/compendium/feats/mountain-stance.md).
- **Activity** Single Action

You stomp, shaking the earth beneath you. Creatures on the ground within a 20-foot emanation take damage equal to your Strength modifier (minimum 0), which they can resist with a basic Fortitude save against your class DC. On a failure, they also fall [prone](archive/srd/pf2e/rules/conditions.md#Prone). After you use this action, you can't use it again for `1d4` rounds.

**Special.** If you have this feat, the Dexterity modifier cap to your AC while using [Mountain Stance](archive/srd/pf2e/compendium/feats/mountain-stance.md) increases from +1 to +2.
