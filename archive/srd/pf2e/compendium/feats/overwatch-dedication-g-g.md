...
You're surrounded by an overwatch field aura in a 30-foot emanation. Your overwatch field aura grants you increased perception and allows you to call out warnings to your allies within the aura to point out threats. This aura has the [auditory](archive/srd/pf2e/rules/traits/auditory.md "Auditory Effect Trait") and [visual](archive/srd/pf2e/rules/traits/visual.md "Visual Effect Trait") traits. You and allies within your overwatch field receive a +2 circumstance bonus when using [Perception](skills.md#Perception) for Initiative checks.
