...
Even as your firearm misfires, you quickly draw a backup weapon. [Release](archive/srd/pf2e/rules/actions/release.md) the misfired weapon if you so choose, and [Interact](archive/srd/pf2e/rules/actions/interact.md) to draw a one-handed weapon.
