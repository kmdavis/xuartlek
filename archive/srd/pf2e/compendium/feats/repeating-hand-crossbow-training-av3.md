...
**Special.** If you have the [Running Reload](archive/srd/pf2e/compendium/feats/running-reload.md) feat, you can reload a repeating hand crossbow magazine on the move. You can use [Running Reload](archive/srd/pf2e/compendium/feats/running-reload.md) as a 3-action activity to reload a magazine into a repeating hand crossbow after you [Stride](archive/srd/pf2e/rules/actions/stride.md), [Step](archive/srd/pf2e/rules/actions/step.md), or [Sneak](archive/srd/pf2e/rules/actions/sneak.md), or as a 2-action activity if you use a magazine from a shootist bandolier.
