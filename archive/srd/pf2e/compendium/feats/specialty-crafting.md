...
Your training focused on [Crafting](skills.md#Crafting) one particular kind of item. Select one of the specialties; you gain a +1 circumstance bonus to [Crafting](skills.md#Crafting) checks to [Craft](archive/srd/pf2e/rules/actions/craft.md) items of that type. If you are a master in [Crafting](skills.md#Crafting), this bonus increases to +2. If it's unclear whether the specialty applies, the GM decides. Some specialties might apply only partially. For example, if you were making a [morningstar](archive/srd/pf2e/compendium/equipment/items/morningstar.md) and had specialty in woodworking, the GM might give you half your bonus because the item requires both blacksmithing and woodworking.
...
*You must have the [Alchemical Crafting](archive/srd/pf2e/compendium/feats/alchemical-crafting.md) skill feat to [Craft](archive/srd/pf2e/rules/actions/craft.md) alchemical items

## Specialty Crafting leads to...

[Impeccable Crafting](archive/srd/pf2e/compendium/feats/impeccable-crafting.md)
