...
Your exoskeleton's weapons are even more potent. If you have a claws unarmed attack, it gains the [deadly <d8>](rules/traits/deadly-d8.md "Deadly Weapon Trait") trait. If you have a branch unarmed attack, it gains the [shove](archive/srd/pf2e/rules/traits/shove.md "Shove Weapon Trait") and [trip](archive/srd/pf2e/rules/traits/trip.md "Trip Weapon Trait") traits.
