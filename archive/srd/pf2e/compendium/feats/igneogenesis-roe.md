...
---
# Igneogenesis  [>>](chapter-9-playing-the-game.md#Actions "Two-Action") *Feat 4*  
...
The object can't include any intricate parts or moving pieces. You can attempt a [Crafting](skills.md#Crafting) skill check as part of using this impulse to add details to your creation, such as a symbol, short message, or pattern (with the DC determined by the GM).
