...
You are adept at quickly scanning loose papers and carefully discerning the contents of sealed letters without damaging the seal. You can attempt [Society](skills.md#Society) checks to [Decipher Writing](archive/srd/pf2e/rules/actions/decipher-writing.md) on a message that is only partially glimpsed, upside down or reversed from your perspective, or even sealed. However, on a critical failure, the recipient is made aware of your efforts (for instance, you damage the seal or disturb the papers in some way). When using this feat to decipher sealed letters, your attempt to [Decipher Writing](archive/srd/pf2e/rules/actions/decipher-writing.md) gains the [manipulate](archive/srd/pf2e/rules/traits/manipulate.md "Manipulate General Trait") trait.
