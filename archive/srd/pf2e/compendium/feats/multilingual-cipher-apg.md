...
You use multiple languages to create and break codes. You gain a +1 circumstance bonus to [Decipher Writing](archive/srd/pf2e/rules/actions/decipher-writing.md). If another creature attempts to [Decipher Writing](archive/srd/pf2e/rules/actions/decipher-writing.md) you encoded, they take a –2 circumstance penalty unless they speak all the languages you used when you created the writing.
