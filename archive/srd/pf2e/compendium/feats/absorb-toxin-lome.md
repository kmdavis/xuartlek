...
- **Trigger** You attempt a saving throw against a [disease](archive/srd/pf2e/rules/traits/disease.md "Disease Effect Trait") or [poison](archive/srd/pf2e/rules/traits/poison.md "Poison Effect Trait") effect that affects an area.
- **Activity** Reaction
