...
Your rapidly metabolize the elemental particles in your opponent's spell to gain a boost of energy. You gain the [quickened](archive/srd/pf2e/rules/conditions.md#Quickened) condition until the end of your next turn. You can use the extra action only to [Step](archive/srd/pf2e/rules/actions/step.md) or [Stride](archive/srd/pf2e/rules/actions/stride.md).
