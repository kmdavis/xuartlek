...
Using your weapon as a lever, you force your opponent to end up right where you want them. Make a [Strike](archive/srd/pf2e/rules/actions/strike.md) with the required weapon. If the [Strike](archive/srd/pf2e/rules/actions/strike.md) hits, you can move the target up to 10 feet into a space in your reach. You can move the target through your space during this movement. This follows the forced movement rules found on page 475. Your [Strike](archive/srd/pf2e/rules/actions/strike.md) gains the following failure effect.
