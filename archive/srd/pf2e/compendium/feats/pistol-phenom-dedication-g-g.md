...
You gain the [Pistol Twirl](pistol-twirl-g-g.md) gunslinger feat, enabling you to [Feint](archive/srd/pf2e/rules/actions/feint.md) against creatures within your weapon's first range increment.

This otherwise serves as Pistol Twirl for the purpose of meeting prerequisites, although as normal, it doesn't count as another pistol phenom feat for the purpose of meeting Pistol Phenom Dedication's special entry and taking another archetype. Whenever you [Feint](archive/srd/pf2e/rules/actions/feint.md) with a one-handed firearm, you can choose to attempt a [Performance](skills.md#Performance) check instead of a [Deception](skills.md#Deception) check.
