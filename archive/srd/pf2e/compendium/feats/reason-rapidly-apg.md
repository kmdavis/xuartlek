...
Your mind works through clues at an unbelievable speed. You instantly use up to five [Recall Knowledge](archive/srd/pf2e/rules/actions/recall-knowledge.md) actions. If you have any special abilities or free actions that would normally be triggered when you [Recall Knowledge](archive/srd/pf2e/rules/actions/recall-knowledge.md), you can't use them for these actions.
