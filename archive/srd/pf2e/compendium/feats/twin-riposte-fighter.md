...
A clever parry with one weapon leaves your opponent open to an attack with the other weapon. Make a melee [Strike](archive/srd/pf2e/rules/actions/strike.md) or use a [Disarm](archive/srd/pf2e/rules/actions/disarm.md) action against the triggering opponent.
