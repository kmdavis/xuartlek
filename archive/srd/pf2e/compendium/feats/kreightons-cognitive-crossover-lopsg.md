...
- **Trigger** You gain no information from a [Recall Knowledge](archive/srd/pf2e/rules/actions/recall-knowledge.md) check (usually because you failed the secret check) using one of the two skills you chose for this feat.
- **Activity** Reaction
