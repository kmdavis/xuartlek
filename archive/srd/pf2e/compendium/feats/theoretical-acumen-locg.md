...
- **Trigger** You succeed at a skill check to [Recall Knowledge](archive/srd/pf2e/rules/actions/recall-knowledge.md) to identify a creature.
- **Activity** Free Action

You study a creature's form and behavior to hypothesize likely means of overcoming its strengths. Once before the end of your next turn, you can use the skill modifier from the triggering check in place of your saving throw modifier against one of the creature's abilities, in place of your [Perception](skills.md#Perception) modifier to [Seek](archive/srd/pf2e/rules/actions/seek.md) the creature, in place of your [Deception](skills.md#Deception) modifier to [Feint](archive/srd/pf2e/rules/actions/feint.md) against the creature, or in place of your [Intimidation](skills.md#Intimidation) modifier to [Demoralize](archive/srd/pf2e/rules/actions/demoralize.md) the creature. Alternatively, against one of the creature's attacks, you can use your DC for the skill used in the triggering check in place of your AC.
