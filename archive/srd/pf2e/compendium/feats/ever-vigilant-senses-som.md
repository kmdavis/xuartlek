...
Your eidolon has enhanced senses. It gains a +2 circumstance bonus to [Perception](skills.md#Perception), and can't be flanked except by creatures that are higher level than it. It can see [invisible](archive/srd/pf2e/rules/conditions.md#Invisible) creatures and objects; they appear translucent and are [concealed](archive/srd/pf2e/rules/conditions.md#Concealed). When your eidolon moves within 30 feet of an illusion that can be 0, the GM rolls a secret check to 0 it, even if your eidolon didn't spend an action to [Interact](archive/srd/pf2e/rules/actions/interact.md).
