...
Each day during your daily preparations, you can create a single temporary scroll containing a 1st-level spell. The spell must be a common spell from the Core Rulebook, or another spell you learned via [Learn a Spell](archive/srd/pf2e/rules/actions/learn-a-spell.md), and it must come from a tradition in which you have the corresponding skill trained.
