...
Your ally can make a melee [Strike](archive/srd/pf2e/rules/actions/strike.md) against the triggering foe as a reaction. This [Strike](archive/srd/pf2e/rules/actions/strike.md) doesn't count toward that ally's multiple attack penalty, and their multiple attack penalty doesn't apply to this [Strike](archive/srd/pf2e/rules/actions/strike.md). If your ally's [Strike](archive/srd/pf2e/rules/actions/strike.md) is successful, combine the damage from your successful ranged attack with the damage from your ally's melee attack for the purpose of determining resistances and weaknesses.
