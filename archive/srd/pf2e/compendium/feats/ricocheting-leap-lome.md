...
- **Prerequisites**: master in [Athletics](skills.md#Athletics), [Wall Jump](archive/srd/pf2e/compendium/feats/wall-jump.md)
...
Once per turn when you make an additional jump off of a creature in this way, you can also attempt to [Shove](archive/srd/pf2e/rules/actions/shove.md) or [Trip](archive/srd/pf2e/rules/actions/trip.md) that creature as a free action.
