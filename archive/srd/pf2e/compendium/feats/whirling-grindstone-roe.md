...
[attack](archive/srd/pf2e/rules/traits/attack.md "Attack Combat Trait")  [composite](composite-roe.md "Composite Action & Ability Trait")  [earth](archive/srd/pf2e/rules/traits/earth.md "Earth Energy & Element Trait")  [impulse](impulse-roe.md "Impulse Action & Ability Trait")  [kineticist](kineticist-roe.md "Kineticist Class Trait")  [metal](metal-roe.md "Metal Energy & Element Trait")  [primal](archive/srd/pf2e/rules/traits/primal.md "Primal Tradition Trait")  
...
A creature within reach of the grindstone can [Interact](archive/srd/pf2e/rules/actions/interact.md) with it to sharpen a metal weapon. This grants a +2 circumstance bonus to the next damage roll made with that weapon within 1 minute.
