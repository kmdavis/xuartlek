...
- **Trigger** The spell attack roll for a foe's spell with an [elemental](archive/srd/pf2e/rules/traits/elemental.md "Elemental Creature Type Trait") trait targeting you fails or critically fails.
- **Activity** Reaction
