...
You've learned a few tricks to ensure you find every last magic item and interesting [magical](archive/srd/pf2e/rules/traits/magical.md "Magical Item Trait") effect during your missions. You can cast [detect magic](archive/srd/pf2e/compendium/spells/detect-magic.md) and read aura as innate spells at will. You can also cast [locate](archive/srd/pf2e/compendium/spells/locate.md) as an innate spell once per day, but only to locate magic items, not specific mundane objects or types of objects. If you could already cast spells, these spells are of the same tradition. Otherwise, they're arcane spells, you use Intelligence as your spellcasting ability, and you become trained in spell attack rolls and spell DCs for arcane spells.

When you cast [detect magic](archive/srd/pf2e/compendium/spells/detect-magic.md) or read aura from this feat on an item or creature under the effect of a [magic aura](magic-aura.md) spell or interact with an item under the effect of an [item facade](archive/srd/pf2e/compendium/spells/item-facade.md) spell, you gain a +2 circumstance bonus on your check to 0.
