...
- **Requirements**: You must have identified a creature with [Recall Knowledge](archive/srd/pf2e/rules/actions/recall-knowledge.md).
...
The next time you deal sneak attack damage to the chosen creature with a [Strike](archive/srd/pf2e/rules/actions/strike.md) before the end of your turn, add an additional `2d6` precision damage. At 11th and 17th levels, if your additional damage from sneak attack increases, increase the additional damage from Analyze Weakness to `3d6` at 11th level and `4d6` at 17th level.
