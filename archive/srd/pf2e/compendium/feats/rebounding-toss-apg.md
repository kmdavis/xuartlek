...
You bounce your weapon off one foe to strike another. Make a ranged [Strike](archive/srd/pf2e/rules/actions/strike.md) with a thrown weapon. If this [Strike](archive/srd/pf2e/rules/actions/strike.md) hits, the weapon rebounds toward an enemy within 10 feet of the original target. Make an additional [Strike](archive/srd/pf2e/rules/actions/strike.md) against this second target. Both attacks count toward your multiple attack penalty, but the penalty doesn't increase until after you've made both attacks.
