...
You can't fuse stances with fundamentally incompatible requirements or restrictions (such as [Ironblood Stance](archive/srd/pf2e/compendium/feats/ironblood-stance.md) and [Crane Stance](archive/srd/pf2e/compendium/feats/crane-stance.md), which both require using only one type of [Strike](archive/srd/pf2e/rules/actions/strike.md)).
