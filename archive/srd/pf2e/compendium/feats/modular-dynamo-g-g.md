...
When you use an [Interact](archive/srd/pf2e/rules/actions/interact.md) action to switch configurations using the [modular](modular-logm.md "Modular Weapon Trait") trait, you switch between the initial configuration of dynamo you chose with the Sterling Dynamo Dedication and the new configuration you chose with Modular Dynamo.

**Special.** You can select this feat multiple times. Each time, you choose another configuration and add it to the list of options you can choose when you use an [Interact](archive/srd/pf2e/rules/actions/interact.md) action with the [modular](modular-logm.md "Modular Weapon Trait") trait.
