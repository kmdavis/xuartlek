...
Undead creatures find it all but impossible to resist your commands. When you use [Hijack Undead](hijack-undead-ooa3.md), if the undead fails its save, it becomes your [minion](archive/srd/pf2e/rules/traits/minion.md "Minion Creature Trait") for 10 minutes. If it critically fails, it becomes your [minion](archive/srd/pf2e/rules/traits/minion.md "Minion Creature Trait") for 24 hours.
