...
This small, stretchable statuette depicts a bear wearing a tutu and a fez and balancing on a ball slightly larger than its head. When activated, it becomes a grizzly bear with similar attire. The bear remains balanced upon its rubber ball, and is therefore ungainly: it cannot [Climb](archive/srd/pf2e/rules/actions/climb.md) or [Swim](archive/srd/pf2e/rules/actions/swim.md), has a –10- foot circumstance penalty to its Speed, and is always [flat-footed](archive/srd/pf2e/rules/conditions.md#Flat-footed). If the bear leaves its ball, such as if it is repositioned with forced movement or knocked [prone](archive/srd/pf2e/rules/conditions.md#Prone), it immediately reverts to statuette form. The bear can be used once per day, and it can remain in bear form for up to 1 hour.
