...
This finely cut garnet brooch fills your mind with vigor and occasional bursts of mental clarity. While wearing the brooch, you gain a +1 item bonus to checks to [Recall Knowledge](archive/srd/pf2e/rules/actions/recall-knowledge.md) with [Lore](skills.md#Lore) skills.
...
The item bonus is +3 and applies to all checks to [Recall Knowledge](archive/srd/pf2e/rules/actions/recall-knowledge.md) with any skill. The activation has a frequency of once per 10 minutes, takes only a single action to activate, and you can attempt to [Recall Knowledge](archive/srd/pf2e/rules/actions/recall-knowledge.md) with any skill.
