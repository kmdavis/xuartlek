...
Derived from a mixture of krooth venom and an agitating agent, scarlet mist causes bleeding that turns into a foaming mist. When a creature under the effects of scarlet mist takes [persistent bleed damage](archive/srd/pf2e/rules/conditions.md#Persistent%20Damage) from the toxin, creatures within 5 feet take the [splash](archive/srd/pf2e/rules/traits/splash.md "Splash Weapon Trait") damage. The [persistent damage](archive/srd/pf2e/rules/conditions.md#Persistent%20Damage) can't be staunched until the poison's effects end. A creature that can't bleed doesn't take the bleed damage or cause the [splash](archive/srd/pf2e/rules/traits/splash.md "Splash Weapon Trait") damage but can still take the poison damage.
