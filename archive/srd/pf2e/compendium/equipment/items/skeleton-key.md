...
A grinning skull tops the bow of this macabre key. This key can be used in place of [thieves' tools](thieves-tools.md) when attempting to [Pick a Lock](archive/srd/pf2e/rules/actions/pick-a-lock.md), and it grants a +1 item bonus to the [Thievery](skills.md#Thievery) check.

If the skeleton key becomes [broken](archive/srd/pf2e/rules/conditions.md#Broken) due to a critical failure on the check, it works as normal [thieves' tools](thieves-tools.md) and loses its benefits until repaired.
