...
- **Dart** The base [persistent bleed damage](archive/srd/pf2e/rules/conditions.md#Persistent%20Damage) increases to `2d6`.
...
- **Knife** The target takes a –5-foot status penalty to its Speed while it has the [persistent bleed damage](archive/srd/pf2e/rules/conditions.md#Persistent%20Damage).
...
- **Spear** The [clumsy](archive/srd/pf2e/rules/conditions.md#Clumsy) condition lasts for 2 rounds.
- **Sword** The target is [flat-footed](archive/srd/pf2e/rules/conditions.md#Flat-footed) until the end of your next turn.
