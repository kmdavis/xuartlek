...
This eye allows you to see as normal, and when you succeed at a [Perception](skills.md#Perception) check against an illusion, you get a critical success instead. Once per day, from any distance, the entity that holds your bargained contract can overwhelm your cryolite eye with magical energy, causing images to float over your vision that inflict the [dazzled](archive/srd/pf2e/rules/conditions.md#Dazzled) condition on you for 1 minute.
