...
[divination](divination.md "Divination School Trait")  [invested](archive/srd/pf2e/rules/traits/invested.md "Invested Item Trait")  [rare](archive/srd/pf2e/rules/traits/rare.md "Rare Rarity Trait")  

- **Price** 160 gp
- **Usage** worn

This ornate copper band has a small ruby set in the center, flanked by a pair of dwarven runes. The wearer of this ring gains the ability to understand, read, and speak one common language of their choice, selected each morning as part of their daily preparations. In addition, the wearer receives a +1 item bonus to [Diplomacy](skills.md#Diplomacy) checks to [Make an Impression](archive/srd/pf2e/rules/actions/make-an-impression.md).
