...
[consumable](archive/srd/pf2e/rules/traits/consumable.md "Consumable Item Trait")  [magical](archive/srd/pf2e/rules/traits/magical.md "Magical Item Trait")  [polymorph](archive/srd/pf2e/rules/traits/polymorph.md "Polymorph Effect Trait")  [potion](archive/srd/pf2e/rules/traits/potion.md "Potion Item Trait")  [transmutation](transmutation.md "Transmutation School Trait")  [uncommon](archive/srd/pf2e/rules/traits/uncommon.md "Uncommon Rarity Trait")  
...
The effects of this potion use the same rules as the [Impersonate](archive/srd/pf2e/rules/actions/impersonate.md) activity of [Deception](skills.md#Deception). Onlookers always assume you're the chosen type of creature unless they're actively Seeking. You gain a +4 status bonus to your [Deception](skills.md#Deception) DC against such [Perception](skills.md#Perception) checks and add your level even if untrained.
...
While drinking a greater potion of disguise, if you picture the specific form you want to transform into, the potion will change you into that form. You can attempt to [Impersonate](archive/srd/pf2e/rules/actions/impersonate.md) a specific individual, though you still need to roll [Deception](skills.md#Deception).
