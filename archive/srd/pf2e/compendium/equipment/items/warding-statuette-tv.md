...
[abjuration](abjuration.md "Abjuration School Trait")  [force](archive/srd/pf2e/rules/traits/force.md "Force Energy & Element Trait")  [magical](archive/srd/pf2e/rules/traits/magical.md "Magical Item Trait")  [spellheart](spellheart-som.md "Spellheart Equipment Trait")  
...
- Weapon When you hit with a [Strike](archive/srd/pf2e/rules/actions/strike.md) using the affixed weapon, or when a spell effect you created by activating the statuette hits with a [Strike](archive/srd/pf2e/rules/actions/strike.md), you can choose a creature adjacent to the creature that was hit. That creature gains a +1 status bonus to AC until the start of your next turn. No more than one creature can benefit from this each turn.
