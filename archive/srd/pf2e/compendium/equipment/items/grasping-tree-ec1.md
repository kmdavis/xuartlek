...
> - **Failure** As success, plus the target is [flat-footed](archive/srd/pf2e/rules/conditions.md#Flat-footed).
> - **Critical Failure** The target takes `2d4` slashing damage and is [immobilized](archive/srd/pf2e/rules/conditions.md#Immobilized) until it destroys the snare (AC 16, HP 25) or Escapes (DC 19).
