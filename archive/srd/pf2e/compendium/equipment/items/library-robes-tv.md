...
You must provide the minimum amount of materials to [Craft](archive/srd/pf2e/rules/actions/craft.md) one scroll of that spell (typically half the Price of a scroll of that level plus any extra cost required for the spell). You don't need to be trained in [Crafting](skills.md#Crafting), nor do you need the Magical [Crafting](skills.md#Crafting) feat. Using this ability erases any scroll already inscribed on the robe.
