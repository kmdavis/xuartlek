...
A suit prepared in this manner grants you a +1 item bonus to [Stealth](skills.md#Stealth) checks while you attempt to [Hide](archive/srd/pf2e/rules/actions/hide.md) or [Sneak](archive/srd/pf2e/rules/actions/sneak.md) in the specific environment it has been prepared for.
