...
[additive <1>](rules/traits/additive-1.md "Additive Feat Trait")  [alchemical](archive/srd/pf2e/rules/traits/alchemical.md "Alchemical Item Trait")  [consumable](archive/srd/pf2e/rules/traits/consumable.md "Consumable Item Trait")  

- **Price** 9 gp
- **Bulk** L; **Usage** held in 1 hand
- **Activate** **Trigger** You use [Quick Alchemy](archive/srd/pf2e/rules/actions/quick-alchemy.md) to craft an alchemical poison that's at least 1 level lower than your advanced alchemy level.
