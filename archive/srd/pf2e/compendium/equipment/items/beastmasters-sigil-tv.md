...
[conjuration](conjuration.md "Conjuration School Trait")  [magical](archive/srd/pf2e/rules/traits/magical.md "Magical Item Trait")  [spellheart](spellheart-som.md "Spellheart Equipment Trait")  
...
- Melee Weapon The sigil grants you a +1 item bonus to [Athletics](skills.md#Athletics) checks to [Trip](archive/srd/pf2e/rules/actions/trip.md).
- Ranged Weapon If you critically hit with the affixed weapon, and the target is adjacent to a creature summoned with the sigil, the target takes `1d6` [persistent bleed damage](archive/srd/pf2e/rules/conditions.md#Persistent%20Damage).
