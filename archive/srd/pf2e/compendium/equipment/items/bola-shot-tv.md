...
> [!success-degree] 
> - **Critical Success** The target falls [prone](archive/srd/pf2e/rules/conditions.md#Prone) and is [stunned](archive/srd/pf2e/rules/conditions.md#Stunned).
> - **Success** The target falls [prone](archive/srd/pf2e/rules/conditions.md#Prone).
