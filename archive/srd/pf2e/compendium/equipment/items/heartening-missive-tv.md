...
[abjuration](abjuration.md "Abjuration School Trait")  [consumable](archive/srd/pf2e/rules/traits/consumable.md "Consumable Item Trait")  [magical](archive/srd/pf2e/rules/traits/magical.md "Magical Item Trait")  [missive](missive-tv.md "Missive Item Trait")  
...
Folded into a delicate butterfly, this missive grants the recipient a sense of grace and poise. Once during the next 24 hours, when the recipient fails a [Diplomacy](skills.md#Diplomacy) or [Performance](skills.md#Performance) check, they can improve the result from a failure to a success or from a critical failure to a failure. This is a [fortune](archive/srd/pf2e/rules/traits/fortune.md "Fortune Effect Trait") effect.
