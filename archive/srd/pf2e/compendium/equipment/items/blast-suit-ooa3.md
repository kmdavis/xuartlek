...
- **Trigger**: You're affected by an area effect that requires a Reflex save, or you would take [splash](rules/traits/splash.md "Splash Weapon Trait") damage from a scatter weapon
