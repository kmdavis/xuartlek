...
Your clothing doesn't need to accommodate this limb of ghostly matter, which can extrude through your clothing and armor. The limb lasts 1 hour, and you can [Dismiss](archive/srd/pf2e/rules/actions/dismiss.md) the activation. You can't hide or disguise the tentacle. You can use the limb to perform simple [Interact](archive/srd/pf2e/rules/actions/interact.md) actions, such as opening an unlocked door. Your limb can't perform actions that require significant manual dexterity, including any action that would require a check to accomplish. You can't use it to hold items. At one time, you can have only one extra limb from any version of this potion. Stronger tentacle potions replace the effects of weaker ones.
