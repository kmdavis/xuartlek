...
Olfactory stimulators can be fitted to animal companions as well as sapient creatures; stimulators produced for companion use have the [companion](archive/srd/pf2e/rules/traits/companion.md "Companion Item Trait") trait.
