...
This rune prevents enemies from escaping your grasp by [fleeing](archive/srd/pf2e/rules/conditions.md#Fleeing) to other planes. If you critically hit a target with an anchoring weapon, the weapon casts [dimensional anchor](dimensional-anchor.md) on the target (DC 27, counteract modifier +17).
