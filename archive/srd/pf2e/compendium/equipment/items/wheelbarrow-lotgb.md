...
You can raise or place a wheelbarrow using an [Interact](archive/srd/pf2e/rules/actions/interact.md) action and can [Stride](archive/srd/pf2e/rules/actions/stride.md) your normal Speed while you have the wheelbarrow raised, though you're [encumbered](archive/srd/pf2e/rules/conditions.md#Encumbered) while pushing a wheelbarrow. You can [Release](archive/srd/pf2e/rules/actions/release.md) a wheelbarrow as normal, but a loaded wheelbarrow has a chance of tipping over if you don't place it down with care. When you [Release](archive/srd/pf2e/rules/actions/release.md) a wheelbarrow, attempt a DC 7 flat check. On a failure, the wheelbarrow tips over, spilling its contents into a randomly determined adjacent space.
