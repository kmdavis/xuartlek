...
When you use the sextant, you gain a +1 item bonus to [Survival](skills.md#Survival) checks, which increases to a +2 item bonus when you [Sense Direction](archive/srd/pf2e/rules/actions/sense-direction.md).
