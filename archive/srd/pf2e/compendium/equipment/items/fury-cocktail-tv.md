...
- Animalistic Lemon juice and powdered claws or talons are added to the cocktail. You gain an unarmed attack in the brawling group of your choice between a jaws attack that deals `1d6` piercing damage or a claw attack that has the [agile](archive/srd/pf2e/rules/traits/agile.md "Agile Weapon Trait") trait and deals `1d4` slashing damage.
...
- Titanic Yuzu juice and powdered giant hair are added to this cocktail. If you're Medium or smaller, you gain the following effects: you become Large, are [clumsy](archive/srd/pf2e/rules/conditions.md#Clumsy), and increase your reach by 5 feet (or by 10 feet if you started out Tiny).
