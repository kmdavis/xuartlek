...
On a failure, the magic doesn't affect you (though it still has its normal effects on anyone else). On a success, the magic affects you and there is no need to attempt further flat checks for the same [magical](archive/srd/pf2e/rules/traits/magical.md "Magical Item Trait") effect, even if it affects you again later.