...
You're trained in [Astrology Lore](skills.md#Lore). You can cast [augury](archive/srd/pf2e/compendium/spells/augury.md) as a divine innate spell once per week, and the spell's effects can see up to 1 hour in the future rather than 30 minutes.