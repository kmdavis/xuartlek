...
You are trained in [Occultism](skills.md#Occultism) and an additional skill in which the haunting entity is well-versed, determined by the GM. Any time you attempt a skill check for the entity's skill, the GM can offer you a +1 circumstance bonus to the check, as though the entity were [Aiding](archive/srd/pf2e/rules/actions/aid.md) you. If you accept but fail the check, you are [frightened](archive/srd/pf2e/rules/conditions.md#Frightened) ([frightened](archive/srd/pf2e/rules/conditions.md#Frightened) on a critical failure). The initial [frightened](archive/srd/pf2e/rules/conditions.md#Frightened) value can't be reduced by effects that would reduce or prevent the condition (such as a fighter's bravery).