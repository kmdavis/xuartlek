...
- **Complexity** Simple
- **Stealth** DC 30 (or 0 if the trapdoor is disabled or [broken](archive/srd/pf2e/rules/conditions.md#Broken)) or [detect magic](archive/srd/pf2e/compendium/spells/detect-magic.md).  
...
**Reset** The trap still causes creatures to fall forever if they fall in, but the trapdoor must be reset manually for the trap to become [hidden](archive/srd/pf2e/rules/conditions.md#Hidden) again.  
