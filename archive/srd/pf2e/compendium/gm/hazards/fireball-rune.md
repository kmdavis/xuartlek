...
[evocation](evocation.md "Evocation School Trait")  [fire](archive/srd/pf2e/rules/traits/fire.md "Fire Energy & Element Trait")  [magical](archive/srd/pf2e/rules/traits/magical.md "Magical Item Trait")  [trap](archive/srd/pf2e/rules/traits/trap.md "Trap Hazard Trait")  

- **Complexity** Simple
- **Stealth** DC 24 expert  

An [invisible](archive/srd/pf2e/rules/conditions.md#Invisible) rune creates an [invisible](archive/srd/pf2e/rules/conditions.md#Invisible), spherical magical sensor with a 20-foot radius.
