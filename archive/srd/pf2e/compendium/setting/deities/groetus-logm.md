...
- **Domains**: [darkness](archive/srd/pf2e/compendium/setting/domains.md#Darkness), [destruction](archive/srd/pf2e/compendium/setting/domains.md#Destruction), [nightmares](archive/srd/pf2e/compendium/setting/domains.md#Nightmares), [void](archive/srd/pf2e/compendium/setting/domains.md#Void)
- **Alternate Domains**: [decay](archive/srd/pf2e/compendium/setting/domains.md#Decay)
- **Cleric Spells**: 1st: [phantom pain](archive/srd/pf2e/compendium/spells/phantom-pain.md); 5th: [crushing despair](crushing-despair.md); 9th: [disjunction](disjunction.md)

When casting the [avatar](archive/srd/pf2e/compendium/spells/avatar.md) spell, a worshipper of Groetus gains the following additional abilities.
...
- **Minor Boon** You wield power over disorder. Once, when you are [confused](archive/srd/pf2e/rules/conditions.md#Confused), you act normally enough to control your own actions in combat without penalty for the duration, though you still babble incoherently and otherwise behave strangely.
...
- **Minor Curse**: Whenever you are illuminated by a light source other than natural sunlight, your head appears to be a bare skull. The DC for your recovery checks is 12 + your [dying](archive/srd/pf2e/rules/conditions.md#Dying) value, rather than 10 + your [dying](archive/srd/pf2e/rules/conditions.md#Dying) value, and you don't benefit from effects that reduce the DC, such as from the [Toughness](archive/srd/pf2e/compendium/feats/toughness.md) feat.
- **Moderate Curse** The horrors at the end of reality become overwhelming and constantly race through your mind. You are permanently [stupefied](archive/srd/pf2e/rules/conditions.md#Stupefied).
- **Major Curse**: You bring about the end to everything around you. Every item you carry or wear gains the [broken](archive/srd/pf2e/rules/conditions.md#Broken) condition after 10 minutes of exposure to you, and is destroyed after a further hour. This effect can't destroy [artifacts](rules/traits/artifacts-gmg.md "Artifact Item Trait") or items of similar power.