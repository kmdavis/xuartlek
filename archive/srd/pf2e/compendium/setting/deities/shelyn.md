...
- **Domains**: [creation](archive/srd/pf2e/compendium/setting/domains.md#Creation), [family](archive/srd/pf2e/compendium/setting/domains.md#Family), [passion](archive/srd/pf2e/compendium/setting/domains.md#Passion), [protection](archive/srd/pf2e/compendium/setting/domains.md#Protection)
- **Alternate Domains**: [repose](archive/srd/pf2e/compendium/setting/domains.md#Repose)
- **Cleric Spells**: 1st: [color spray](color-spray.md); 3rd: [enthrall](archive/srd/pf2e/compendium/spells/enthrall.md); 4th: [creation](archive/srd/pf2e/compendium/spells/creation.md)
...
- **Moderate Boon**: You are inspired to create great works and become a virtuoso at all arts. You gain the [Specialty Crafting](archive/srd/pf2e/compendium/feats/specialty-crafting.md) feat and the [Virtuoso Performer](archive/srd/pf2e/compendium/feats/virtuosic-performer.md) feat in all categories of [Crafting](skills.md#Crafting) and [Performance](skills.md#Performance).
- **Major Boon**: Your inner beauty and love surround you in an aura. As long as you bear them no ill will, all creatures other than fiends, undead, and mindless creatures start with an attitude of [friendly](archive/srd/pf2e/rules/conditions.md#Friendly) toward you, unless they would have been [helpful](archive/srd/pf2e/rules/conditions.md#Helpful) instead. This doesn't mean they are willing to change their life or plans for you, and this boon does not prevent their attitudes from worsening if you try to thwart them. This effect doesn't work against deities and similarly powerful creatures. Additionally, the love you share with your friends inspires them. You and your allies gain a +3 status bonus to saving throws and skill checks as long as you can see each other.

- **Minor Curse**: You heart churns with remorse. Each day, you are [sickened](archive/srd/pf2e/rules/conditions.md#Sickened) as a specific misdeed plays out in your mind over and over in guilt. You can't remove this condition, though it abates enough for you to quickly eat and drink when necessary. If you make amends or otherwise earnestly pursue redemption for the misdeed, the [sickened](archive/srd/pf2e/rules/conditions.md#Sickened) condition fades completely that day.
...
- **Major Curse**: Those who spread misery via false love face Shelyn's greatest curse. You lose the ability to distinguish any living being from another through appearance, voice, [scent](archive/srd/pf2e/rules/abilities/scent.md), or similar sensory means. You can make out physical size (so you wouldn't mistake an ant for a horse), but nothing further. If you were merely shallow, every creature you see has generic, bland features, but if your deeds were vile, you see only the faces of those you have wronged.