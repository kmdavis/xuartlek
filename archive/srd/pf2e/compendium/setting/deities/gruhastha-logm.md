...
- **Favored Weapon**: [shortbow](archive/srd/pf2e/compendium/equipment/items/shortbow.md)
- **Domains**: [glyph](archive/srd/pf2e/compendium/setting/domains.md#Glyph), [knowledge](archive/srd/pf2e/compendium/setting/domains.md#Knowledge), [perfection](archive/srd/pf2e/compendium/setting/domains.md#Perfection), [truth](archive/srd/pf2e/compendium/setting/domains.md#Truth)
- **Alternate Domains**: [nature](archive/srd/pf2e/compendium/setting/domains.md#Nature), [travel](archive/srd/pf2e/compendium/setting/domains.md#Travel)
- **Cleric Spells**: 1st: [share lore](share-lore-logm.md); 2nd: [comprehend language](comprehend-language.md); 3rd: [hypercognition](archive/srd/pf2e/compendium/spells/hypercognition.md)

When casting the [avatar](archive/srd/pf2e/compendium/spells/avatar.md) spell, a worshipper of Gruhastha gains the following additional abilities.
...
- **Minor Boon** Books fall open to insightful passages, and memories spring to mind when they are most needed. Once, when you fail a check to [Recall Knowledge](archive/srd/pf2e/rules/actions/recall-knowledge.md), you critically succeed instead. Gruhastha typically grants this boon for an extremely consequential attempt to [Recall Knowledge](archive/srd/pf2e/rules/actions/recall-knowledge.md), particularly when misinformation would have dire consequences.
...
- **Major Boon**: You are a divine inspiration to others around you. When attempting any checks to [Recall Knowledge](archive/srd/pf2e/rules/actions/recall-knowledge.md), you can roll twice and use the better result; this is a [fortune](archive/srd/pf2e/rules/traits/fortune.md "Fortune Effect Trait") effect. Additionally, allies within 60 feet gain a +2 status bonus to Will saves.
...
- **Moderate Curse** Enlightenment begins to elude you, leaving you at a loss for knowledge. Whenever you attempt a check to [Recall Knowledge](archive/srd/pf2e/rules/actions/recall-knowledge.md), you use a result one degree of success worse than the result you rolled.
