...
- **Alternate Domains**: [cold](archive/srd/pf2e/compendium/setting/domains.md#Cold), [lightning](archive/srd/pf2e/compendium/setting/domains.md#Lightning)
- **Cleric Spells**: 1st: [gust of wind](archive/srd/pf2e/compendium/spells/gust-of-wind.md); 3rd: [lightning bolt](archive/srd/pf2e/compendium/spells/lightning-bolt.md); 5th: [control water](archive/srd/pf2e/compendium/spells/control-water.md)
...
- **Moderate Curse** The current of the waves constantly fights against you, putting you at risk of drowning any time you must [Swim](archive/srd/pf2e/rules/actions/swim.md). You lose any swim Speed you have, unless it's your only Speed, in which case you take a –20-foot status penalty to your swim Speed. When you roll an [Athletics](skills.md#Athletics) check to [Swim](archive/srd/pf2e/rules/actions/swim.md), you always use the outcome for one degree of success worse than the result of your roll.
- **Major Curse**: Those who displease Gozreh are shunned by nature itself. All animals and nonsapient plant creatures are [hostile](archive/srd/pf2e/rules/conditions.md#Hostile) to you, and any animal companion or familiar abandons you. Sapient plants' attitude toward you begins two categories worse than normal, as something about you seems repugnant to them. While plants and animals might not attack you outright if it's not normally in their nature to do so when they are hostile, dogs growl at you, cats hiss, and so on.