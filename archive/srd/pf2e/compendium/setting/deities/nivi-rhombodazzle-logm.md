...
- **Domains**: [family](archive/srd/pf2e/compendium/setting/domains.md#Family), [luck](archive/srd/pf2e/compendium/setting/domains.md#Luck), [trickery](archive/srd/pf2e/compendium/setting/domains.md#Trickery), [wealth](archive/srd/pf2e/compendium/setting/domains.md#Wealth)
- **Alternate Domains**: [confidence](archive/srd/pf2e/compendium/setting/domains.md#Confidence), [earth](archive/srd/pf2e/compendium/setting/domains.md#Earth)
- **Cleric Spells**: 1st: [illusory disguise](archive/srd/pf2e/compendium/spells/illusory-disguise.md); 2nd: [invisibility](archive/srd/pf2e/compendium/spells/invisibility.md); 4th: [private sanctum](private-sanctum.md)

When casting the [avatar](archive/srd/pf2e/compendium/spells/avatar.md) spell, a worshipper of Nivi Rhombodazzle gains the following additional abilities.
...
- **Moderate Boon**: Nivi bestows a fraction of her skill at pushing consequences down the road. Once per day, after attempting a check, you can roll a second time. You must use the result of the second roll, even if it is worse. This is a [fortune](archive/srd/pf2e/rules/traits/fortune.md "Fortune Effect Trait") effect. At any point after you use this boon, the GM can replace one of your check results with the first result of the check you attempted when using this boon; this delayed result can't be further delayed, prevented, or affected in any way, even by other divine intercessions.
- **Major Boon**: Those who have done much to please Nivi find themselves slipping from sight when needed. Any time you attempt a [Stealth](skills.md#Stealth) check to [Hide](archive/srd/pf2e/rules/actions/hide.md) or [Sneak](archive/srd/pf2e/rules/actions/sneak.md), you also gain the effects of 2nd-level [invisibility](archive/srd/pf2e/compendium/spells/invisibility.md) and [fleet step](archive/srd/pf2e/compendium/spells/fleet-step.md) spells to help you elude your enemies. These effects last until the end of your next turn or until you stop [Hiding](archive/srd/pf2e/rules/actions/hide.md) or [Sneaking](archive/srd/pf2e/rules/actions/sneak.md), whichever comes first (you can continue to [Hide](archive/srd/pf2e/rules/actions/hide.md) or [Sneak](archive/srd/pf2e/rules/actions/sneak.md), turn after turn, to extend these effects).
...
- **Moderate Curse** Those who arouse Nivi's wrath find themselves bound to the earth with no place to hide. You are wreathed in constant [faerie fire](faerie-fire.md) and constantly affected by [earthbind](archive/srd/pf2e/compendium/spells/earthbind.md), and any effect that grants invisibility doesn't work on you.
