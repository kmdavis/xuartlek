...
- **Domains**: [creation](archive/srd/pf2e/compendium/setting/domains.md#Creation), [earth](archive/srd/pf2e/compendium/setting/domains.md#Earth), [knowledge](archive/srd/pf2e/compendium/setting/domains.md#Knowledge), [time](archive/srd/pf2e/compendium/setting/domains.md#Time)
- **Cleric Spells**: 1st: [temporary tool](temporary-tool-logm.md); 4th: [creation](archive/srd/pf2e/compendium/spells/creation.md); 7th: [duplicate foe](archive/srd/pf2e/compendium/spells/duplicate-foe.md)

When casting the [avatar](archive/srd/pf2e/compendium/spells/avatar.md) spell, a worshipper of Brigh gains the following additional abilities.
...
- **Minor Boon** Knowledge floods your mind. Once, you can reroll a failed skill check to [Recall Knowledge](archive/srd/pf2e/rules/actions/recall-knowledge.md); you must use the second result, even if it's worse.
- **Moderate Boon**: You become a wellspring of invention. You gain the [Inventor](archive/srd/pf2e/compendium/feats/inventor.md) feat, even if you don't meet its prerequisites, and when you roll a [Crafting](skills.md#Crafting) check for the [Inventor](archive/srd/pf2e/compendium/feats/inventor.md) feat, you use the result one degree of success better than the result you rolled.
...
- **Minor Curse**: Your hands shake when attempting delicate work. All your failures to [Craft](archive/srd/pf2e/rules/actions/craft.md) or [Repair](archive/srd/pf2e/rules/actions/repair.md) items are instead critical failures.
- **Moderate Curse** Whenever you try to perform engineering or science tasks, everything just seems to explode. Whenever you attempt to create or use an [alchemical](archive/srd/pf2e/rules/traits/alchemical.md "Alchemical Item Trait") item or a [construct](archive/srd/pf2e/rules/traits/construct.md "Construct Creature Type Trait"), [Disable a Device](archive/srd/pf2e/rules/actions/disable-a-device.md), and so on, you must attempt a DC 15 flat check. On a failure, something explodes and you take `1d6` fire damage (or a different type of damage, if appropriate) per level of the item, construct, or device (DC 40 basic Reflex save).
