...
Divine spellcasters can call a deity's might to their fingertips, acting as a worldly conduit for divine wrath or redemption—but not just anyone can call the power of the gods. Some of the spells in this section are new additions to the [divine](archive/srd/pf2e/rules/traits/divine.md "Divine Tradition Trait") spell list, and thus they can be cast by any clerics, sorcerers whose bloodlines grant [divine](archive/srd/pf2e/rules/traits/divine.md "Divine Tradition Trait") spells, or other characters with access to [divine](archive/srd/pf2e/rules/traits/divine.md "Divine Tradition Trait") spells. Others are more commonly used by bards, druids, sorcerers, wizards, and other characters with access to spellcasting, but can be granted to worshippers of a specific deity as a blessing to the faithful.
