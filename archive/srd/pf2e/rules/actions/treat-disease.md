...
---
# Treat Disease (basic) [⏲](chapter-9-playing-the-game.md#Actions "Duration or Frequency") 8 hour (at least 8 hours)
...
You spend at least 8 hours caring for a diseased creature. Attempt a [Medicine](skills.md#Medicine) check against the disease's DC. After you attempt to Treat a Disease for a creature, you can't try again until after that creature's next save against the disease.
