...
You can grow an item from a living thing, most commonly a plant. You need the [Alchemical Crafting](archive/srd/pf2e/compendium/feats/alchemical-crafting.md) skill feat to Grow an alchemical item, the [Magical Crafting](archive/srd/pf2e/compendium/feats/magical-crafting.md) skill feat to Grow a magic item, and the [Snare Crafting](archive/srd/pf2e/compendium/feats/snare-crafting.md) feat to Grow a snare. To Grow an item, you must meet the following requirements.
