...
Your last attack failed, but it set you up for another. Make a [Strike](archive/srd/pf2e/rules/actions/strike.md) with your other hand, using a one-handed melee weapon or unarmed attack. This [Strike](archive/srd/pf2e/rules/actions/strike.md) uses the same multiple attack penalty as the [Strike](archive/srd/pf2e/rules/actions/strike.md) that failed on the last action. Afterward, increase your multiple attack penalty normally.