...
> - **Critical Failure** You break your tools. Fixing them requires using [Crafting](skills.md#Crafting) to [Repair](archive/srd/pf2e/rules/actions/repair.md) them or else swapping in replacement picks (costing 3 sp, or 3 gp for infiltrator thieves' tools).