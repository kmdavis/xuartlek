...
For example, if you spent 2 actions to Act Together, you could cast [burning hands](burning-hands.md) (2 actions) and your eidolon could [Strike](archive/srd/pf2e/rules/actions/strike.md) (1 action), or your eidolon could use its Breath Weapon (2 actions) and you could [Stride](archive/srd/pf2e/rules/actions/stride.md) (1 action).

This lets you each use separate exploration activities like [Avoid Notice](archive/srd/pf2e/rules/actions/avoid-notice.md) as you travel (Core Rulebook 496).