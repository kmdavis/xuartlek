...
You [Stride](archive/srd/pf2e/rules/actions/stride.md) up to your Speed. During this movement, you can try to move through the space of one enemy. Attempt an [Acrobatics](skills.md#Acrobatics) check against the enemy's Reflex DC as soon as you try to enter its space. You can [Tumble Through](archive/srd/pf2e/rules/actions/tumble-through.md) using Climb, Fly, Swim, or another action instead of [Stride](archive/srd/pf2e/rules/actions/stride.md) in the appropriate environment.
