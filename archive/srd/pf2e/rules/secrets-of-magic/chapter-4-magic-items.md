...
All fulus have the [fulu](fulu-som.md "Fulu Item Trait") and [consumable](archive/srd/pf2e/rules/traits/consumable.md "Consumable Item Trait") traits. Fulus also have a tradition trait—either [arcane](archive/srd/pf2e/rules/traits/arcane.md "Arcane Tradition Trait"), [divine](archive/srd/pf2e/rules/traits/divine.md "Divine Tradition Trait"), [occult](archive/srd/pf2e/rules/traits/occult.md "Occult Tradition Trait") or [primal](archive/srd/pf2e/rules/traits/primal.md "Primal Tradition Trait")—determined by the magical tradition of its creator. For example, a fulu created by a priest would have the [divine](archive/srd/pf2e/rules/traits/divine.md "Divine Tradition Trait") trait, whereas a witch who dabbles in fate might create a fulu with the [occult](archive/srd/pf2e/rules/traits/occult.md "Occult Tradition Trait") trait. Some fulus also have the [talisman](archive/srd/pf2e/rules/traits/talisman.md "Talisman Item Trait") trait, if they work similarly to talismans (such as being affixed to a suit of armor, a shield, or a weapon.

Each fulu's stat block indicates the type of item or creature it can be affixed to. Affixing or removing a fulu requires using the [Affix a Fulu](affix-a-fulu-som.md) activity, or the [Affix a Talisman](archive/srd/pf2e/rules/actions/affix-a-talisman.md) action instead if the fulu is also a talisman.
...
Unlike most items, the ritualistic aspect of fulus' creation allows the creator to expedite the process, though doing so decreases the fulus' stability. A character with the formula for a fulu can [Craft](archive/srd/pf2e/rules/actions/craft.md) up to four fulus for their full price in a single day of downtime, rather than taking four days as normal for the [Craft](archive/srd/pf2e/rules/actions/craft.md) downtime activity. However, if they do so, the fulus only last for a month, rather than a year. This is perfect for fulus you expect to use soon after [Crafting](archive/srd/pf2e/rules/actions/craft.md) them, as in that case, there isn't much difference between a month and a year.
...
To craft a magical tattoo, you must be able to craft magic items and have a specialty in tattooing. You can attain these requirements by taking the [Tattoo Artist](tattoo-artist-tv.md) skill feat below, or you can take both the [Magical Crafting](archive/srd/pf2e/compendium/feats/magical-crafting.md) and [Specialty Crafting](archive/srd/pf2e/compendium/feats/specialty-crafting.md) skill feats, choosing artistry as your specialty.

#### Crafting A Tattoo
<sup>SoM p. 164</sup>

Inking a magical tattoo onto a creature is much like etching a rune onto an item. The tattooist uses the [Craft](archive/srd/pf2e/rules/actions/craft.md) activity, and the subject must be present throughout the process. The tattooist must meet any special [Craft](archive/srd/pf2e/rules/actions/craft.md) requirements, and they can ink only one tattoo at a time. Not only does a magical tattoo not have any effect until the [Craft](archive/srd/pf2e/rules/actions/craft.md) activity is complete, but it also requires a healing period. Though this time frame can last up to a month, applying magical or alchemical healing can shorten it to as little as a day.

#### The Tattoo Trait
<sup>SoM p. 164</sup>

A magical tattoo has the [tattoo](tattoo-lowg.md "Tattoo Item Trait") trait. It's permanently a part of the subject's body, and reduces the number of items that creature can invest per day by 1. Each tattoo has the [invested](archive/srd/pf2e/rules/traits/invested.md "Invested Item Trait") trait to indicate this limitation—a magical tattoo is like an invested item that the tattooed creature has no choice but to invest. If the tattoo loses its magic or is destroyed, it no longer reduces your investiture. Just like a physical magic item, a magical tattoo can be counteracted by spells like [dispel magic](archive/srd/pf2e/compendium/spells/dispel-magic.md) or [disjunction](disjunction.md). If destroyed, the tattoo fades from the skin.

If a creature gets a new magical tattoo when their limit on invested items has already been reduced to zero, the new tattoo's magic fails to take hold, and it becomes a non-magical tattoo instead. However, a tattooist can alter an existing tattoo when they [Craft](archive/srd/pf2e/rules/actions/craft.md) a tattoo, modifying the old one into a different magical tattoo and removing the old effect. Magical tattoos can usually be 11 into their greater versions by having a tattooist add to or modify the existing tattoo.
...
Once you've decided the trait, choose the spells to inscribe. They must share the trait you chose for the staff. For instance, your undine sorcerer might create a _deep sea staff_ themed around the [water](archive/srd/pf2e/rules/traits/water.md "Water Energy & Element Trait") trait, inscribing it with spells such as [create water](archive/srd/pf2e/compendium/spells/create-water.md) and [hydraulic push](archive/srd/pf2e/compendium/spells/hydraulic-push.md).

You can inscribe a number of common spells on the staff depending on its level, as shown on the table below. You can place the same spell into the staff at multiple levels to provide heightened versions, though doing so uses up one of your picks for that spell level. You can add a spell you can't cast to a staff by supplying a casting of it via another caster or by using [Trick Magic Item](archive/srd/pf2e/compendium/feats/trick-magic-item.md); however, since you can cast a spell from a staff only if it's on your spell list, this option isn't useful for most characters.
...
- 2nd: [entangle](entangle.md), [shape wood](archive/srd/pf2e/compendium/spells/shape-wood.md)
- 3rd: [tree shape](tree-shape.md), [wall of thorns](archive/srd/pf2e/compendium/spells/wall-of-thorns.md)
- 4th: [barkskin](barkskin.md), [speak with plants](archive/srd/pf2e/compendium/spells/speak-with-plants.md)
- 5th: [plant form](archive/srd/pf2e/compendium/spells/plant-form.md), [wall of thorns](archive/srd/pf2e/compendium/spells/wall-of-thorns.md)
- 6th: nature's reprisal, [plant form](archive/srd/pf2e/compendium/spells/plant-form.md)
...
As with normal staves, one casting of all listed levels of all spells in the staff must be provided during [Crafting](archive/srd/pf2e/rules/actions/craft.md).

Choose a magical school for your staff from among the schools the spells on it have. Pick the one that best reflects the spells, usually the one most shared among them. You can optionally give your staff a trait for one magic tradition, instead of the [magical](archive/srd/pf2e/rules/traits/magical.md "Magical Item Trait") trait, if the staff is fully steeped in that tradition and contains spells only from that tradition's spell list.

You still need to [Craft](archive/srd/pf2e/rules/actions/craft.md) the staff. If you're not good at [Crafting](skills.md#Crafting), you can have somebody use the [Craft](archive/srd/pf2e/rules/actions/craft.md) activity for you, but you must be present the whole time. Since the creation of a custom staff is [rare](archive/srd/pf2e/rules/traits/rare.md "Rare Rarity Trait"), you and the GM might decide to have a special quest for esoteric ingredients and methods as part of the story.

##### Example
<sup>SoM p. 167</sup>

Lini selected mostly transmutation spells for her staff, so she chooses the [transmutation](transmutation.md "Transmutation School Trait") trait. She could give it the primal trait, but choses to keep it open with the [magical](archive/srd/pf2e/rules/traits/magical.md "Magical Item Trait") trait, much like the [verdant staff](archive/srd/pf2e/compendium/equipment/items/verdant-staff.md) in the Core Rulebook.
...
**[Spellheart](spellheart-som.md "Spellheart Equipment Trait")**: Spellhearts are permanent items that work similarly to talismans. You affix a spellheart using the [Affix a Spellheart](archive/srd/pf2e/rules/actions/affix-a-talisman.md) activity, which is otherwise identical to [Affix a Talisman](archive/srd/pf2e/rules/actions/affix-a-talisman.md). The limit of one talisman per item remains—an item can have one spellheart or one talisman, not both. The rules related to talismans and affixing them are on page 565 of the Core Rulebook. When casting a cantrip from a spellheart, you can use your own spell attack roll or spell DC if it's higher. [Crafting](archive/srd/pf2e/rules/actions/craft.md) a spellheart requires the spells the spellheart can cast. For example, a major five-feather wreath requires [air walk](air-walk.md), gale blast, and [wall of wind](archive/srd/pf2e/compendium/spells/wall-of-wind.md).
