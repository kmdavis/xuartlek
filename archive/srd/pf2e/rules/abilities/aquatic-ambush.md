...
**Effect** The monster moves up to its swim Speed + 10 feet toward the triggering creature, traveling on water and on land. Once the creature is in reach, the monster makes a [Strike](archive/srd/pf2e/rules/actions/strike.md) against it. The creature is [flat-footed](archive/srd/pf2e/rules/conditions.md#Flat-footed) against this [Strike](archive/srd/pf2e/rules/actions/strike.md).